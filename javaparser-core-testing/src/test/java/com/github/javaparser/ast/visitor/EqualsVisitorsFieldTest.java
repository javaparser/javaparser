...
public class EqualsVisitorsFieldTest extends AbstractEqualsVisitorsTest {
    ...
    void equals_differentModifiers_false(Strategy strategy) {
        assertNotEqualAfterMutation(
                FIELD, this::getRightField, n -> n.getModifiers().clear(), strategy);
    }
    ...
    void equals_differentVariable_false(Strategy strategy) {
        assertNotEqualAfterMutation(
                FIELD, this::getRightField, n -> n.getVariables().clear(), strategy);
    }
    ...
    void equals_differentAnnotation_false(Strategy strategy) {
        assertNotEqualAfterMutation(
                FIELD, this::getRightField, n -> n.getAnnotations().clear(), strategy);
    }
