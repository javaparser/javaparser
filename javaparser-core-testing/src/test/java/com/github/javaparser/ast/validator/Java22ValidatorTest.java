...
class Java22ValidatorTest {
    ...
    void validSwitchWithComplexGuardAndUnnamedPatterns() {
        ParseResult<CompilationUnit> result = javaParser.parse(
                COMPILATION_UNIT,
                provider("class Test { String getEngineCategory(Object obj, boolean someVariable) { return switch (obj) { case String _ when someVariable -> \"conditional\"; default -> \"none\"; }; } }"));
        assertNoProblems(result);
    }
