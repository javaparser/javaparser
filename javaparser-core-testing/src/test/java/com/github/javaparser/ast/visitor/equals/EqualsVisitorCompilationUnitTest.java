...
public class EqualsVisitorCompilationUnitTest extends EqualsVisitorTest {
    ...
    public static Stream<Arguments> declarationsInScope() {
        return Stream.of(
                Arguments.of(ImportDeclaration.class),
                Arguments.of(PackageDeclaration.class),
                Arguments.of(ClassOrInterfaceDeclaration.class));
    }

    @Test
    void equals_bothAreNull_true() {
        boolean result = equalsNodes(null, null);
    ...
    void equals_leftIsNull_false() {
        parseAndClone(CODE);
        boolean result = equalsNodes(null, nodeRight);
    ...
    void equals_rightIsNull_false() {
        parseAndClone(CODE);
        boolean result = equalsNodes(nodeLeft, null);
        assertThat(result, is(false));
    }
