...
public class EqualsVisitorsConstructorTest extends AbstractEqualsVisitorsTest {
    ...
    void equals_differentModifier_false(Strategy strategy) {
        assertNotEqualAfterMutation(
                CONSTRUCTOR, this::getRightConstructor, n -> n.getModifiers().clear(), strategy);
    }
    ...
    void equals_differentName_false(Strategy strategy) {
        assertNotEqualAfterMutation(
                CONSTRUCTOR, this::getRightConstructor, n -> n.setName(n.getName() + "differentName"), strategy);
    }
    ...
    void equals_differentParameters_false(Strategy strategy) {
        assertNotEqualAfterMutation(
                CONSTRUCTOR, this::getRightConstructor, n -> n.getParameters().clear(), strategy);
    }
    ...
    void equals_differentAnnotations_false(Strategy strategy) {
        assertNotEqualAfterMutation(
                CONSTRUCTOR, this::getRightConstructor, n -> n.getAnnotations().clear(), strategy);
    }
