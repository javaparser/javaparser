...
public class TokenCursorTest {
    @Test
    public void aaa() {
        CompilationUnit cu = parse("package com.github.javaparser.wiki_samples;" + EOL +
                EOL +
        ...
        Statement statement = cu.getClassByName("TestFile").get().getMethodsByName("foo").get(0).getBody().get().getStatements().get(0);
