    ...
    public SymbolReference<TypeDeclaration> tryToSolveType(String name) {
        ...
        if (srcFile.exists()) {
            try {
                ...
                ClassOrInterfaceDeclaration classOrInterfaceDeclaration = Navigator.demandClass(compilationUnit, simpleName(name));
                TypeDeclaration typeDeclaration = new JavaParserClassDeclaration(classOrInterfaceDeclaration);
