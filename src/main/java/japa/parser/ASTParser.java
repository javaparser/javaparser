...
final class ASTParser implements ASTParserConstants {
    ...
    private ArrayList<Token> special_tokens = null;
    ...
    private final Comment getComment() {
        ...
        if (special_tokens == null) {
            special_tokens = new ArrayList<Token>();
        }
 ...
 */
  ...
  final public ConstructorDeclaration ConstructorDeclaration(Modifier modifier) throws ParseException {
    ...
    jj_consume_token(RBRACE);
        ...
        ConstructorDeclaration tmp = new ConstructorDeclaration(line, column, token.endLine, token.endColumn,popJavadoc(), modifier.modifiers, modifier.annotations, typeParameters, name, parameters, throws_, new BlockStmt(bbLine, bbColumn, token.endLine, token.endColumn, stmts));
        tmp.setComment(cmmt);
        {if (true) return tmp;}
    throw new Error("Missing return statement in function");
  }
