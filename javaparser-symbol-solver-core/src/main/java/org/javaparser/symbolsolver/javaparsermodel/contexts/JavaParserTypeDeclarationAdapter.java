...
public class JavaParserTypeDeclarationAdapter {
    ...
    private org.javaparser.ast.body.TypeDeclaration<?> wrappedNode;
    private TypeSolver typeSolver;
    private Context context;
    private ResolvedReferenceTypeDeclaration typeDeclaration;

    public JavaParserTypeDeclarationAdapter(org.javaparser.ast.body.TypeDeclaration<?> wrappedNode, TypeSolver typeSolver,
