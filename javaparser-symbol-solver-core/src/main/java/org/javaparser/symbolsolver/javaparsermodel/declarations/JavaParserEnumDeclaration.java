...
import org.javaparser.resolution.types.parametrization.ResolvedTypeParametersMap;
import org.javaparser.symbolsolver.core.resolution.Context;
import org.javaparser.symbolsolver.core.resolution.MethodUsageResolutionCapability;
...
import org.javaparser.symbolsolver.logic.MethodResolutionCapability;
...
import org.javaparser.symbolsolver.model.typesystem.LazyType;
...
public class JavaParserEnumDeclaration extends AbstractTypeDeclaration
    ...
    private org.javaparser.ast.body.EnumDeclaration wrappedNode;
    private JavaParserTypeAdapter<org.javaparser.ast.body.EnumDeclaration> javaParserTypeAdapter;

    public JavaParserEnumDeclaration(org.javaparser.ast.body.EnumDeclaration wrappedNode, TypeSolver typeSolver) {
    ...
    public Set<ResolvedMethodDeclaration> getDeclaredMethods() {
        ...
        for (BodyDeclaration<?> member : wrappedNode.getMembers()) {
            if (member instanceof org.javaparser.ast.body.MethodDeclaration) {
                methods.add(new JavaParserMethodDeclaration((org.javaparser.ast.body.MethodDeclaration) member, typeSolver));
            }
        }
        return methods;
    }
     ...
     */
    public org.javaparser.ast.body.EnumDeclaration getWrappedNode() {
        return wrappedNode;
    }
    ...
    public Set<ResolvedReferenceTypeDeclaration> internalTypes() {
        ...
        for (BodyDeclaration<?> member : this.wrappedNode.getMembers()) {
            if (member instanceof org.javaparser.ast.body.TypeDeclaration) {
                res.add(JavaParserFacade.get(typeSolver).getTypeDeclaration((org.javaparser.ast.body.TypeDeclaration)member));
            }
        }
        return res;
    }
