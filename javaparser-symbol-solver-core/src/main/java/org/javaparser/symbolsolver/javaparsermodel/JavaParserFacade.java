...
import org.javaparser.ast.DataKey;
...
import org.javaparser.symbolsolver.javaparsermodel.contexts.FieldAccessContext;
...
import org.javaparser.symbolsolver.javaparsermodel.declarations.JavaParserTypeVariableDeclaration;
...
import org.javaparser.symbolsolver.resolution.ConstructorResolutionLogic;
...
import static org.javaparser.symbolsolver.model.resolution.SymbolReference.*;
...
public class JavaParserFacade {
    ...
    private void solveArguments(Node node, NodeList<Expression> args, boolean solveLambdas, List<ResolvedType> argumentTypes,
        ...
        for (Expression parameterValue : args) {
            if (parameterValue instanceof LambdaExpr || parameterValue instanceof MethodReferenceExpr) {
                ...
                } catch (org.javaparser.resolution.UnsolvedSymbolException e) {
                    throw e;
                } catch (Exception e) {
    ...
    protected MethodUsage toMethodUsage(MethodReferenceExpr methodReferenceExpr) {
        ...
        if (!(typeExpr.getType() instanceof org.javaparser.ast.type.ClassOrInterfaceType)) {
    ...
    protected org.javaparser.ast.body.TypeDeclaration<?> findContainingTypeDecl(Node node) {
    ...
    public ResolvedType convertToUsage(org.javaparser.ast.type.Type type, Node context) {
    ...
    public ResolvedType convertToUsage(org.javaparser.ast.type.Type type) {
    ...
    protected ResolvedType convertToUsage(org.javaparser.ast.type.Type type, Context context) {
        if (context == null) {
        ...
        } else if (type instanceof org.javaparser.ast.type.PrimitiveType) {
            return ResolvedPrimitiveType.byName(((org.javaparser.ast.type.PrimitiveType) type).getType().name());
        ...
        } else if (type instanceof org.javaparser.ast.type.VoidType) {
            return ResolvedVoidType.INSTANCE;
        } else if (type instanceof org.javaparser.ast.type.ArrayType) {
            org.javaparser.ast.type.ArrayType jpArrayType = (org.javaparser.ast.type.ArrayType) type;
    ...
    public ResolvedType convert(org.javaparser.ast.type.Type type, Context context) {
    ...
    public ResolvedReferenceTypeDeclaration getTypeDeclaration(org.javaparser.ast.body.TypeDeclaration<?> typeDeclaration) {
