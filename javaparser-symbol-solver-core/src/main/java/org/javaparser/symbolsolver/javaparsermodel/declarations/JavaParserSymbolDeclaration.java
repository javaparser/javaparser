    ...
    public ResolvedType getType() {
        if (wrappedNode instanceof Parameter) {
            ...
            if (demandParentNode(wrappedNode) instanceof LambdaExpr) {
                ...
                if (parameter.getType() instanceof org.javaparser.ast.type.PrimitiveType) {
                    rawType = ResolvedPrimitiveType.byName(((org.javaparser.ast.type.PrimitiveType) parameter.getType()).getType().name());
                } else {
