...
public class JmlDocsTypeDeclarationMetaModel extends TypeDeclarationMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlDocsTypeDeclarationMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(
                superBaseNodeMetaModel,
                JmlDocsTypeDeclaration.class,
                "JmlDocsTypeDeclaration",
