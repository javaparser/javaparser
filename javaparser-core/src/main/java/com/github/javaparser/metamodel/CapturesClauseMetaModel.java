...
import com.github.javaparser.ast.clauses.CapturesClause;
...
public class CapturesClauseMetaModel extends JmlClauseMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    CapturesClauseMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, CapturesClause.class, "CapturesClause", "com.github.javaparser.ast.clauses", false, false);
    }
}
