...
public class EnumConstantDeclarationMetaModel extends ClassMetaModel {
    ...
    EnumConstantDeclarationMetaModel(JavaParserMetaModel parent, Optional<ClassMetaModel> superClassMetaModel) {
        ...
        fieldMetaModels.add(new FieldMetaModel(this, "getClassBody", "setClassBody", "classBody", com.github.javaparser.ast.body.BodyDeclaration.class, getField("classBody"), true, false, true, false, true));
    ...
    private Field getField(String name) {
        try {
            return EnumConstantDeclaration.class.getDeclaredField(name);
