...
import com.github.javaparser.ast.clauses.WorkingSpaceClause;
...
public class WorkingSpaceClauseMetaModel extends JmlClauseMetaModel {
    ...
    WorkingSpaceClauseMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, WorkingSpaceClause.class, "WorkingSpaceClause", "com.github.javaparser.ast.clauses", false, false);
    }
}
