...
public class JmlDocsStatementsMetaModel extends StatementMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlDocsStatementsMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(
                superBaseNodeMetaModel,
                JmlDocsStatements.class,
                "JmlDocsStatements",
