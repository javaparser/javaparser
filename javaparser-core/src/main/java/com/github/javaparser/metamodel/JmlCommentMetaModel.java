...
public class JmlCommentMetaModel extends CommentMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlCommentMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, JmlComment.class, "JmlComment", "com.github.javaparser.ast.comments", false, false);
    }
}
