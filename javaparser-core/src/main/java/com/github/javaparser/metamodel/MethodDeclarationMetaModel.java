...
public class MethodDeclarationMetaModel extends ClassMetaModel {
    ...
    MethodDeclarationMetaModel(JavaParserMetaModel parent, Optional<ClassMetaModel> superClassMetaModel) {
        ...
        fieldMetaModels.add(new FieldMetaModel(this, "getBody", "setBody", "body", int.class, null, true, true, false, false));
        fieldMetaModels.add(new FieldMetaModel(this, "isDefault", "setIsDefault", "isDefault", int.class, null, true, false, false, false));
