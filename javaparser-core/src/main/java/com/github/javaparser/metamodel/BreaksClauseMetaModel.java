...
import com.github.javaparser.ast.clauses.BreaksClause;
...
public class BreaksClauseMetaModel extends JmlClauseMetaModel {
    ...
    BreaksClauseMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, BreaksClause.class, "BreaksClause", "com.github.javaparser.ast.clauses", false, false);
    }
