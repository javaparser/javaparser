...
import com.github.javaparser.ast.jml.clauses.BreaksClause;
...
public class BreaksClauseMetaModel extends JmlClauseMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    BreaksClauseMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, BreaksClause.class, "BreaksClause", "com.github.javaparser.ast.jml.clauses", false, false);
    }
