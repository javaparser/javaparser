...
import com.github.javaparser.ast.jml.stmt.JmlAssumeStmt;
...
public class JmlAssumeStmtMetaModel extends JmlStatementMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlAssumeStmtMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, JmlAssumeStmt.class, "JmlAssumeStmt", "com.github.javaparser.ast.jml.stmt", false, false);
    }
