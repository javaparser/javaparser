...
public class KeyExecStmtMetaModel extends StatementMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    KeyExecStmtMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, KeyExecStmt.class, "KeyExecStmt", "com.github.javaparser.ast.key", false, false);
    }

    public PropertyMetaModel branchesPropertyMetaModel;

    public PropertyMetaModel execBlockPropertyMetaModel;
}
