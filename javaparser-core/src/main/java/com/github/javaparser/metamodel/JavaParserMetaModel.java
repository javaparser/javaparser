...
public final class JavaParserMetaModel {
    ...
    private static void initializeConstructorParameters() {
        ...
        callableDeclarationMetaModel
                .getConstructorParameters()
                .add(callableDeclarationMetaModel.contractsPropertyMetaModel);
        ...
        importDeclarationMetaModel
                .getConstructorParameters()
                .add(importDeclarationMetaModel.isJmlModelPropertyMetaModel);
        ...
        jmlDocDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlDocDeclarationMetaModel.jmlCommentsPropertyMetaModel);
        ...
        jmlBinaryInfixExprMetaModel
                .getConstructorParameters()
                .add(jmlBinaryInfixExprMetaModel.operatorPropertyMetaModel);
        ...
        jmlMultiCompareExprMetaModel
                .getConstructorParameters()
                .add(jmlMultiCompareExprMetaModel.expressionsPropertyMetaModel);
        jmlMultiCompareExprMetaModel
                .getConstructorParameters()
                .add(jmlMultiCompareExprMetaModel.operatorsPropertyMetaModel);
        ...
        jmlSetComprehensionExprMetaModel
                .getConstructorParameters()
                .add(jmlSetComprehensionExprMetaModel.bindingPropertyMetaModel);
        jmlSetComprehensionExprMetaModel
                .getConstructorParameters()
                .add(jmlSetComprehensionExprMetaModel.predicatePropertyMetaModel);
        ...
        jmlMethodDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlMethodDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlMethodDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlMethodDeclarationMetaModel.methodDeclarationPropertyMetaModel);
        jmlMethodDeclarationMetaModel
                .getConstructorParameters()
        ...
        jmlSimpleExprClauseMetaModel
                .getConstructorParameters()
                .add(jmlSimpleExprClauseMetaModel.heapsPropertyMetaModel);
        jmlSimpleExprClauseMetaModel
                .getConstructorParameters()
                .add(jmlSimpleExprClauseMetaModel.expressionPropertyMetaModel);
        ...
        jmlMultiExprClauseMetaModel
                .getConstructorParameters()
                .add(jmlMultiExprClauseMetaModel.expressionsPropertyMetaModel);
        ...
        jmlSignalsOnlyClauseMetaModel
                .getConstructorParameters()
                .add(jmlSignalsOnlyClauseMetaModel.typesPropertyMetaModel);
        jmlLabledClauseMetaModel.getConstructorParameters().add(jmlLabledClauseMetaModel.kindPropertyMetaModel);
        jmlLabledClauseMetaModel.getConstructorParameters().add(jmlLabledClauseMetaModel.labelPropertyMetaModel);
        jmlLabledClauseMetaModel.getConstructorParameters().add(jmlLabledClauseMetaModel.expressionPropertyMetaModel);
        jmlForallClauseMetaModel
                .getConstructorParameters()
                .add(jmlForallClauseMetaModel.boundedVariablesPropertyMetaModel);
        ...
        jmlCallableClauseMetaModel
                .getConstructorParameters()
                .add(jmlCallableClauseMetaModel.methodSignaturesPropertyMetaModel);
        jmlConditionalClauseMetaModel.getConstructorParameters().add(jmlClauseMetaModel.namePropertyMetaModel);
        jmlConditionalClauseMetaModel
                .getConstructorParameters()
                .add(jmlConditionalClauseMetaModel.conditionPropertyMetaModel);
        jmlConditionalClauseMetaModel
                .getConstructorParameters()
                .add(jmlConditionalClauseMetaModel.kindPropertyMetaModel);
        jmlConditionalClauseMetaModel
                .getConstructorParameters()
                .add(jmlConditionalClauseMetaModel.expressionPropertyMetaModel);
        jmlMethodSignatureMetaModel
                .getConstructorParameters()
                .add(jmlMethodSignatureMetaModel.receiverPropertyMetaModel);
        jmlMethodSignatureMetaModel.getConstructorParameters().add(jmlMethodSignatureMetaModel.namePropertyMetaModel);
        jmlMethodSignatureMetaModel
                .getConstructorParameters()
                .add(jmlMethodSignatureMetaModel.argumentTypesPropertyMetaModel);
        jmlInfFlowClauseMetaModel.getConstructorParameters().add(jmlInfFlowClauseMetaModel.kindPropertyMetaModel);
        jmlInfFlowClauseMetaModel.getConstructorParameters().add(jmlClauseMetaModel.namePropertyMetaModel);
        jmlInfFlowClauseMetaModel.getConstructorParameters().add(jmlInfFlowClauseMetaModel.byPropertyMetaModel);
        jmlInfFlowClauseMetaModel
                .getConstructorParameters()
                .add(jmlInfFlowClauseMetaModel.declassifiesPropertyMetaModel);
        jmlInfFlowClauseMetaModel.getConstructorParameters().add(jmlInfFlowClauseMetaModel.erasesPropertyMetaModel);
        jmlInfFlowClauseMetaModel
                .getConstructorParameters()
                .add(jmlInfFlowClauseMetaModel.expressionsPropertyMetaModel);
        jmlInfFlowClauseMetaModel.getConstructorParameters().add(jmlInfFlowClauseMetaModel.newObjectsPropertyMetaModel);
        ...
        jmlClassExprDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassExprDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlClassExprDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassExprDeclarationMetaModel.modifiersPropertyMetaModel);
        jmlClassExprDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassExprDeclarationMetaModel.kindPropertyMetaModel);
        jmlClassExprDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassExprDeclarationMetaModel.namePropertyMetaModel);
        jmlClassExprDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassExprDeclarationMetaModel.invariantPropertyMetaModel);
        jmlRepresentsDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlRepresentsDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlRepresentsDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlRepresentsDeclarationMetaModel.modifiersPropertyMetaModel);
        jmlRepresentsDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlRepresentsDeclarationMetaModel.namePropertyMetaModel);
        jmlRepresentsDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlRepresentsDeclarationMetaModel.exprPropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassAccessibleDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassAccessibleDeclarationMetaModel.modifiersPropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassAccessibleDeclarationMetaModel.variablePropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassAccessibleDeclarationMetaModel.expressionsPropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel
                .getConstructorParameters()
                .add(jmlClassAccessibleDeclarationMetaModel.measuredByPropertyMetaModel);
        keyCatchAllStmtMetaModel.getConstructorParameters().add(keyCatchAllStmtMetaModel.labelPropertyMetaModel);
        keyCatchAllStmtMetaModel.getConstructorParameters().add(keyCatchAllStmtMetaModel.blockPropertyMetaModel);
        ...
        keyCcatchParameterMetaModel
                .getConstructorParameters()
                .add(keyCcatchParameterMetaModel.parameterPropertyMetaModel);
        ...
        keyEscapeExpressionMetaModel
                .getConstructorParameters()
                .add(keyEscapeExpressionMetaModel.calleePropertyMetaModel);
        keyEscapeExpressionMetaModel
                .getConstructorParameters()
                .add(keyEscapeExpressionMetaModel.argumentsPropertyMetaModel);
        keyExecStmtMetaModel.getConstructorParameters().add(keyExecStmtMetaModel.execBlockPropertyMetaModel);
        keyExecStmtMetaModel.getConstructorParameters().add(keyExecStmtMetaModel.branchesPropertyMetaModel);
        keyExecutionContextMetaModel
                .getConstructorParameters()
                .add(keyExecutionContextMetaModel.contextPropertyMetaModel);
        keyExecutionContextMetaModel
                .getConstructorParameters()
                .add(keyExecutionContextMetaModel.signaturePropertyMetaModel);
        keyExecutionContextMetaModel
                .getConstructorParameters()
                .add(keyExecutionContextMetaModel.instancePropertyMetaModel);
        keyLoopScopeBlockStmtMetaModel
                .getConstructorParameters()
                .add(keyLoopScopeBlockStmtMetaModel.indexPVPropertyMetaModel);
        keyLoopScopeBlockStmtMetaModel
                .getConstructorParameters()
                .add(keyLoopScopeBlockStmtMetaModel.blockPropertyMetaModel);
        keyMergePointStmtMetaModel.getConstructorParameters().add(keyMergePointStmtMetaModel.exprPropertyMetaModel);
        keyMethodBodyStatementMetaModel
                .getConstructorParameters()
                .add(keyMethodBodyStatementMetaModel.namePropertyMetaModel);
        keyMethodBodyStatementMetaModel
                .getConstructorParameters()
                .add(keyMethodBodyStatementMetaModel.exprPropertyMetaModel);
        keyMethodBodyStatementMetaModel
                .getConstructorParameters()
                .add(keyMethodBodyStatementMetaModel.sourcePropertyMetaModel);
        keyMethodCallStmtMetaModel.getConstructorParameters().add(keyMethodCallStmtMetaModel.namePropertyMetaModel);
        keyMethodCallStmtMetaModel.getConstructorParameters().add(keyMethodCallStmtMetaModel.contextPropertyMetaModel);
        keyMethodCallStmtMetaModel.getConstructorParameters().add(keyMethodCallStmtMetaModel.blockPropertyMetaModel);
        keyMethodSignatureMetaModel.getConstructorParameters().add(keyMethodSignatureMetaModel.namePropertyMetaModel);
        keyMethodSignatureMetaModel
                .getConstructorParameters()
        ...
        keyContextStatementBlockMetaModel
                .getConstructorParameters()
                .add(keyContextStatementBlockMetaModel.contextPropertyMetaModel);
        keyContextStatementBlockMetaModel
                .getConstructorParameters()
                .add(keyContextStatementBlockMetaModel.trPropertyMetaModel);
        keyContextStatementBlockMetaModel
                .getConstructorParameters()
                .add(keyContextStatementBlockMetaModel.signaturePropertyMetaModel);
        keyContextStatementBlockMetaModel
                .getConstructorParameters()
        ...
        keyMetaConstructMetaModel.getConstructorParameters().add(keyMetaConstructMetaModel.kindPropertyMetaModel);
        keyMetaConstructMetaModel.getConstructorParameters().add(keyMetaConstructMetaModel.childPropertyMetaModel);
        keyMetaConstructMetaModel.getConstructorParameters().add(keyMetaConstructMetaModel.schemasPropertyMetaModel);
        keyMetaConstructExpressionMetaModel
                .getConstructorParameters()
                .add(keyMetaConstructExpressionMetaModel.textPropertyMetaModel);
        keyMetaConstructExpressionMetaModel
                .getConstructorParameters()
                .add(keyMetaConstructExpressionMetaModel.childPropertyMetaModel);
        keyMetaConstructTypeMetaModel.getConstructorParameters().add(typeMetaModel.annotationsPropertyMetaModel);
        keyMetaConstructTypeMetaModel
                .getConstructorParameters()
                .add(keyMetaConstructTypeMetaModel.kindPropertyMetaModel);
        keyMetaConstructTypeMetaModel
                .getConstructorParameters()
                .add(keyMetaConstructTypeMetaModel.exprPropertyMetaModel);
        keyMethodSignatureSVMetaModel
                .getConstructorParameters()
                .add(keyMethodSignatureSVMetaModel.textPropertyMetaModel);
        keyPassiveExpressionMetaModel
                .getConstructorParameters()
                .add(keyPassiveExpressionMetaModel.exprPropertyMetaModel);
        keyProgramVariableSVMetaModel
                .getConstructorParameters()
                .add(keyProgramVariableSVMetaModel.textPropertyMetaModel);
        ...
        keyExecutionContextSVMetaModel
                .getConstructorParameters()
                .add(keyExecutionContextSVMetaModel.textPropertyMetaModel);
    }
    ...
    private static void initializeNodeMetaModels() {
        ...
        nodeMetaModels.add(jmlConditionalClauseMetaModel);
        ...
        nodeMetaModels.add(jmlInfFlowClauseMetaModel);
        nodeMetaModels.add(jmlLabelExprMetaModel);
        nodeMetaModels.add(jmlLabelStmtMetaModel);
        nodeMetaModels.add(jmlLabledClauseMetaModel);
        ...
        nodeMetaModels.add(keyExecStmtMetaModel);
        ...
        nodeMetaModels.add(keyMetaConstructTypeMetaModel);
        nodeMetaModels.add(keyMethodBodyStatementMetaModel);
        nodeMetaModels.add(keyMethodCallStmtMetaModel);
        nodeMetaModels.add(keyMethodSignatureMetaModel);
        nodeMetaModels.add(keyMethodSignatureSVMetaModel);
        nodeMetaModels.add(keyPassiveExpressionMetaModel);
        nodeMetaModels.add(keyProgramVariableSVMetaModel);
        nodeMetaModels.add(keyStatementSVMetaModel);
        nodeMetaModels.add(keyTransactionStmtMetaModel);
    ...
    private static void initializePropertyMetaModels() {
        nodeMetaModel.associatedSpecificationCommentsPropertyMetaModel = new PropertyMetaModel(
                nodeMetaModel,
        ...
        nodeMetaModel
                ...
                .add(nodeMetaModel.associatedSpecificationCommentsPropertyMetaModel);
        ...
        bodyDeclarationMetaModel.annotationsPropertyMetaModel = new PropertyMetaModel(
        ...
        bodyDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(bodyDeclarationMetaModel.annotationsPropertyMetaModel);
        callableDeclarationMetaModel.contractsPropertyMetaModel = new PropertyMetaModel(
                callableDeclarationMetaModel,
                "contracts",
        ...
        callableDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(callableDeclarationMetaModel.contractsPropertyMetaModel);
        callableDeclarationMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                callableDeclarationMetaModel,
                "modifiers",
        ...
        callableDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(callableDeclarationMetaModel.modifiersPropertyMetaModel);
        callableDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                callableDeclarationMetaModel,
                "name",
        ...
        callableDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(callableDeclarationMetaModel.namePropertyMetaModel);
        callableDeclarationMetaModel.parametersPropertyMetaModel = new PropertyMetaModel(
                callableDeclarationMetaModel,
                "parameters",
        ...
        callableDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(callableDeclarationMetaModel.parametersPropertyMetaModel);
        callableDeclarationMetaModel.receiverParameterPropertyMetaModel = new PropertyMetaModel(
                callableDeclarationMetaModel,
                "receiverParameter",
        ...
        callableDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(callableDeclarationMetaModel.receiverParameterPropertyMetaModel);
        callableDeclarationMetaModel.thrownExceptionsPropertyMetaModel = new PropertyMetaModel(
                callableDeclarationMetaModel,
                "thrownExceptions",
        ...
        callableDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(callableDeclarationMetaModel.thrownExceptionsPropertyMetaModel);
        callableDeclarationMetaModel.typeParametersPropertyMetaModel = new PropertyMetaModel(
                callableDeclarationMetaModel,
                "typeParameters",
        ...
        callableDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(callableDeclarationMetaModel.typeParametersPropertyMetaModel);
        typeMetaModel.annotationsPropertyMetaModel = new PropertyMetaModel(
                typeMetaModel,
                "annotations",
                com.github.javaparser.ast.expr.AnnotationExpr.class,
                Optional.of(annotationExprMetaModel),
        ...
        annotationExprMetaModel.namePropertyMetaModel = new PropertyMetaModel(
        ...
        typeDeclarationMetaModel.membersPropertyMetaModel = new PropertyMetaModel(
        ...
        typeDeclarationMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                typeDeclarationMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        typeDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(typeDeclarationMetaModel.modifiersPropertyMetaModel);
        typeDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                typeDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        literalStringValueExprMetaModel.valuePropertyMetaModel = new PropertyMetaModel(
                literalStringValueExprMetaModel,
                "value",
        ...
        literalStringValueExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(literalStringValueExprMetaModel.valuePropertyMetaModel);
        moduleDeclarationMetaModel.annotationsPropertyMetaModel = new PropertyMetaModel(
                moduleDeclarationMetaModel,
                "annotations",
                com.github.javaparser.ast.expr.AnnotationExpr.class,
                Optional.of(annotationExprMetaModel),
        ...
        moduleDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleDeclarationMetaModel.annotationsPropertyMetaModel);
        moduleDeclarationMetaModel.directivesPropertyMetaModel = new PropertyMetaModel(
                moduleDeclarationMetaModel,
                "directives",
        ...
        moduleDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleDeclarationMetaModel.directivesPropertyMetaModel);
        moduleDeclarationMetaModel.isOpenPropertyMetaModel = new PropertyMetaModel(
                moduleDeclarationMetaModel, "isOpen", boolean.class, Optional.empty(), false, false, false, false);
        moduleDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleDeclarationMetaModel.isOpenPropertyMetaModel);
        moduleDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                moduleDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        arrayCreationLevelMetaModel.annotationsPropertyMetaModel = new PropertyMetaModel(
                arrayCreationLevelMetaModel,
                "annotations",
                com.github.javaparser.ast.expr.AnnotationExpr.class,
                Optional.of(annotationExprMetaModel),
        ...
        arrayCreationLevelMetaModel
                .getDeclaredPropertyMetaModels()
                .add(arrayCreationLevelMetaModel.annotationsPropertyMetaModel);
        arrayCreationLevelMetaModel.dimensionPropertyMetaModel = new PropertyMetaModel(
                arrayCreationLevelMetaModel,
                "dimension",
        ...
        arrayCreationLevelMetaModel
                .getDeclaredPropertyMetaModels()
                .add(arrayCreationLevelMetaModel.dimensionPropertyMetaModel);
        compilationUnitMetaModel.importsPropertyMetaModel = new PropertyMetaModel(
                compilationUnitMetaModel,
                "imports",
        ...
        compilationUnitMetaModel.modulePropertyMetaModel = new PropertyMetaModel(
                compilationUnitMetaModel,
                "module",
        ...
        compilationUnitMetaModel.packageDeclarationPropertyMetaModel = new PropertyMetaModel(
                compilationUnitMetaModel,
                "packageDeclaration",
        ...
        compilationUnitMetaModel
                .getDeclaredPropertyMetaModels()
                .add(compilationUnitMetaModel.packageDeclarationPropertyMetaModel);
        compilationUnitMetaModel.typesPropertyMetaModel = new PropertyMetaModel(
                compilationUnitMetaModel,
                "types",
        ...
        importDeclarationMetaModel.isAsteriskPropertyMetaModel = new PropertyMetaModel(
                importDeclarationMetaModel, "isAsterisk", boolean.class, Optional.empty(), false, false, false, false);
        importDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(importDeclarationMetaModel.isAsteriskPropertyMetaModel);
        importDeclarationMetaModel.isJmlModelPropertyMetaModel = new PropertyMetaModel(
                importDeclarationMetaModel, "isJmlModel", boolean.class, Optional.empty(), false, false, false, false);
        importDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(importDeclarationMetaModel.isJmlModelPropertyMetaModel);
        ...
        importDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                importDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        packageDeclarationMetaModel.annotationsPropertyMetaModel = new PropertyMetaModel(
                packageDeclarationMetaModel,
                "annotations",
                com.github.javaparser.ast.expr.AnnotationExpr.class,
                Optional.of(annotationExprMetaModel),
        ...
        packageDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(packageDeclarationMetaModel.annotationsPropertyMetaModel);
        packageDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                packageDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        annotationMemberDeclarationMetaModel.defaultValuePropertyMetaModel = new PropertyMetaModel(
                annotationMemberDeclarationMetaModel,
                "defaultValue",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        annotationMemberDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(annotationMemberDeclarationMetaModel.defaultValuePropertyMetaModel);
        annotationMemberDeclarationMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                annotationMemberDeclarationMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        annotationMemberDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(annotationMemberDeclarationMetaModel.modifiersPropertyMetaModel);
        annotationMemberDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                annotationMemberDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        annotationMemberDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(annotationMemberDeclarationMetaModel.namePropertyMetaModel);
        annotationMemberDeclarationMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                annotationMemberDeclarationMetaModel,
                "type",
        ...
        annotationMemberDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(annotationMemberDeclarationMetaModel.typePropertyMetaModel);
        classOrInterfaceDeclarationMetaModel.extendedTypesPropertyMetaModel = new PropertyMetaModel(
                classOrInterfaceDeclarationMetaModel,
                "extendedTypes",
        ...
        classOrInterfaceDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(classOrInterfaceDeclarationMetaModel.extendedTypesPropertyMetaModel);
        classOrInterfaceDeclarationMetaModel.implementedTypesPropertyMetaModel = new PropertyMetaModel(
                classOrInterfaceDeclarationMetaModel,
                "implementedTypes",
                com.github.javaparser.ast.type.ClassOrInterfaceType.class,
                Optional.of(classOrInterfaceTypeMetaModel),
        ...
        classOrInterfaceDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(classOrInterfaceDeclarationMetaModel.isInterfacePropertyMetaModel);
        classOrInterfaceDeclarationMetaModel.permittedTypesPropertyMetaModel = new PropertyMetaModel(
                classOrInterfaceDeclarationMetaModel,
                "permittedTypes",
                com.github.javaparser.ast.type.ClassOrInterfaceType.class,
                Optional.of(classOrInterfaceTypeMetaModel),
        ...
        classOrInterfaceDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(classOrInterfaceDeclarationMetaModel.permittedTypesPropertyMetaModel);
        classOrInterfaceDeclarationMetaModel.typeParametersPropertyMetaModel = new PropertyMetaModel(
                classOrInterfaceDeclarationMetaModel,
                "typeParameters",
                com.github.javaparser.ast.type.TypeParameter.class,
                Optional.of(typeParameterMetaModel),
        ...
        classOrInterfaceDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(classOrInterfaceDeclarationMetaModel.typeParametersPropertyMetaModel);
        constructorDeclarationMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                constructorDeclarationMetaModel,
                "body",
        ...
        constructorDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(constructorDeclarationMetaModel.bodyPropertyMetaModel);
        enumConstantDeclarationMetaModel.argumentsPropertyMetaModel = new PropertyMetaModel(
                enumConstantDeclarationMetaModel,
                "arguments",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        enumConstantDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(enumConstantDeclarationMetaModel.argumentsPropertyMetaModel);
        enumConstantDeclarationMetaModel.classBodyPropertyMetaModel = new PropertyMetaModel(
                enumConstantDeclarationMetaModel,
                "classBody",
                com.github.javaparser.ast.body.BodyDeclaration.class,
                Optional.of(bodyDeclarationMetaModel),
        ...
        enumConstantDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(enumConstantDeclarationMetaModel.classBodyPropertyMetaModel);
        enumConstantDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                enumConstantDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        enumConstantDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(enumConstantDeclarationMetaModel.namePropertyMetaModel);
        enumDeclarationMetaModel.entriesPropertyMetaModel = new PropertyMetaModel(
                enumDeclarationMetaModel,
                "entries",
        ...
        enumDeclarationMetaModel.implementedTypesPropertyMetaModel = new PropertyMetaModel(
                enumDeclarationMetaModel,
                "implementedTypes",
                com.github.javaparser.ast.type.ClassOrInterfaceType.class,
                Optional.of(classOrInterfaceTypeMetaModel),
        ...
        enumDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(enumDeclarationMetaModel.implementedTypesPropertyMetaModel);
        fieldDeclarationMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
        ...
        fieldDeclarationMetaModel.variablesPropertyMetaModel = new PropertyMetaModel(
                fieldDeclarationMetaModel,
                "variables",
        ...
        fieldDeclarationMetaModel.maximumCommonTypePropertyMetaModel = new PropertyMetaModel(
                fieldDeclarationMetaModel,
                "maximumCommonType",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        initializerDeclarationMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                initializerDeclarationMetaModel,
                "body",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
        ...
        initializerDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(initializerDeclarationMetaModel.bodyPropertyMetaModel);
        initializerDeclarationMetaModel.isStaticPropertyMetaModel = new PropertyMetaModel(
                initializerDeclarationMetaModel,
                "isStatic",
                boolean.class,
                Optional.empty(),
        ...
        initializerDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(initializerDeclarationMetaModel.isStaticPropertyMetaModel);
        methodDeclarationMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                methodDeclarationMetaModel,
                "body",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
        ...
        methodDeclarationMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                methodDeclarationMetaModel,
                "type",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        parameterMetaModel.annotationsPropertyMetaModel = new PropertyMetaModel(
                parameterMetaModel,
                "annotations",
                com.github.javaparser.ast.expr.AnnotationExpr.class,
                Optional.of(annotationExprMetaModel),
        ...
        parameterMetaModel.isVarArgsPropertyMetaModel = new PropertyMetaModel(
                parameterMetaModel, "isVarArgs", boolean.class, Optional.empty(), false, false, false, false);
        parameterMetaModel.getDeclaredPropertyMetaModels().add(parameterMetaModel.isVarArgsPropertyMetaModel);
        parameterMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                parameterMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        parameterMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                parameterMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        parameterMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                parameterMetaModel,
                "type",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        parameterMetaModel.varArgsAnnotationsPropertyMetaModel = new PropertyMetaModel(
                parameterMetaModel,
                "varArgsAnnotations",
                com.github.javaparser.ast.expr.AnnotationExpr.class,
                Optional.of(annotationExprMetaModel),
        ...
        receiverParameterMetaModel.annotationsPropertyMetaModel = new PropertyMetaModel(
                receiverParameterMetaModel,
                "annotations",
                com.github.javaparser.ast.expr.AnnotationExpr.class,
                Optional.of(annotationExprMetaModel),
        ...
        receiverParameterMetaModel
                .getDeclaredPropertyMetaModels()
                .add(receiverParameterMetaModel.annotationsPropertyMetaModel);
        receiverParameterMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                receiverParameterMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        receiverParameterMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                receiverParameterMetaModel,
                "type",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        recordDeclarationMetaModel.implementedTypesPropertyMetaModel = new PropertyMetaModel(
                recordDeclarationMetaModel,
                "implementedTypes",
                com.github.javaparser.ast.type.ClassOrInterfaceType.class,
                Optional.of(classOrInterfaceTypeMetaModel),
        ...
        recordDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(recordDeclarationMetaModel.implementedTypesPropertyMetaModel);
        recordDeclarationMetaModel.parametersPropertyMetaModel = new PropertyMetaModel(
                recordDeclarationMetaModel,
                "parameters",
                com.github.javaparser.ast.body.Parameter.class,
                Optional.of(parameterMetaModel),
        ...
        recordDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(recordDeclarationMetaModel.parametersPropertyMetaModel);
        recordDeclarationMetaModel.receiverParameterPropertyMetaModel = new PropertyMetaModel(
                recordDeclarationMetaModel,
                "receiverParameter",
                com.github.javaparser.ast.body.ReceiverParameter.class,
                Optional.of(receiverParameterMetaModel),
        ...
        recordDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(recordDeclarationMetaModel.receiverParameterPropertyMetaModel);
        recordDeclarationMetaModel.typeParametersPropertyMetaModel = new PropertyMetaModel(
                recordDeclarationMetaModel,
                "typeParameters",
                com.github.javaparser.ast.type.TypeParameter.class,
                Optional.of(typeParameterMetaModel),
        ...
        recordDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(recordDeclarationMetaModel.typeParametersPropertyMetaModel);
        compactConstructorDeclarationMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                compactConstructorDeclarationMetaModel,
                "body",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
        ...
        compactConstructorDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(compactConstructorDeclarationMetaModel.modifiersPropertyMetaModel);
        compactConstructorDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                compactConstructorDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        compactConstructorDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(compactConstructorDeclarationMetaModel.namePropertyMetaModel);
        compactConstructorDeclarationMetaModel.thrownExceptionsPropertyMetaModel = new PropertyMetaModel(
                compactConstructorDeclarationMetaModel,
                "thrownExceptions",
                com.github.javaparser.ast.type.ReferenceType.class,
                Optional.of(referenceTypeMetaModel),
        ...
        compactConstructorDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(compactConstructorDeclarationMetaModel.thrownExceptionsPropertyMetaModel);
        compactConstructorDeclarationMetaModel.typeParametersPropertyMetaModel = new PropertyMetaModel(
                compactConstructorDeclarationMetaModel,
                "typeParameters",
                com.github.javaparser.ast.type.TypeParameter.class,
                Optional.of(typeParameterMetaModel),
        ...
        compactConstructorDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(compactConstructorDeclarationMetaModel.typeParametersPropertyMetaModel);
        variableDeclaratorMetaModel.initializerPropertyMetaModel = new PropertyMetaModel(
                variableDeclaratorMetaModel,
                "initializer",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        variableDeclaratorMetaModel
                .getDeclaredPropertyMetaModels()
                .add(variableDeclaratorMetaModel.initializerPropertyMetaModel);
        variableDeclaratorMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                variableDeclaratorMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        variableDeclaratorMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                variableDeclaratorMetaModel,
                "type",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        commentMetaModel.contentPropertyMetaModel = new PropertyMetaModel(
                commentMetaModel, "content", java.lang.String.class, Optional.empty(), false, false, false, false);
        commentMetaModel.getDeclaredPropertyMetaModels().add(commentMetaModel.contentPropertyMetaModel);
        arrayAccessExprMetaModel.indexPropertyMetaModel = new PropertyMetaModel(
        ...
        arrayAccessExprMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                arrayAccessExprMetaModel,
                "name",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        arrayCreationExprMetaModel.elementTypePropertyMetaModel = new PropertyMetaModel(
                arrayCreationExprMetaModel,
                "elementType",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        arrayCreationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(arrayCreationExprMetaModel.elementTypePropertyMetaModel);
        arrayCreationExprMetaModel.initializerPropertyMetaModel = new PropertyMetaModel(
                arrayCreationExprMetaModel,
                "initializer",
        ...
        arrayCreationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(arrayCreationExprMetaModel.initializerPropertyMetaModel);
        arrayCreationExprMetaModel.levelsPropertyMetaModel = new PropertyMetaModel(
                arrayCreationExprMetaModel,
                "levels",
        ...
        arrayInitializerExprMetaModel.valuesPropertyMetaModel = new PropertyMetaModel(
                arrayInitializerExprMetaModel,
                "values",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        arrayInitializerExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(arrayInitializerExprMetaModel.valuesPropertyMetaModel);
        assignExprMetaModel.operatorPropertyMetaModel = new PropertyMetaModel(
                assignExprMetaModel,
                "operator",
        ...
        assignExprMetaModel.targetPropertyMetaModel = new PropertyMetaModel(
                assignExprMetaModel,
                "target",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        assignExprMetaModel.valuePropertyMetaModel = new PropertyMetaModel(
                assignExprMetaModel,
                "value",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        binaryExprMetaModel.leftPropertyMetaModel = new PropertyMetaModel(
                binaryExprMetaModel,
                "left",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        binaryExprMetaModel.operatorPropertyMetaModel = new PropertyMetaModel(
                binaryExprMetaModel,
                "operator",
        ...
        binaryExprMetaModel.rightPropertyMetaModel = new PropertyMetaModel(
                binaryExprMetaModel,
                "right",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        booleanLiteralExprMetaModel.valuePropertyMetaModel = new PropertyMetaModel(
                booleanLiteralExprMetaModel, "value", boolean.class, Optional.empty(), false, false, false, false);
        booleanLiteralExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(booleanLiteralExprMetaModel.valuePropertyMetaModel);
        castExprMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                castExprMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        castExprMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                castExprMetaModel,
                "type",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        classExprMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                classExprMetaModel,
                "type",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        conditionalExprMetaModel.conditionPropertyMetaModel = new PropertyMetaModel(
        ...
        conditionalExprMetaModel.elseExprPropertyMetaModel = new PropertyMetaModel(
                conditionalExprMetaModel,
                "elseExpr",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        conditionalExprMetaModel.thenExprPropertyMetaModel = new PropertyMetaModel(
                conditionalExprMetaModel,
                "thenExpr",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        enclosedExprMetaModel.innerPropertyMetaModel = new PropertyMetaModel(
        ...
        fieldAccessExprMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                fieldAccessExprMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        fieldAccessExprMetaModel.scopePropertyMetaModel = new PropertyMetaModel(
                fieldAccessExprMetaModel,
                "scope",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        fieldAccessExprMetaModel.typeArgumentsPropertyMetaModel = new PropertyMetaModel(
                fieldAccessExprMetaModel,
                "typeArguments",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        fieldAccessExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(fieldAccessExprMetaModel.typeArgumentsPropertyMetaModel);
        fieldAccessExprMetaModel.usingDiamondOperatorPropertyMetaModel = new PropertyMetaModel(
                fieldAccessExprMetaModel,
        ...
        instanceOfExprMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
        ...
        instanceOfExprMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                instanceOfExprMetaModel,
                "type",
                com.github.javaparser.ast.type.ReferenceType.class,
                Optional.of(referenceTypeMetaModel),
        ...
        lambdaExprMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                lambdaExprMetaModel,
                "body",
        ...
        lambdaExprMetaModel.contractsPropertyMetaModel = new PropertyMetaModel(
                lambdaExprMetaModel,
                "contracts",
                com.github.javaparser.ast.jml.clauses.JmlContract.class,
                Optional.of(jmlContractMetaModel),
        ...
        lambdaExprMetaModel.isEnclosingParametersPropertyMetaModel = new PropertyMetaModel(
                lambdaExprMetaModel,
        ...
        lambdaExprMetaModel.expressionBodyPropertyMetaModel = new PropertyMetaModel(
                lambdaExprMetaModel,
                "expressionBody",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        memberValuePairMetaModel.namePropertyMetaModel = new PropertyMetaModel(
        ...
        memberValuePairMetaModel.valuePropertyMetaModel = new PropertyMetaModel(
                memberValuePairMetaModel,
                "value",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        methodCallExprMetaModel.argumentsPropertyMetaModel = new PropertyMetaModel(
        ...
        methodCallExprMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                methodCallExprMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        methodCallExprMetaModel.scopePropertyMetaModel = new PropertyMetaModel(
                methodCallExprMetaModel,
                "scope",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        methodCallExprMetaModel.typeArgumentsPropertyMetaModel = new PropertyMetaModel(
                methodCallExprMetaModel,
                "typeArguments",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        methodCallExprMetaModel.usingDiamondOperatorPropertyMetaModel = new PropertyMetaModel(
                methodCallExprMetaModel,
                "usingDiamondOperator",
                boolean.class,
                Optional.empty(),
        ...
        methodReferenceExprMetaModel.identifierPropertyMetaModel = new PropertyMetaModel(
                methodReferenceExprMetaModel,
                "identifier",
                java.lang.String.class,
                Optional.empty(),
        ...
        methodReferenceExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(methodReferenceExprMetaModel.identifierPropertyMetaModel);
        methodReferenceExprMetaModel.scopePropertyMetaModel = new PropertyMetaModel(
                methodReferenceExprMetaModel,
                "scope",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        methodReferenceExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(methodReferenceExprMetaModel.scopePropertyMetaModel);
        methodReferenceExprMetaModel.typeArgumentsPropertyMetaModel = new PropertyMetaModel(
                methodReferenceExprMetaModel,
                "typeArguments",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        methodReferenceExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(methodReferenceExprMetaModel.typeArgumentsPropertyMetaModel);
        methodReferenceExprMetaModel.usingDiamondOperatorPropertyMetaModel = new PropertyMetaModel(
                methodReferenceExprMetaModel,
                "usingDiamondOperator",
                boolean.class,
                Optional.empty(),
        ...
        nameExprMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                nameExprMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        nameMetaModel.identifierPropertyMetaModel = new PropertyMetaModel(
                nameMetaModel, "identifier", java.lang.String.class, Optional.empty(), false, true, false, false);
        nameMetaModel.getDeclaredPropertyMetaModels().add(nameMetaModel.identifierPropertyMetaModel);
        nameMetaModel.qualifierPropertyMetaModel = new PropertyMetaModel(
                nameMetaModel,
                "qualifier",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        normalAnnotationExprMetaModel.pairsPropertyMetaModel = new PropertyMetaModel(
                normalAnnotationExprMetaModel,
                "pairs",
        ...
        normalAnnotationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(normalAnnotationExprMetaModel.pairsPropertyMetaModel);
        objectCreationExprMetaModel.anonymousClassBodyPropertyMetaModel = new PropertyMetaModel(
                objectCreationExprMetaModel,
                "anonymousClassBody",
                com.github.javaparser.ast.body.BodyDeclaration.class,
                Optional.of(bodyDeclarationMetaModel),
        ...
        objectCreationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(objectCreationExprMetaModel.anonymousClassBodyPropertyMetaModel);
        objectCreationExprMetaModel.argumentsPropertyMetaModel = new PropertyMetaModel(
                objectCreationExprMetaModel,
                "arguments",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        objectCreationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(objectCreationExprMetaModel.argumentsPropertyMetaModel);
        objectCreationExprMetaModel.scopePropertyMetaModel = new PropertyMetaModel(
                objectCreationExprMetaModel,
                "scope",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        objectCreationExprMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                objectCreationExprMetaModel,
                "type",
                com.github.javaparser.ast.type.ClassOrInterfaceType.class,
                Optional.of(classOrInterfaceTypeMetaModel),
        ...
        objectCreationExprMetaModel.typeArgumentsPropertyMetaModel = new PropertyMetaModel(
                objectCreationExprMetaModel,
                "typeArguments",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        objectCreationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(objectCreationExprMetaModel.typeArgumentsPropertyMetaModel);
        objectCreationExprMetaModel.usingDiamondOperatorPropertyMetaModel = new PropertyMetaModel(
                objectCreationExprMetaModel,
                "usingDiamondOperator",
                boolean.class,
                Optional.empty(),
        ...
        recordPatternExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(recordPatternExprMetaModel.patternListPropertyMetaModel);
        singleMemberAnnotationExprMetaModel.memberValuePropertyMetaModel = new PropertyMetaModel(
                singleMemberAnnotationExprMetaModel,
                "memberValue",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        singleMemberAnnotationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(singleMemberAnnotationExprMetaModel.memberValuePropertyMetaModel);
        simpleNameMetaModel.identifierPropertyMetaModel = new PropertyMetaModel(
                simpleNameMetaModel, "identifier", java.lang.String.class, Optional.empty(), false, true, false, false);
        simpleNameMetaModel.getDeclaredPropertyMetaModels().add(simpleNameMetaModel.identifierPropertyMetaModel);
        superExprMetaModel.typeNamePropertyMetaModel = new PropertyMetaModel(
                superExprMetaModel,
                "typeName",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        switchExprMetaModel.entriesPropertyMetaModel = new PropertyMetaModel(
                switchExprMetaModel,
                "entries",
        ...
        switchExprMetaModel.selectorPropertyMetaModel = new PropertyMetaModel(
                switchExprMetaModel,
                "selector",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        thisExprMetaModel.typeNamePropertyMetaModel = new PropertyMetaModel(
                thisExprMetaModel,
                "typeName",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        typeExprMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                typeExprMetaModel,
                "type",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        typePatternExprMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
        ...
        typePatternExprMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                typePatternExprMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        unaryExprMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                unaryExprMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        unaryExprMetaModel.operatorPropertyMetaModel = new PropertyMetaModel(
                unaryExprMetaModel,
                "operator",
        ...
        unaryExprMetaModel.postfixPropertyMetaModel = new PropertyMetaModel(
                unaryExprMetaModel, "postfix", boolean.class, Optional.empty(), false, false, false, false);
        ...
        variableDeclarationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(variableDeclarationExprMetaModel.annotationsPropertyMetaModel);
        variableDeclarationExprMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                variableDeclarationExprMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        variableDeclarationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(variableDeclarationExprMetaModel.modifiersPropertyMetaModel);
        variableDeclarationExprMetaModel.variablesPropertyMetaModel = new PropertyMetaModel(
                variableDeclarationExprMetaModel,
                "variables",
                com.github.javaparser.ast.body.VariableDeclarator.class,
                Optional.of(variableDeclaratorMetaModel),
        ...
        variableDeclarationExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(variableDeclarationExprMetaModel.variablesPropertyMetaModel);
        variableDeclarationExprMetaModel.maximumCommonTypePropertyMetaModel = new PropertyMetaModel(
                variableDeclarationExprMetaModel,
                "maximumCommonType",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        assertStmtMetaModel.checkPropertyMetaModel = new PropertyMetaModel(
                assertStmtMetaModel,
                "check",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        assertStmtMetaModel.messagePropertyMetaModel = new PropertyMetaModel(
                assertStmtMetaModel,
                "message",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        blockStmtMetaModel.contractsPropertyMetaModel = new PropertyMetaModel(
                blockStmtMetaModel,
                "contracts",
                com.github.javaparser.ast.jml.clauses.JmlContract.class,
                Optional.of(jmlContractMetaModel),
        ...
        blockStmtMetaModel.statementsPropertyMetaModel = new PropertyMetaModel(
                blockStmtMetaModel,
                "statements",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        breakStmtMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
                breakStmtMetaModel,
                "label",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        catchClauseMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
        ...
        catchClauseMetaModel.parameterPropertyMetaModel = new PropertyMetaModel(
                catchClauseMetaModel,
                "parameter",
                com.github.javaparser.ast.body.Parameter.class,
                Optional.of(parameterMetaModel),
        ...
        continueStmtMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
        ...
        doStmtMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                doStmtMetaModel,
                "body",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        doStmtMetaModel.conditionPropertyMetaModel = new PropertyMetaModel(
                doStmtMetaModel,
                "condition",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        doStmtMetaModel.contractsPropertyMetaModel = new PropertyMetaModel(
                doStmtMetaModel,
                "contracts",
                com.github.javaparser.ast.jml.clauses.JmlContract.class,
                Optional.of(jmlContractMetaModel),
        ...
        explicitConstructorInvocationStmtMetaModel.argumentsPropertyMetaModel = new PropertyMetaModel(
                explicitConstructorInvocationStmtMetaModel,
                "arguments",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        explicitConstructorInvocationStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(explicitConstructorInvocationStmtMetaModel.argumentsPropertyMetaModel);
        explicitConstructorInvocationStmtMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                explicitConstructorInvocationStmtMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        explicitConstructorInvocationStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(explicitConstructorInvocationStmtMetaModel.expressionPropertyMetaModel);
        explicitConstructorInvocationStmtMetaModel.isThisPropertyMetaModel = new PropertyMetaModel(
                explicitConstructorInvocationStmtMetaModel,
                "isThis",
                boolean.class,
                Optional.empty(),
        ...
        explicitConstructorInvocationStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(explicitConstructorInvocationStmtMetaModel.isThisPropertyMetaModel);
        explicitConstructorInvocationStmtMetaModel.typeArgumentsPropertyMetaModel = new PropertyMetaModel(
                explicitConstructorInvocationStmtMetaModel,
                "typeArguments",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        explicitConstructorInvocationStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(explicitConstructorInvocationStmtMetaModel.typeArgumentsPropertyMetaModel);
        explicitConstructorInvocationStmtMetaModel.usingDiamondOperatorPropertyMetaModel = new PropertyMetaModel(
                explicitConstructorInvocationStmtMetaModel,
                "usingDiamondOperator",
                boolean.class,
                Optional.empty(),
        ...
        expressionStmtMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
        ...
        forEachStmtMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
        ...
        forEachStmtMetaModel.contractsPropertyMetaModel = new PropertyMetaModel(
                forEachStmtMetaModel,
                "contracts",
                com.github.javaparser.ast.jml.clauses.JmlContract.class,
                Optional.of(jmlContractMetaModel),
        ...
        forEachStmtMetaModel.iterablePropertyMetaModel = new PropertyMetaModel(
                forEachStmtMetaModel,
                "iterable",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        forEachStmtMetaModel.variablePropertyMetaModel = new PropertyMetaModel(
                forEachStmtMetaModel,
                "variable",
        ...
        forStmtMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                forStmtMetaModel,
                "body",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        forStmtMetaModel.comparePropertyMetaModel = new PropertyMetaModel(
                forStmtMetaModel,
                "compare",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        forStmtMetaModel.contractsPropertyMetaModel = new PropertyMetaModel(
                forStmtMetaModel,
                "contracts",
                com.github.javaparser.ast.jml.clauses.JmlContract.class,
                Optional.of(jmlContractMetaModel),
        ...
        forStmtMetaModel.initializationPropertyMetaModel = new PropertyMetaModel(
                forStmtMetaModel,
                "initialization",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        forStmtMetaModel.updatePropertyMetaModel = new PropertyMetaModel(
                forStmtMetaModel,
                "update",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        ifStmtMetaModel.conditionPropertyMetaModel = new PropertyMetaModel(
                ifStmtMetaModel,
                "condition",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        ifStmtMetaModel.elseStmtPropertyMetaModel = new PropertyMetaModel(
                ifStmtMetaModel,
                "elseStmt",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        ifStmtMetaModel.thenStmtPropertyMetaModel = new PropertyMetaModel(
                ifStmtMetaModel,
                "thenStmt",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        ifStmtMetaModel.cascadingIfStmtPropertyMetaModel = new PropertyMetaModel(
                ifStmtMetaModel, "cascadingIfStmt", boolean.class, Optional.empty(), false, false, false, false);
        ifStmtMetaModel.getDerivedPropertyMetaModels().add(ifStmtMetaModel.cascadingIfStmtPropertyMetaModel);
        ifStmtMetaModel.elseBlockPropertyMetaModel = new PropertyMetaModel(
                ifStmtMetaModel, "elseBlock", boolean.class, Optional.empty(), false, false, false, false);
        ifStmtMetaModel.getDerivedPropertyMetaModels().add(ifStmtMetaModel.elseBlockPropertyMetaModel);
        ifStmtMetaModel.elseBranchPropertyMetaModel = new PropertyMetaModel(
                ifStmtMetaModel, "elseBranch", boolean.class, Optional.empty(), false, false, false, false);
        ifStmtMetaModel.getDerivedPropertyMetaModels().add(ifStmtMetaModel.elseBranchPropertyMetaModel);
        ifStmtMetaModel.thenBlockPropertyMetaModel = new PropertyMetaModel(
                ifStmtMetaModel, "thenBlock", boolean.class, Optional.empty(), false, false, false, false);
        ifStmtMetaModel.getDerivedPropertyMetaModels().add(ifStmtMetaModel.thenBlockPropertyMetaModel);
        labeledStmtMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
        ...
        labeledStmtMetaModel.statementPropertyMetaModel = new PropertyMetaModel(
                labeledStmtMetaModel,
                "statement",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        localClassDeclarationStmtMetaModel.classDeclarationPropertyMetaModel = new PropertyMetaModel(
                localClassDeclarationStmtMetaModel,
                "classDeclaration",
        ...
        localRecordDeclarationStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(localRecordDeclarationStmtMetaModel.recordDeclarationPropertyMetaModel);
        returnStmtMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                returnStmtMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        switchEntryMetaModel.guardPropertyMetaModel = new PropertyMetaModel(
        ...
        switchEntryMetaModel.labelsPropertyMetaModel = new PropertyMetaModel(
                switchEntryMetaModel,
                "labels",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        switchEntryMetaModel.statementsPropertyMetaModel = new PropertyMetaModel(
                switchEntryMetaModel,
                "statements",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        switchEntryMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                switchEntryMetaModel,
                "type",
        ...
        switchEntryMetaModel.switchStatementEntryPropertyMetaModel = new PropertyMetaModel(
                switchEntryMetaModel,
        ...
        switchStmtMetaModel.entriesPropertyMetaModel = new PropertyMetaModel(
                switchStmtMetaModel,
                "entries",
                com.github.javaparser.ast.stmt.SwitchEntry.class,
                Optional.of(switchEntryMetaModel),
        ...
        switchStmtMetaModel.selectorPropertyMetaModel = new PropertyMetaModel(
                switchStmtMetaModel,
                "selector",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        synchronizedStmtMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
        ...
        synchronizedStmtMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                synchronizedStmtMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        throwStmtMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                throwStmtMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        tryStmtMetaModel.catchClausesPropertyMetaModel = new PropertyMetaModel(
                tryStmtMetaModel,
                "catchClauses",
        ...
        tryStmtMetaModel.finallyBlockPropertyMetaModel = new PropertyMetaModel(
                tryStmtMetaModel,
                "finallyBlock",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
        ...
        tryStmtMetaModel.resourcesPropertyMetaModel = new PropertyMetaModel(
                tryStmtMetaModel,
                "resources",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        tryStmtMetaModel.tryBlockPropertyMetaModel = new PropertyMetaModel(
                tryStmtMetaModel,
                "tryBlock",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
        ...
        whileStmtMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                whileStmtMetaModel,
                "body",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        whileStmtMetaModel.conditionPropertyMetaModel = new PropertyMetaModel(
                whileStmtMetaModel,
                "condition",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        whileStmtMetaModel.contractsPropertyMetaModel = new PropertyMetaModel(
                whileStmtMetaModel,
                "contracts",
                com.github.javaparser.ast.jml.clauses.JmlContract.class,
                Optional.of(jmlContractMetaModel),
        ...
        yieldStmtMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                yieldStmtMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        arrayTypeMetaModel.componentTypePropertyMetaModel = new PropertyMetaModel(
                arrayTypeMetaModel,
                "componentType",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        arrayTypeMetaModel.originPropertyMetaModel = new PropertyMetaModel(
                arrayTypeMetaModel,
                "origin",
        ...
        classOrInterfaceTypeMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                classOrInterfaceTypeMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        classOrInterfaceTypeMetaModel
                .getDeclaredPropertyMetaModels()
                .add(classOrInterfaceTypeMetaModel.namePropertyMetaModel);
        classOrInterfaceTypeMetaModel.scopePropertyMetaModel = new PropertyMetaModel(
                classOrInterfaceTypeMetaModel,
                "scope",
                com.github.javaparser.ast.type.ClassOrInterfaceType.class,
                Optional.of(classOrInterfaceTypeMetaModel),
        ...
        classOrInterfaceTypeMetaModel
                .getDeclaredPropertyMetaModels()
                .add(classOrInterfaceTypeMetaModel.scopePropertyMetaModel);
        classOrInterfaceTypeMetaModel.typeArgumentsPropertyMetaModel = new PropertyMetaModel(
                classOrInterfaceTypeMetaModel,
                "typeArguments",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        classOrInterfaceTypeMetaModel
                .getDeclaredPropertyMetaModels()
                .add(classOrInterfaceTypeMetaModel.typeArgumentsPropertyMetaModel);
        classOrInterfaceTypeMetaModel.usingDiamondOperatorPropertyMetaModel = new PropertyMetaModel(
                classOrInterfaceTypeMetaModel,
                "usingDiamondOperator",
                boolean.class,
                Optional.empty(),
        ...
        intersectionTypeMetaModel.elementsPropertyMetaModel = new PropertyMetaModel(
        ...
        primitiveTypeMetaModel.typePropertyMetaModel = new PropertyMetaModel(
        ...
        typeParameterMetaModel.namePropertyMetaModel = new PropertyMetaModel(
        ...
        typeParameterMetaModel.typeBoundPropertyMetaModel = new PropertyMetaModel(
                typeParameterMetaModel,
                "typeBound",
                com.github.javaparser.ast.type.ClassOrInterfaceType.class,
                Optional.of(classOrInterfaceTypeMetaModel),
        ...
        unionTypeMetaModel.elementsPropertyMetaModel = new PropertyMetaModel(
                unionTypeMetaModel,
                "elements",
                com.github.javaparser.ast.type.ReferenceType.class,
                Optional.of(referenceTypeMetaModel),
        ...
        wildcardTypeMetaModel.extendedTypePropertyMetaModel = new PropertyMetaModel(
        ...
        wildcardTypeMetaModel.superTypePropertyMetaModel = new PropertyMetaModel(
                wildcardTypeMetaModel,
                "superType",
                com.github.javaparser.ast.type.ReferenceType.class,
                Optional.of(referenceTypeMetaModel),
        ...
        moduleExportsDirectiveMetaModel.moduleNamesPropertyMetaModel = new PropertyMetaModel(
                moduleExportsDirectiveMetaModel,
                "moduleNames",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        moduleExportsDirectiveMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleExportsDirectiveMetaModel.moduleNamesPropertyMetaModel);
        moduleExportsDirectiveMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                moduleExportsDirectiveMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        moduleExportsDirectiveMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleExportsDirectiveMetaModel.namePropertyMetaModel);
        moduleOpensDirectiveMetaModel.moduleNamesPropertyMetaModel = new PropertyMetaModel(
                moduleOpensDirectiveMetaModel,
                "moduleNames",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        moduleOpensDirectiveMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleOpensDirectiveMetaModel.moduleNamesPropertyMetaModel);
        moduleOpensDirectiveMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                moduleOpensDirectiveMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        moduleOpensDirectiveMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleOpensDirectiveMetaModel.namePropertyMetaModel);
        moduleProvidesDirectiveMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                moduleProvidesDirectiveMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        moduleProvidesDirectiveMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleProvidesDirectiveMetaModel.namePropertyMetaModel);
        moduleProvidesDirectiveMetaModel.withPropertyMetaModel = new PropertyMetaModel(
                moduleProvidesDirectiveMetaModel,
                "with",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        moduleProvidesDirectiveMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleProvidesDirectiveMetaModel.withPropertyMetaModel);
        moduleRequiresDirectiveMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                moduleRequiresDirectiveMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        moduleRequiresDirectiveMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleRequiresDirectiveMetaModel.modifiersPropertyMetaModel);
        moduleRequiresDirectiveMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                moduleRequiresDirectiveMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        moduleRequiresDirectiveMetaModel
                .getDeclaredPropertyMetaModels()
                .add(moduleRequiresDirectiveMetaModel.namePropertyMetaModel);
        moduleUsesDirectiveMetaModel.namePropertyMetaModel = new PropertyMetaModel(
        ...
        jmlDocDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlDocDeclarationMetaModel.jmlCommentsPropertyMetaModel);
        jmlDocStmtMetaModel.jmlCommentsPropertyMetaModel = new PropertyMetaModel(
                jmlDocStmtMetaModel,
                "jmlComments",
                com.github.javaparser.ast.jml.doc.JmlDoc.class,
                Optional.of(jmlDocMetaModel),
        ...
        jmlDocTypeMetaModel.jmlCommentsPropertyMetaModel = new PropertyMetaModel(
                jmlDocTypeMetaModel,
                "jmlComments",
                com.github.javaparser.ast.jml.doc.JmlDoc.class,
                Optional.of(jmlDocMetaModel),
        ...
        jmlQuantifiedExprMetaModel.binderPropertyMetaModel = new PropertyMetaModel(
                jmlQuantifiedExprMetaModel,
                "binder",
                com.github.javaparser.ast.jml.expr.JmlQuantifiedExpr.JmlBinder.class,
                Optional.empty(),
                false,
                false,
                false,
        ...
        jmlQuantifiedExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlQuantifiedExprMetaModel.binderPropertyMetaModel);
        jmlQuantifiedExprMetaModel.expressionsPropertyMetaModel = new PropertyMetaModel(
                jmlQuantifiedExprMetaModel,
                "expressions",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlBinaryInfixExprMetaModel.leftPropertyMetaModel = new PropertyMetaModel(
                jmlBinaryInfixExprMetaModel,
                "left",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlBinaryInfixExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlBinaryInfixExprMetaModel.leftPropertyMetaModel);
        jmlBinaryInfixExprMetaModel.operatorPropertyMetaModel = new PropertyMetaModel(
                jmlBinaryInfixExprMetaModel,
                "operator",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlBinaryInfixExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlBinaryInfixExprMetaModel.operatorPropertyMetaModel);
        jmlBinaryInfixExprMetaModel.rightPropertyMetaModel = new PropertyMetaModel(
                jmlBinaryInfixExprMetaModel,
                "right",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlBinaryInfixExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlBinaryInfixExprMetaModel.rightPropertyMetaModel);
        jmlLetExprMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(
                jmlLetExprMetaModel,
                "body",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlLetExprMetaModel.variablesPropertyMetaModel = new PropertyMetaModel(
                jmlLetExprMetaModel,
                "variables",
                com.github.javaparser.ast.expr.VariableDeclarationExpr.class,
                Optional.of(variableDeclarationExprMetaModel),
        ...
        jmlMultiCompareExprMetaModel.expressionsPropertyMetaModel = new PropertyMetaModel(
                jmlMultiCompareExprMetaModel,
                "expressions",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlMultiCompareExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMultiCompareExprMetaModel.expressionsPropertyMetaModel);
        jmlMultiCompareExprMetaModel.operatorsPropertyMetaModel = new PropertyMetaModel(
                jmlMultiCompareExprMetaModel,
                "operators",
                com.github.javaparser.ast.jml.expr.JmlMultiCompareExpr.Operators.class,
                Optional.empty(),
                false,
                false,
                false,
        ...
        jmlMultiCompareExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMultiCompareExprMetaModel.operatorsPropertyMetaModel);
        jmlLabelExprMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                jmlLabelExprMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
                false,
        ...
        jmlLabelExprMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                jmlLabelExprMetaModel,
                "kind",
                com.github.javaparser.ast.jml.expr.JmlLabelExpr.Kind.class,
                Optional.empty(),
                false,
                false,
                false,
        ...
        jmlLabelExprMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
                jmlLabelExprMetaModel,
                "label",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlSetComprehensionExprMetaModel.bindingPropertyMetaModel = new PropertyMetaModel(
                jmlSetComprehensionExprMetaModel,
                "binding",
                com.github.javaparser.ast.body.VariableDeclarator.class,
                Optional.of(variableDeclaratorMetaModel),
        ...
        jmlSetComprehensionExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlSetComprehensionExprMetaModel.bindingPropertyMetaModel);
        jmlSetComprehensionExprMetaModel.predicatePropertyMetaModel = new PropertyMetaModel(
                jmlSetComprehensionExprMetaModel,
                "predicate",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlSetComprehensionExprMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlSetComprehensionExprMetaModel.predicatePropertyMetaModel);
        jmlGhostStmtMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlGhostStmtMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
                false,
        ...
        jmlGhostStmtMetaModel.statementPropertyMetaModel = new PropertyMetaModel(
                jmlGhostStmtMetaModel,
                "statement",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        jmlExpressionStmtMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                jmlExpressionStmtMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlExpressionStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlExpressionStmtMetaModel.expressionPropertyMetaModel);
        jmlExpressionStmtMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlExpressionStmtMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlExpressionStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlExpressionStmtMetaModel.jmlTagsPropertyMetaModel);
        jmlExpressionStmtMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                jmlExpressionStmtMetaModel,
                "kind",
                com.github.javaparser.ast.jml.stmt.JmlExpressionStmt.JmlStmtKind.class,
                Optional.empty(),
                false,
                false,
                false,
        ...
        jmlExpressionStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlExpressionStmtMetaModel.kindPropertyMetaModel);
        jmlRefiningStmtMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
        ...
        jmlUnreachableStmtMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlUnreachableStmtMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlUnreachableStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlUnreachableStmtMetaModel.jmlTagsPropertyMetaModel);
        jmlLabelStmtMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlLabelStmtMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
                false,
        ...
        jmlLabelStmtMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
                jmlLabelStmtMetaModel,
                "label",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlBeginStmtMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
        ...
        jmlEndStmtMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlEndStmtMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlMethodDeclarationMetaModel.contractPropertyMetaModel = new PropertyMetaModel(
                jmlMethodDeclarationMetaModel,
                "contract",
                com.github.javaparser.ast.jml.clauses.JmlContract.class,
                Optional.of(jmlContractMetaModel),
        ...
        jmlMethodDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMethodDeclarationMetaModel.contractPropertyMetaModel);
        jmlMethodDeclarationMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlMethodDeclarationMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlMethodDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMethodDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlMethodDeclarationMetaModel.methodDeclarationPropertyMetaModel = new PropertyMetaModel(
                jmlMethodDeclarationMetaModel,
                "methodDeclaration",
                com.github.javaparser.ast.body.MethodDeclaration.class,
                Optional.of(methodDeclarationMetaModel),
                false,
                false,
                false,
                false);
        jmlMethodDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMethodDeclarationMetaModel.methodDeclarationPropertyMetaModel);
        jmlFieldDeclarationMetaModel.declPropertyMetaModel = new PropertyMetaModel(
                jmlFieldDeclarationMetaModel,
                "decl",
                com.github.javaparser.ast.body.FieldDeclaration.class,
                Optional.of(fieldDeclarationMetaModel),
                false,
                false,
                false,
                false);
        ...
        jmlFieldDeclarationMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlFieldDeclarationMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlFieldDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlFieldDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlClauseMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                jmlClauseMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlSimpleExprClauseMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                jmlSimpleExprClauseMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlSimpleExprClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlSimpleExprClauseMetaModel.expressionPropertyMetaModel);
        jmlSimpleExprClauseMetaModel.heapsPropertyMetaModel = new PropertyMetaModel(
                jmlSimpleExprClauseMetaModel,
                "heaps",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlSimpleExprClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlSimpleExprClauseMetaModel.heapsPropertyMetaModel);
        jmlSimpleExprClauseMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                jmlSimpleExprClauseMetaModel,
                "kind",
                com.github.javaparser.ast.jml.clauses.JmlClauseKind.class,
                Optional.empty(),
                false,
                false,
                false,
        ...
        jmlSimpleExprClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlSimpleExprClauseMetaModel.kindPropertyMetaModel);
        jmlMultiExprClauseMetaModel.expressionsPropertyMetaModel = new PropertyMetaModel(
                jmlMultiExprClauseMetaModel,
                "expressions",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlMultiExprClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMultiExprClauseMetaModel.expressionsPropertyMetaModel);
        jmlMultiExprClauseMetaModel.heapsPropertyMetaModel = new PropertyMetaModel(
                jmlMultiExprClauseMetaModel,
                "heaps",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlMultiExprClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMultiExprClauseMetaModel.heapsPropertyMetaModel);
        jmlMultiExprClauseMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                jmlMultiExprClauseMetaModel,
                "kind",
                com.github.javaparser.ast.jml.clauses.JmlClauseKind.class,
                Optional.empty(),
        ...
        jmlMultiExprClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMultiExprClauseMetaModel.kindPropertyMetaModel);
        jmlSignalsClauseMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                jmlSignalsClauseMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
                false,
        ...
        jmlSignalsClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlSignalsClauseMetaModel.expressionPropertyMetaModel);
        jmlSignalsClauseMetaModel.parameterPropertyMetaModel = new PropertyMetaModel(
                jmlSignalsClauseMetaModel,
                "parameter",
                com.github.javaparser.ast.body.Parameter.class,
                Optional.of(parameterMetaModel),
        ...
        jmlSignalsClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlSignalsClauseMetaModel.parameterPropertyMetaModel);
        jmlSignalsOnlyClauseMetaModel.typesPropertyMetaModel = new PropertyMetaModel(
                jmlSignalsOnlyClauseMetaModel,
                "types",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        jmlSignalsOnlyClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlSignalsOnlyClauseMetaModel.typesPropertyMetaModel);
        jmlLabledClauseMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
        ...
        jmlLabledClauseMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                jmlLabledClauseMetaModel,
                "kind",
                com.github.javaparser.ast.jml.clauses.JmlClauseKind.class,
                Optional.empty(),
                ...
                false,
                false);
        jmlLabledClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlLabledClauseMetaModel.kindPropertyMetaModel);
        jmlLabledClauseMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
                jmlLabledClauseMetaModel,
                "label",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
                ...
                false,
                false);
        jmlLabledClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlLabledClauseMetaModel.labelPropertyMetaModel);
        jmlForallClauseMetaModel.boundedVariablesPropertyMetaModel = new PropertyMetaModel(
                jmlForallClauseMetaModel,
                "boundedVariables",
                com.github.javaparser.ast.body.Parameter.class,
                Optional.of(parameterMetaModel),
        ...
        jmlForallClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlForallClauseMetaModel.boundedVariablesPropertyMetaModel);
        jmlOldClauseMetaModel.declarationsPropertyMetaModel = new PropertyMetaModel(
                jmlOldClauseMetaModel,
                "declarations",
                com.github.javaparser.ast.expr.VariableDeclarationExpr.class,
                Optional.of(variableDeclarationExprMetaModel),
                false,
        ...
        jmlCallableClauseMetaModel.methodSignaturesPropertyMetaModel = new PropertyMetaModel(
                jmlCallableClauseMetaModel,
                "methodSignatures",
                com.github.javaparser.ast.jml.clauses.JmlMethodSignature.class,
                Optional.of(jmlMethodSignatureMetaModel),
                false,
                false,
                true,
                false);
        jmlCallableClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlCallableClauseMetaModel.methodSignaturesPropertyMetaModel);
        jmlConditionalClauseMetaModel.conditionPropertyMetaModel = new PropertyMetaModel(
                jmlConditionalClauseMetaModel,
                "condition",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlConditionalClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlConditionalClauseMetaModel.conditionPropertyMetaModel);
        jmlConditionalClauseMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                jmlConditionalClauseMetaModel,
                "expression",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlConditionalClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlConditionalClauseMetaModel.expressionPropertyMetaModel);
        jmlConditionalClauseMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                jmlConditionalClauseMetaModel,
                "kind",
                com.github.javaparser.ast.jml.clauses.JmlClauseKind.class,
                Optional.empty(),
        ...
        jmlConditionalClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlConditionalClauseMetaModel.kindPropertyMetaModel);
        jmlMethodSignatureMetaModel.argumentTypesPropertyMetaModel = new PropertyMetaModel(
                jmlMethodSignatureMetaModel,
                "argumentTypes",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        jmlMethodSignatureMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMethodSignatureMetaModel.argumentTypesPropertyMetaModel);
        jmlMethodSignatureMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                jmlMethodSignatureMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlMethodSignatureMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMethodSignatureMetaModel.namePropertyMetaModel);
        jmlMethodSignatureMetaModel.receiverPropertyMetaModel = new PropertyMetaModel(
                jmlMethodSignatureMetaModel,
                "receiver",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        jmlMethodSignatureMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlMethodSignatureMetaModel.receiverPropertyMetaModel);
        jmlInfFlowClauseMetaModel.byPropertyMetaModel = new PropertyMetaModel(
                jmlInfFlowClauseMetaModel,
                "by",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
                ...
                true,
                false);
        jmlInfFlowClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlInfFlowClauseMetaModel.byPropertyMetaModel);
        jmlInfFlowClauseMetaModel.declassifiesPropertyMetaModel = new PropertyMetaModel(
                jmlInfFlowClauseMetaModel,
                "declassifies",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlInfFlowClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlInfFlowClauseMetaModel.declassifiesPropertyMetaModel);
        jmlInfFlowClauseMetaModel.erasesPropertyMetaModel = new PropertyMetaModel(
                jmlInfFlowClauseMetaModel,
                "erases",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlInfFlowClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlInfFlowClauseMetaModel.erasesPropertyMetaModel);
        jmlInfFlowClauseMetaModel.expressionsPropertyMetaModel = new PropertyMetaModel(
                jmlInfFlowClauseMetaModel,
                "expressions",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlInfFlowClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlInfFlowClauseMetaModel.expressionsPropertyMetaModel);
        jmlInfFlowClauseMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                jmlInfFlowClauseMetaModel,
                "kind",
                com.github.javaparser.ast.jml.clauses.JmlClauseKind.class,
                Optional.empty(),
                ...
                false,
                false);
        jmlInfFlowClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlInfFlowClauseMetaModel.kindPropertyMetaModel);
        jmlInfFlowClauseMetaModel.newObjectsPropertyMetaModel = new PropertyMetaModel(
                jmlInfFlowClauseMetaModel,
                "newObjects",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlInfFlowClauseMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlInfFlowClauseMetaModel.newObjectsPropertyMetaModel);
        ...
        jmlContractMetaModel.clausesPropertyMetaModel = new PropertyMetaModel(
                jmlContractMetaModel,
                "clauses",
                com.github.javaparser.ast.jml.clauses.JmlClause.class,
                Optional.of(jmlClauseMetaModel),
                false,
                false,
                true,
                false);
        jmlContractMetaModel.getDeclaredPropertyMetaModels().add(jmlContractMetaModel.clausesPropertyMetaModel);
        jmlContractMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlContractMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlContractMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                jmlContractMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        jmlContractMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                jmlContractMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlContractMetaModel.subContractsPropertyMetaModel = new PropertyMetaModel(
                jmlContractMetaModel,
                "subContracts",
                com.github.javaparser.ast.jml.clauses.JmlContract.class,
                Optional.of(jmlContractMetaModel),
        ...
        jmlContractMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                jmlContractMetaModel,
                "type",
                com.github.javaparser.ast.jml.clauses.ContractType.class,
                Optional.empty(),
                false,
                false,
                false,
        ...
        jmlClassExprDeclarationMetaModel.invariantPropertyMetaModel = new PropertyMetaModel(
                jmlClassExprDeclarationMetaModel,
                "invariant",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlClassExprDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassExprDeclarationMetaModel.invariantPropertyMetaModel);
        jmlClassExprDeclarationMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlClassExprDeclarationMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlClassExprDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassExprDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlClassExprDeclarationMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                jmlClassExprDeclarationMetaModel,
                "kind",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlClassExprDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassExprDeclarationMetaModel.kindPropertyMetaModel);
        jmlClassExprDeclarationMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                jmlClassExprDeclarationMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        jmlClassExprDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassExprDeclarationMetaModel.modifiersPropertyMetaModel);
        jmlClassExprDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                jmlClassExprDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlClassExprDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassExprDeclarationMetaModel.namePropertyMetaModel);
        jmlRepresentsDeclarationMetaModel.exprPropertyMetaModel = new PropertyMetaModel(
                jmlRepresentsDeclarationMetaModel,
                "expr",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlRepresentsDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlRepresentsDeclarationMetaModel.exprPropertyMetaModel);
        jmlRepresentsDeclarationMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlRepresentsDeclarationMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlRepresentsDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlRepresentsDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlRepresentsDeclarationMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                jmlRepresentsDeclarationMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        jmlRepresentsDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlRepresentsDeclarationMetaModel.modifiersPropertyMetaModel);
        jmlRepresentsDeclarationMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                jmlRepresentsDeclarationMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        jmlRepresentsDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlRepresentsDeclarationMetaModel.namePropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel.expressionsPropertyMetaModel = new PropertyMetaModel(
                jmlClassAccessibleDeclarationMetaModel,
                "expressions",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlClassAccessibleDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassAccessibleDeclarationMetaModel.expressionsPropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel.jmlTagsPropertyMetaModel = new PropertyMetaModel(
                jmlClassAccessibleDeclarationMetaModel,
                "jmlTags",
                com.github.javaparser.ast.expr.SimpleName.class,
                Optional.of(simpleNameMetaModel),
        ...
        jmlClassAccessibleDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassAccessibleDeclarationMetaModel.jmlTagsPropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel.measuredByPropertyMetaModel = new PropertyMetaModel(
                jmlClassAccessibleDeclarationMetaModel,
                "measuredBy",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlClassAccessibleDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassAccessibleDeclarationMetaModel.measuredByPropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(
                jmlClassAccessibleDeclarationMetaModel,
                "modifiers",
                com.github.javaparser.ast.Modifier.class,
                Optional.of(modifierMetaModel),
        ...
        jmlClassAccessibleDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassAccessibleDeclarationMetaModel.modifiersPropertyMetaModel);
        jmlClassAccessibleDeclarationMetaModel.variablePropertyMetaModel = new PropertyMetaModel(
                jmlClassAccessibleDeclarationMetaModel,
                "variable",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        jmlClassAccessibleDeclarationMetaModel
                .getDeclaredPropertyMetaModels()
                .add(jmlClassAccessibleDeclarationMetaModel.variablePropertyMetaModel);
        keyCatchAllStmtMetaModel.blockPropertyMetaModel = new PropertyMetaModel(
                ...
                false,
                false);
        keyCatchAllStmtMetaModel.getDeclaredPropertyMetaModels().add(keyCatchAllStmtMetaModel.blockPropertyMetaModel);
        keyCatchAllStmtMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
                keyCatchAllStmtMetaModel,
                "label",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
                ...
                false,
                false);
        keyCatchAllStmtMetaModel.getDeclaredPropertyMetaModels().add(keyCatchAllStmtMetaModel.labelPropertyMetaModel);
        keyCcatchBreakMetaModel.blockPropertyMetaModel = new PropertyMetaModel(
                keyCcatchBreakMetaModel,
                "block",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
                true,
        ...
        keyCcatchBreakMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
                keyCcatchBreakMetaModel,
                "label",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        keyCcatchContinueMetaModel.blockPropertyMetaModel = new PropertyMetaModel(
                keyCcatchContinueMetaModel,
                "block",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
                true,
        ...
        keyCcatchContinueMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyCcatchContinueMetaModel.blockPropertyMetaModel);
        keyCcatchContinueMetaModel.labelPropertyMetaModel = new PropertyMetaModel(
                keyCcatchContinueMetaModel,
                "label",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        keyCcatchContinueMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyCcatchContinueMetaModel.labelPropertyMetaModel);
        keyCcatchParameterMetaModel.blockPropertyMetaModel = new PropertyMetaModel(
                keyCcatchParameterMetaModel,
                "block",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
        ...
        keyCcatchParameterMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyCcatchParameterMetaModel.blockPropertyMetaModel);
        keyCcatchParameterMetaModel.parameterPropertyMetaModel = new PropertyMetaModel(
                keyCcatchParameterMetaModel,
                "parameter",
                com.github.javaparser.ast.body.Parameter.class,
                Optional.of(parameterMetaModel),
        ...
        keyCcatchParameterMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyCcatchParameterMetaModel.parameterPropertyMetaModel);
        keyCcatchReturnMetaModel.blockPropertyMetaModel = new PropertyMetaModel(
        ...
        keyCcatchReturnMetaModel.parameterPropertyMetaModel = new PropertyMetaModel(
                keyCcatchReturnMetaModel,
                "parameter",
                com.github.javaparser.ast.body.Parameter.class,
                Optional.of(parameterMetaModel),
        ...
        keyCcatchReturnMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyCcatchReturnMetaModel.parameterPropertyMetaModel);
        keyEscapeExpressionMetaModel.argumentsPropertyMetaModel = new PropertyMetaModel(
                keyEscapeExpressionMetaModel,
                "arguments",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        keyEscapeExpressionMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyEscapeExpressionMetaModel.argumentsPropertyMetaModel);
        keyEscapeExpressionMetaModel.calleePropertyMetaModel = new PropertyMetaModel(
                keyEscapeExpressionMetaModel,
                "callee",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        keyEscapeExpressionMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyEscapeExpressionMetaModel.calleePropertyMetaModel);
        keyExecStmtMetaModel.branchesPropertyMetaModel = new PropertyMetaModel(
                keyExecStmtMetaModel,
                "branches",
                com.github.javaparser.ast.key.KeyCcatchBranch.class,
                Optional.of(keyCcatchBranchMetaModel),
                false,
                false,
                true,
                false);
        keyExecStmtMetaModel.getDeclaredPropertyMetaModels().add(keyExecStmtMetaModel.branchesPropertyMetaModel);
        keyExecStmtMetaModel.execBlockPropertyMetaModel = new PropertyMetaModel(
                keyExecStmtMetaModel,
                "execBlock",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
                ...
                false,
                false);
        keyExecStmtMetaModel.getDeclaredPropertyMetaModels().add(keyExecStmtMetaModel.execBlockPropertyMetaModel);
        keyExecutionContextMetaModel.contextPropertyMetaModel = new PropertyMetaModel(
                keyExecutionContextMetaModel,
                "context",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        keyExecutionContextMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyExecutionContextMetaModel.contextPropertyMetaModel);
        keyExecutionContextMetaModel.instancePropertyMetaModel = new PropertyMetaModel(
                keyExecutionContextMetaModel,
                "instance",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        keyExecutionContextMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyExecutionContextMetaModel.instancePropertyMetaModel);
        keyExecutionContextMetaModel.signaturePropertyMetaModel = new PropertyMetaModel(
                keyExecutionContextMetaModel,
                "signature",
                com.github.javaparser.ast.key.KeyMethodSignature.class,
                Optional.of(keyMethodSignatureMetaModel),
                false,
                false,
                false,
                false);
        keyExecutionContextMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyExecutionContextMetaModel.signaturePropertyMetaModel);
        keyLoopScopeBlockStmtMetaModel.blockPropertyMetaModel = new PropertyMetaModel(
                keyLoopScopeBlockStmtMetaModel,
                "block",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
        ...
        keyLoopScopeBlockStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyLoopScopeBlockStmtMetaModel.blockPropertyMetaModel);
        keyLoopScopeBlockStmtMetaModel.indexPVPropertyMetaModel = new PropertyMetaModel(
                keyLoopScopeBlockStmtMetaModel,
                "indexPV",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        keyLoopScopeBlockStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyLoopScopeBlockStmtMetaModel.indexPVPropertyMetaModel);
        keyMergePointStmtMetaModel.exprPropertyMetaModel = new PropertyMetaModel(
                keyMergePointStmtMetaModel,
                "expr",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
                false,
        ...
        keyMergePointStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMergePointStmtMetaModel.exprPropertyMetaModel);
        keyMethodBodyStatementMetaModel.exprPropertyMetaModel = new PropertyMetaModel(
                keyMethodBodyStatementMetaModel,
                "expr",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        keyMethodBodyStatementMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodBodyStatementMetaModel.exprPropertyMetaModel);
        keyMethodBodyStatementMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                keyMethodBodyStatementMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        keyMethodBodyStatementMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodBodyStatementMetaModel.namePropertyMetaModel);
        keyMethodBodyStatementMetaModel.sourcePropertyMetaModel = new PropertyMetaModel(
                keyMethodBodyStatementMetaModel,
                "source",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        keyMethodBodyStatementMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodBodyStatementMetaModel.sourcePropertyMetaModel);
        keyMethodCallStmtMetaModel.blockPropertyMetaModel = new PropertyMetaModel(
                keyMethodCallStmtMetaModel,
                "block",
                com.github.javaparser.ast.stmt.BlockStmt.class,
                Optional.of(blockStmtMetaModel),
                false,
        ...
        keyMethodCallStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodCallStmtMetaModel.blockPropertyMetaModel);
        keyMethodCallStmtMetaModel.contextPropertyMetaModel = new PropertyMetaModel(
                keyMethodCallStmtMetaModel,
                "context",
                com.github.javaparser.ast.key.KeyAbstractExecutionContext.class,
        ...
        keyMethodCallStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodCallStmtMetaModel.contextPropertyMetaModel);
        keyMethodCallStmtMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                keyMethodCallStmtMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        keyMethodCallStmtMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodCallStmtMetaModel.namePropertyMetaModel);
        keyMethodSignatureMetaModel.namePropertyMetaModel = new PropertyMetaModel(
                keyMethodSignatureMetaModel,
                "name",
                com.github.javaparser.ast.expr.Name.class,
                Optional.of(nameMetaModel),
        ...
        keyMethodSignatureMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodSignatureMetaModel.namePropertyMetaModel);
        keyMethodSignatureMetaModel.paramTypesPropertyMetaModel = new PropertyMetaModel(
                keyMethodSignatureMetaModel,
                "paramTypes",
                com.github.javaparser.ast.type.Type.class,
                Optional.of(typeMetaModel),
        ...
        keyMethodSignatureMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodSignatureMetaModel.paramTypesPropertyMetaModel);
        keyTransactionStmtMetaModel.typePropertyMetaModel = new PropertyMetaModel(
                keyTransactionStmtMetaModel,
                "type",
                com.github.javaparser.ast.key.KeyTransactionStmt.TransactionType.class,
                Optional.empty(),
                false,
                false,
                false,
        ...
        keyContextStatementBlockMetaModel.contextPropertyMetaModel = new PropertyMetaModel(
                keyContextStatementBlockMetaModel,
                "context",
                com.github.javaparser.ast.key.sv.KeyExecCtxtSV.class,
                Optional.of(keyExecCtxtSVMetaModel),
                true,
                false,
                false,
                false);
        keyContextStatementBlockMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyContextStatementBlockMetaModel.contextPropertyMetaModel);
        keyContextStatementBlockMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(
                keyContextStatementBlockMetaModel,
                "expression",
                com.github.javaparser.ast.key.sv.KeyExpressionSV.class,
                Optional.of(keyExpressionSVMetaModel),
                true,
                false,
                false,
                false);
        keyContextStatementBlockMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyContextStatementBlockMetaModel.expressionPropertyMetaModel);
        keyContextStatementBlockMetaModel.signaturePropertyMetaModel = new PropertyMetaModel(
                keyContextStatementBlockMetaModel,
                "signature",
                com.github.javaparser.ast.key.sv.KeyMethodSignatureSV.class,
                Optional.of(keyMethodSignatureSVMetaModel),
                true,
                false,
                false,
                false);
        keyContextStatementBlockMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyContextStatementBlockMetaModel.signaturePropertyMetaModel);
        keyContextStatementBlockMetaModel.statementsPropertyMetaModel = new PropertyMetaModel(
                keyContextStatementBlockMetaModel,
                "statements",
                com.github.javaparser.ast.stmt.Statement.class,
                Optional.of(statementMetaModel),
        ...
        keyContextStatementBlockMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyContextStatementBlockMetaModel.statementsPropertyMetaModel);
        keyContextStatementBlockMetaModel.trPropertyMetaModel = new PropertyMetaModel(
                keyContextStatementBlockMetaModel,
                "tr",
                com.github.javaparser.ast.key.sv.KeyTypeSV.class,
                Optional.of(keyTypeSVMetaModel),
                true,
                false,
                false,
                false);
        ...
        keyExpressionSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyExpressionSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyExpressionSVMetaModel.getDeclaredPropertyMetaModels().add(keyExpressionSVMetaModel.textPropertyMetaModel);
        keyJumpLabelSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyJumpLabelSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyJumpLabelSVMetaModel.getDeclaredPropertyMetaModels().add(keyJumpLabelSVMetaModel.textPropertyMetaModel);
        keyMetaConstructMetaModel.childPropertyMetaModel = new PropertyMetaModel(
                ...
                false,
                false);
        keyMetaConstructMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructMetaModel.childPropertyMetaModel);
        keyMetaConstructMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                keyMetaConstructMetaModel,
                "kind",
                java.lang.String.class,
                Optional.empty(),
                ...
                false,
                false);
        keyMetaConstructMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructMetaModel.kindPropertyMetaModel);
        keyMetaConstructMetaModel.schemasPropertyMetaModel = new PropertyMetaModel(
                keyMetaConstructMetaModel,
                "schemas",
                com.github.javaparser.ast.Node.class,
                Optional.of(nodeMetaModel),
        ...
        keyMetaConstructMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMetaConstructMetaModel.schemasPropertyMetaModel);
        keyMetaConstructExpressionMetaModel.childPropertyMetaModel = new PropertyMetaModel(
                keyMetaConstructExpressionMetaModel,
                "child",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        keyMetaConstructExpressionMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMetaConstructExpressionMetaModel.childPropertyMetaModel);
        keyMetaConstructExpressionMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyMetaConstructExpressionMetaModel,
                "text",
                java.lang.String.class,
                Optional.empty(),
        ...
        keyMetaConstructExpressionMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMetaConstructExpressionMetaModel.textPropertyMetaModel);
        keyMetaConstructTypeMetaModel.exprPropertyMetaModel = new PropertyMetaModel(
                keyMetaConstructTypeMetaModel,
                "expr",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        keyMetaConstructTypeMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMetaConstructTypeMetaModel.exprPropertyMetaModel);
        keyMetaConstructTypeMetaModel.kindPropertyMetaModel = new PropertyMetaModel(
                keyMetaConstructTypeMetaModel,
                "kind",
                java.lang.String.class,
                Optional.empty(),
        ...
        keyMetaConstructTypeMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMetaConstructTypeMetaModel.kindPropertyMetaModel);
        keyMethodSignatureSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyMethodSignatureSVMetaModel,
                "text",
                java.lang.String.class,
                Optional.empty(),
        ...
        keyMethodSignatureSVMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyMethodSignatureSVMetaModel.textPropertyMetaModel);
        keyPassiveExpressionMetaModel.exprPropertyMetaModel = new PropertyMetaModel(
                keyPassiveExpressionMetaModel,
                "expr",
                com.github.javaparser.ast.expr.Expression.class,
                Optional.of(expressionMetaModel),
        ...
        keyPassiveExpressionMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyPassiveExpressionMetaModel.exprPropertyMetaModel);
        keyProgramVariableSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyProgramVariableSVMetaModel,
                "text",
                java.lang.String.class,
                Optional.empty(),
        ...
        keyProgramVariableSVMetaModel
                .getDeclaredPropertyMetaModels()
                .add(keyProgramVariableSVMetaModel.textPropertyMetaModel);
        keyStatementSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyStatementSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyStatementSVMetaModel.getDeclaredPropertyMetaModels().add(keyStatementSVMetaModel.textPropertyMetaModel);
        keyTypeSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyTypeSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyTypeSVMetaModel.getDeclaredPropertyMetaModels().add(keyTypeSVMetaModel.textPropertyMetaModel);
        keyCcatchSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyCcatchSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyCcatchSVMetaModel.getDeclaredPropertyMetaModels().add(keyCcatchSVMetaModel.textPropertyMetaModel);
        keyExecutionContextSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(
                keyExecutionContextSVMetaModel,
                "text",
                java.lang.String.class,
                Optional.empty(),
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlDocDeclarationMetaModel jmlDocDeclarationMetaModel =
            new JmlDocDeclarationMetaModel(Optional.of(bodyDeclarationMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlDocStmtMetaModel jmlDocStmtMetaModel =
            new JmlDocStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlDocTypeMetaModel jmlDocTypeMetaModel =
    ...
    public static final JmlStatementMetaModel jmlStatementMetaModel =
            new JmlStatementMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlGhostStmtMetaModel jmlGhostStmtMetaModel =
            new JmlGhostStmtMetaModel(Optional.of(jmlStatementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlExpressionStmtMetaModel jmlExpressionStmtMetaModel =
            new JmlExpressionStmtMetaModel(Optional.of(jmlStatementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlRefiningStmtMetaModel jmlRefiningStmtMetaModel =
            new JmlRefiningStmtMetaModel(Optional.of(jmlStatementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlUnreachableStmtMetaModel jmlUnreachableStmtMetaModel =
            new JmlUnreachableStmtMetaModel(Optional.of(jmlStatementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlLabelStmtMetaModel jmlLabelStmtMetaModel =
            new JmlLabelStmtMetaModel(Optional.of(jmlStatementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlBeginStmtMetaModel jmlBeginStmtMetaModel =
            new JmlBeginStmtMetaModel(Optional.of(jmlStatementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlEndStmtMetaModel jmlEndStmtMetaModel =
            new JmlEndStmtMetaModel(Optional.of(jmlStatementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlClassLevelDeclarationMetaModel jmlClassLevelDeclarationMetaModel =
            new JmlClassLevelDeclarationMetaModel(Optional.of(bodyDeclarationMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlMethodDeclarationMetaModel jmlMethodDeclarationMetaModel =
            new JmlMethodDeclarationMetaModel(Optional.of(jmlClassLevelDeclarationMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlFieldDeclarationMetaModel jmlFieldDeclarationMetaModel =
            new JmlFieldDeclarationMetaModel(Optional.of(jmlClassLevelDeclarationMetaModel));
    ...
    public static final JmlSimpleExprClauseMetaModel jmlSimpleExprClauseMetaModel =
            new JmlSimpleExprClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlMultiExprClauseMetaModel jmlMultiExprClauseMetaModel =
            new JmlMultiExprClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlSignalsClauseMetaModel jmlSignalsClauseMetaModel =
            new JmlSignalsClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlSignalsOnlyClauseMetaModel jmlSignalsOnlyClauseMetaModel =
            new JmlSignalsOnlyClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlLabledClauseMetaModel jmlLabledClauseMetaModel =
            new JmlLabledClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlForallClauseMetaModel jmlForallClauseMetaModel =
            new JmlForallClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlOldClauseMetaModel jmlOldClauseMetaModel =
            new JmlOldClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlCallableClauseMetaModel jmlCallableClauseMetaModel =
            new JmlCallableClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlConditionalClauseMetaModel jmlConditionalClauseMetaModel =
            new JmlConditionalClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlMethodSignatureMetaModel jmlMethodSignatureMetaModel =
            new JmlMethodSignatureMetaModel(Optional.of(nodeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlInfFlowClauseMetaModel jmlInfFlowClauseMetaModel =
            new JmlInfFlowClauseMetaModel(Optional.of(jmlClauseMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlContractMetaModel jmlContractMetaModel =
            new JmlContractMetaModel(Optional.of(nodeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlClassExprDeclarationMetaModel jmlClassExprDeclarationMetaModel =
            new JmlClassExprDeclarationMetaModel(Optional.of(jmlClassLevelDeclarationMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlRepresentsDeclarationMetaModel jmlRepresentsDeclarationMetaModel =
            new JmlRepresentsDeclarationMetaModel(Optional.of(jmlClassLevelDeclarationMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlClassAccessibleDeclarationMetaModel jmlClassAccessibleDeclarationMetaModel =
            new JmlClassAccessibleDeclarationMetaModel(Optional.of(jmlClassLevelDeclarationMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyAbstractExecutionContextMetaModel keyAbstractExecutionContextMetaModel =
            new KeyAbstractExecutionContextMetaModel(Optional.of(nodeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyCatchAllStmtMetaModel keyCatchAllStmtMetaModel =
            new KeyCatchAllStmtMetaModel(Optional.of(statementMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyCcatchBreakMetaModel keyCcatchBreakMetaModel =
            new KeyCcatchBreakMetaModel(Optional.of(keyCcatchBranchMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyCcatchContinueMetaModel keyCcatchContinueMetaModel =
            new KeyCcatchContinueMetaModel(Optional.of(keyCcatchBranchMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyCcatchParameterMetaModel keyCcatchParameterMetaModel =
            new KeyCcatchParameterMetaModel(Optional.of(keyCcatchBranchMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyCcatchReturnMetaModel keyCcatchReturnMetaModel =
            new KeyCcatchReturnMetaModel(Optional.of(keyCcatchBranchMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyEscapeExpressionMetaModel keyEscapeExpressionMetaModel =
            new KeyEscapeExpressionMetaModel(Optional.of(expressionMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyExecStmtMetaModel keyExecStmtMetaModel =
            new KeyExecStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyExecutionContextMetaModel keyExecutionContextMetaModel =
            new KeyExecutionContextMetaModel(Optional.of(keyAbstractExecutionContextMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyLoopScopeBlockStmtMetaModel keyLoopScopeBlockStmtMetaModel =
            new KeyLoopScopeBlockStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMergePointStmtMetaModel keyMergePointStmtMetaModel =
            new KeyMergePointStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMethodBodyStatementMetaModel keyMethodBodyStatementMetaModel =
            new KeyMethodBodyStatementMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMethodCallStmtMetaModel keyMethodCallStmtMetaModel =
            new KeyMethodCallStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMethodSignatureMetaModel keyMethodSignatureMetaModel =
            new KeyMethodSignatureMetaModel(Optional.of(nodeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyTransactionStmtMetaModel keyTransactionStmtMetaModel =
    ...
    public static final KeyExecCtxtSVMetaModel keyExecCtxtSVMetaModel =
            new KeyExecCtxtSVMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyExpressionSVMetaModel keyExpressionSVMetaModel =
            new KeyExpressionSVMetaModel(Optional.of(expressionMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyJumpLabelSVMetaModel keyJumpLabelSVMetaModel =
            new KeyJumpLabelSVMetaModel(Optional.of(nodeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMetaConstructMetaModel keyMetaConstructMetaModel =
            new KeyMetaConstructMetaModel(Optional.of(statementMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMetaConstructTypeMetaModel keyMetaConstructTypeMetaModel =
            new KeyMetaConstructTypeMetaModel(Optional.of(typeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMethodSignatureSVMetaModel keyMethodSignatureSVMetaModel =
            new KeyMethodSignatureSVMetaModel(Optional.of(nodeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyPassiveExpressionMetaModel keyPassiveExpressionMetaModel =
            new KeyPassiveExpressionMetaModel(Optional.of(expressionMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyProgramVariableSVMetaModel keyProgramVariableSVMetaModel =
            new KeyProgramVariableSVMetaModel(Optional.of(expressionMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyStatementSVMetaModel keyStatementSVMetaModel =
            new KeyStatementSVMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyTypeSVMetaModel keyTypeSVMetaModel = new KeyTypeSVMetaModel(Optional.of(typeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyCcatchSVMetaModel keyCcatchSVMetaModel =
            new KeyCcatchSVMetaModel(Optional.of(keyCcatchBranchMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyExecutionContextSVMetaModel keyExecutionContextSVMetaModel =
            new KeyExecutionContextSVMetaModel(Optional.of(keyAbstractExecutionContextMetaModel));
