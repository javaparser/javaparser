...
public final class JavaParserMetaModel {
    ...
    private static void initializeConstructorParameters() {
        ...
        matchAllPatternExprMetaModel.getConstructorParameters().add(matchAllPatternExprMetaModel.modifiersPropertyMetaModel);
        ...
        jmlConditionalClauseMetaModel.getConstructorParameters().add(jmlConditionalClauseMetaModel.conditionPropertyMetaModel);
        jmlConditionalClauseMetaModel.getConstructorParameters().add(jmlConditionalClauseMetaModel.kindPropertyMetaModel);
        jmlConditionalClauseMetaModel.getConstructorParameters().add(jmlConditionalClauseMetaModel.expressionPropertyMetaModel);
        ...
        jmlInfFlowClauseMetaModel.getConstructorParameters().add(jmlInfFlowClauseMetaModel.declassifiesPropertyMetaModel);
        jmlInfFlowClauseMetaModel.getConstructorParameters().add(jmlInfFlowClauseMetaModel.erasesPropertyMetaModel);
        jmlInfFlowClauseMetaModel.getConstructorParameters().add(jmlInfFlowClauseMetaModel.expressionsPropertyMetaModel);
        ...
        keyExecutionContextMetaModel.getConstructorParameters().add(keyExecutionContextMetaModel.contextPropertyMetaModel);
        keyExecutionContextMetaModel.getConstructorParameters().add(keyExecutionContextMetaModel.signaturePropertyMetaModel);
        keyExecutionContextMetaModel.getConstructorParameters().add(keyExecutionContextMetaModel.instancePropertyMetaModel);
        keyLoopScopeBlockStmtMetaModel.getConstructorParameters().add(keyLoopScopeBlockStmtMetaModel.indexPVPropertyMetaModel);
        keyLoopScopeBlockStmtMetaModel.getConstructorParameters().add(keyLoopScopeBlockStmtMetaModel.blockPropertyMetaModel);
        ...
        keyMethodSignatureMetaModel.getConstructorParameters().add(keyMethodSignatureMetaModel.paramTypesPropertyMetaModel);
        ...
        keyContextStatementBlockMetaModel.getConstructorParameters().add(keyContextStatementBlockMetaModel.signaturePropertyMetaModel);
        keyContextStatementBlockMetaModel.getConstructorParameters().add(keyContextStatementBlockMetaModel.expressionPropertyMetaModel);
        ...
        keyMetaConstructExpressionMetaModel.getConstructorParameters().add(keyMetaConstructExpressionMetaModel.textPropertyMetaModel);
        keyMetaConstructExpressionMetaModel.getConstructorParameters().add(keyMetaConstructExpressionMetaModel.childPropertyMetaModel);
        keyMetaConstructTypeMetaModel.getConstructorParameters().add(typeMetaModel.annotationsPropertyMetaModel);
        keyMetaConstructTypeMetaModel.getConstructorParameters().add(keyMetaConstructTypeMetaModel.kindPropertyMetaModel);
        keyMetaConstructTypeMetaModel.getConstructorParameters().add(keyMetaConstructTypeMetaModel.exprPropertyMetaModel);
        keyMethodSignatureSVMetaModel.getConstructorParameters().add(keyMethodSignatureSVMetaModel.textPropertyMetaModel);
    ...
    private static void initializePropertyMetaModels() {
        ...
        importDeclarationMetaModel.isModulePropertyMetaModel = new PropertyMetaModel(importDeclarationMetaModel, "isModule", boolean.class, Optional.empty(), false, false, false, false);
        importDeclarationMetaModel.getDeclaredPropertyMetaModels().add(importDeclarationMetaModel.isModulePropertyMetaModel);
        ...
        classOrInterfaceDeclarationMetaModel.isCompactPropertyMetaModel = new PropertyMetaModel(classOrInterfaceDeclarationMetaModel, "isCompact", boolean.class, Optional.empty(), false, false, false, false);
        classOrInterfaceDeclarationMetaModel.getDeclaredPropertyMetaModels().add(classOrInterfaceDeclarationMetaModel.isCompactPropertyMetaModel);
        ...
        constructorDeclarationMetaModel.bodyPropertyMetaModel = new PropertyMetaModel(constructorDeclarationMetaModel, "body", com.github.javaparser.ast.stmt.BlockStmt.class, Optional.of(blockStmtMetaModel), true, false, false, false);
        ...
        recordPatternExprMetaModel.patternListPropertyMetaModel = new PropertyMetaModel(recordPatternExprMetaModel, "patternList", com.github.javaparser.ast.expr.ComponentPatternExpr.class, Optional.of(componentPatternExprMetaModel), false, false, true, false);
        ...
        matchAllPatternExprMetaModel.modifiersPropertyMetaModel = new PropertyMetaModel(matchAllPatternExprMetaModel, "modifiers", com.github.javaparser.ast.Modifier.class, Optional.of(modifierMetaModel), false, false, true, false);
        matchAllPatternExprMetaModel.getDeclaredPropertyMetaModels().add(matchAllPatternExprMetaModel.modifiersPropertyMetaModel);
        ...
        jmlDocMetaModel.contentPropertyMetaModel = new PropertyMetaModel(jmlDocMetaModel, "content", java.lang.String.class, Optional.empty(), false, false, false, false);
        ...
        jmlLabledClauseMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(jmlLabledClauseMetaModel, "expression", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, false, false);
        jmlLabledClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlLabledClauseMetaModel.expressionPropertyMetaModel);
        jmlLabledClauseMetaModel.kindPropertyMetaModel = new PropertyMetaModel(jmlLabledClauseMetaModel, "kind", com.github.javaparser.ast.jml.clauses.JmlClauseKind.class, Optional.empty(), false, false, false, false);
        jmlLabledClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlLabledClauseMetaModel.kindPropertyMetaModel);
        jmlLabledClauseMetaModel.labelPropertyMetaModel = new PropertyMetaModel(jmlLabledClauseMetaModel, "label", com.github.javaparser.ast.expr.SimpleName.class, Optional.of(simpleNameMetaModel), true, false, false, false);
        ...
        jmlConditionalClauseMetaModel.conditionPropertyMetaModel = new PropertyMetaModel(jmlConditionalClauseMetaModel, "condition", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, false, false);
        jmlConditionalClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlConditionalClauseMetaModel.conditionPropertyMetaModel);
        jmlConditionalClauseMetaModel.expressionPropertyMetaModel = new PropertyMetaModel(jmlConditionalClauseMetaModel, "expression", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, false, false);
        jmlConditionalClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlConditionalClauseMetaModel.expressionPropertyMetaModel);
        jmlConditionalClauseMetaModel.kindPropertyMetaModel = new PropertyMetaModel(jmlConditionalClauseMetaModel, "kind", com.github.javaparser.ast.jml.clauses.JmlClauseKind.class, Optional.empty(), false, false, false, false);
        jmlConditionalClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlConditionalClauseMetaModel.kindPropertyMetaModel);
        ...
        jmlInfFlowClauseMetaModel.byPropertyMetaModel = new PropertyMetaModel(jmlInfFlowClauseMetaModel, "by", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, true, false);
        jmlInfFlowClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlInfFlowClauseMetaModel.byPropertyMetaModel);
        jmlInfFlowClauseMetaModel.declassifiesPropertyMetaModel = new PropertyMetaModel(jmlInfFlowClauseMetaModel, "declassifies", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, true, false);
        jmlInfFlowClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlInfFlowClauseMetaModel.declassifiesPropertyMetaModel);
        jmlInfFlowClauseMetaModel.erasesPropertyMetaModel = new PropertyMetaModel(jmlInfFlowClauseMetaModel, "erases", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, true, false);
        jmlInfFlowClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlInfFlowClauseMetaModel.erasesPropertyMetaModel);
        jmlInfFlowClauseMetaModel.expressionsPropertyMetaModel = new PropertyMetaModel(jmlInfFlowClauseMetaModel, "expressions", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, true, false);
        jmlInfFlowClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlInfFlowClauseMetaModel.expressionsPropertyMetaModel);
        jmlInfFlowClauseMetaModel.kindPropertyMetaModel = new PropertyMetaModel(jmlInfFlowClauseMetaModel, "kind", com.github.javaparser.ast.jml.clauses.JmlClauseKind.class, Optional.empty(), false, false, false, false);
        jmlInfFlowClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlInfFlowClauseMetaModel.kindPropertyMetaModel);
        jmlInfFlowClauseMetaModel.newObjectsPropertyMetaModel = new PropertyMetaModel(jmlInfFlowClauseMetaModel, "newObjects", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, true, false);
        jmlInfFlowClauseMetaModel.getDeclaredPropertyMetaModels().add(jmlInfFlowClauseMetaModel.newObjectsPropertyMetaModel);
        ...
        keyCatchAllStmtMetaModel.blockPropertyMetaModel = new PropertyMetaModel(keyCatchAllStmtMetaModel, "block", com.github.javaparser.ast.stmt.BlockStmt.class, Optional.of(blockStmtMetaModel), false, false, false, false);
        keyCatchAllStmtMetaModel.getDeclaredPropertyMetaModels().add(keyCatchAllStmtMetaModel.blockPropertyMetaModel);
        keyCatchAllStmtMetaModel.labelPropertyMetaModel = new PropertyMetaModel(keyCatchAllStmtMetaModel, "label", com.github.javaparser.ast.expr.Name.class, Optional.of(nameMetaModel), false, false, false, false);
        ...
        keyExecStmtMetaModel.branchesPropertyMetaModel = new PropertyMetaModel(keyExecStmtMetaModel, "branches", com.github.javaparser.ast.key.KeyCcatchBranch.class, Optional.of(keyCcatchBranchMetaModel), false, false, true, false);
        keyExecStmtMetaModel.getDeclaredPropertyMetaModels().add(keyExecStmtMetaModel.branchesPropertyMetaModel);
        keyExecStmtMetaModel.execBlockPropertyMetaModel = new PropertyMetaModel(keyExecStmtMetaModel, "execBlock", com.github.javaparser.ast.stmt.BlockStmt.class, Optional.of(blockStmtMetaModel), false, false, false, false);
        ...
        keyLoopScopeBlockStmtMetaModel.blockPropertyMetaModel = new PropertyMetaModel(keyLoopScopeBlockStmtMetaModel, "block", com.github.javaparser.ast.stmt.BlockStmt.class, Optional.of(blockStmtMetaModel), false, false, false, false);
        keyLoopScopeBlockStmtMetaModel.getDeclaredPropertyMetaModels().add(keyLoopScopeBlockStmtMetaModel.blockPropertyMetaModel);
        keyLoopScopeBlockStmtMetaModel.indexPVPropertyMetaModel = new PropertyMetaModel(keyLoopScopeBlockStmtMetaModel, "indexPV", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, false, false);
        keyLoopScopeBlockStmtMetaModel.getDeclaredPropertyMetaModels().add(keyLoopScopeBlockStmtMetaModel.indexPVPropertyMetaModel);
        keyMergePointStmtMetaModel.exprPropertyMetaModel = new PropertyMetaModel(keyMergePointStmtMetaModel, "expr", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, false, false);
        keyMergePointStmtMetaModel.getDeclaredPropertyMetaModels().add(keyMergePointStmtMetaModel.exprPropertyMetaModel);
        ...
        keyMethodCallStmtMetaModel.blockPropertyMetaModel = new PropertyMetaModel(keyMethodCallStmtMetaModel, "block", com.github.javaparser.ast.stmt.BlockStmt.class, Optional.of(blockStmtMetaModel), false, false, false, false);
        keyMethodCallStmtMetaModel.getDeclaredPropertyMetaModels().add(keyMethodCallStmtMetaModel.blockPropertyMetaModel);
        keyMethodCallStmtMetaModel.contextPropertyMetaModel = new PropertyMetaModel(keyMethodCallStmtMetaModel, "context", com.github.javaparser.ast.key.KeyAbstractExecutionContext.class, Optional.of(keyAbstractExecutionContextMetaModel), false, false, false, false);
        keyMethodCallStmtMetaModel.getDeclaredPropertyMetaModels().add(keyMethodCallStmtMetaModel.contextPropertyMetaModel);
        keyMethodCallStmtMetaModel.namePropertyMetaModel = new PropertyMetaModel(keyMethodCallStmtMetaModel, "name", com.github.javaparser.ast.expr.Name.class, Optional.of(nameMetaModel), true, false, false, false);
        keyMethodCallStmtMetaModel.getDeclaredPropertyMetaModels().add(keyMethodCallStmtMetaModel.namePropertyMetaModel);
        ...
        keyMethodSignatureMetaModel.paramTypesPropertyMetaModel = new PropertyMetaModel(keyMethodSignatureMetaModel, "paramTypes", com.github.javaparser.ast.type.Type.class, Optional.of(typeMetaModel), false, false, true, false);
        keyMethodSignatureMetaModel.getDeclaredPropertyMetaModels().add(keyMethodSignatureMetaModel.paramTypesPropertyMetaModel);
        keyTransactionStmtMetaModel.typePropertyMetaModel = new PropertyMetaModel(keyTransactionStmtMetaModel, "type", com.github.javaparser.ast.key.KeyTransactionStmt.TransactionType.class, Optional.empty(), false, false, false, false);
        keyTransactionStmtMetaModel.getDeclaredPropertyMetaModels().add(keyTransactionStmtMetaModel.typePropertyMetaModel);
        keYMarkerStatementMetaModel.kindPropertyMetaModel = new PropertyMetaModel(keYMarkerStatementMetaModel, "kind", int.class, Optional.empty(), false, false, false, false);
        keYMarkerStatementMetaModel.getDeclaredPropertyMetaModels().add(keYMarkerStatementMetaModel.kindPropertyMetaModel);
        ...
        keyContextStatementBlockMetaModel.getDeclaredPropertyMetaModels().add(keyContextStatementBlockMetaModel.expressionPropertyMetaModel);
        keyContextStatementBlockMetaModel.signaturePropertyMetaModel = new PropertyMetaModel(keyContextStatementBlockMetaModel, "signature", com.github.javaparser.ast.key.sv.KeyMethodSignatureSV.class, Optional.of(keyMethodSignatureSVMetaModel), true, false, false, false);
        keyContextStatementBlockMetaModel.getDeclaredPropertyMetaModels().add(keyContextStatementBlockMetaModel.signaturePropertyMetaModel);
        keyContextStatementBlockMetaModel.statementsPropertyMetaModel = new PropertyMetaModel(keyContextStatementBlockMetaModel, "statements", com.github.javaparser.ast.stmt.Statement.class, Optional.of(statementMetaModel), false, false, true, false);
        keyContextStatementBlockMetaModel.getDeclaredPropertyMetaModels().add(keyContextStatementBlockMetaModel.statementsPropertyMetaModel);
        keyContextStatementBlockMetaModel.trPropertyMetaModel = new PropertyMetaModel(keyContextStatementBlockMetaModel, "tr", com.github.javaparser.ast.key.sv.KeyTypeSV.class, Optional.of(keyTypeSVMetaModel), true, false, false, false);
        keyContextStatementBlockMetaModel.getDeclaredPropertyMetaModels().add(keyContextStatementBlockMetaModel.trPropertyMetaModel);
        keyExecCtxtSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(keyExecCtxtSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyExecCtxtSVMetaModel.getDeclaredPropertyMetaModels().add(keyExecCtxtSVMetaModel.textPropertyMetaModel);
        keyExpressionSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(keyExpressionSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyExpressionSVMetaModel.getDeclaredPropertyMetaModels().add(keyExpressionSVMetaModel.textPropertyMetaModel);
        keyJumpLabelSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(keyJumpLabelSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyJumpLabelSVMetaModel.getDeclaredPropertyMetaModels().add(keyJumpLabelSVMetaModel.textPropertyMetaModel);
        keyMetaConstructMetaModel.childPropertyMetaModel = new PropertyMetaModel(keyMetaConstructMetaModel, "child", com.github.javaparser.ast.Node.class, Optional.of(nodeMetaModel), false, false, false, false);
        keyMetaConstructMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructMetaModel.childPropertyMetaModel);
        keyMetaConstructMetaModel.kindPropertyMetaModel = new PropertyMetaModel(keyMetaConstructMetaModel, "kind", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyMetaConstructMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructMetaModel.kindPropertyMetaModel);
        keyMetaConstructMetaModel.schemasPropertyMetaModel = new PropertyMetaModel(keyMetaConstructMetaModel, "schemas", com.github.javaparser.ast.Node.class, Optional.of(nodeMetaModel), false, false, true, false);
        keyMetaConstructMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructMetaModel.schemasPropertyMetaModel);
        keyMetaConstructExpressionMetaModel.childPropertyMetaModel = new PropertyMetaModel(keyMetaConstructExpressionMetaModel, "child", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, false, false);
        keyMetaConstructExpressionMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructExpressionMetaModel.childPropertyMetaModel);
        keyMetaConstructExpressionMetaModel.textPropertyMetaModel = new PropertyMetaModel(keyMetaConstructExpressionMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyMetaConstructExpressionMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructExpressionMetaModel.textPropertyMetaModel);
        keyMetaConstructTypeMetaModel.exprPropertyMetaModel = new PropertyMetaModel(keyMetaConstructTypeMetaModel, "expr", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, false, false);
        keyMetaConstructTypeMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructTypeMetaModel.exprPropertyMetaModel);
        keyMetaConstructTypeMetaModel.kindPropertyMetaModel = new PropertyMetaModel(keyMetaConstructTypeMetaModel, "kind", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyMetaConstructTypeMetaModel.getDeclaredPropertyMetaModels().add(keyMetaConstructTypeMetaModel.kindPropertyMetaModel);
        keyMethodSignatureSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(keyMethodSignatureSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
        keyMethodSignatureSVMetaModel.getDeclaredPropertyMetaModels().add(keyMethodSignatureSVMetaModel.textPropertyMetaModel);
        keyPassiveExpressionMetaModel.exprPropertyMetaModel = new PropertyMetaModel(keyPassiveExpressionMetaModel, "expr", com.github.javaparser.ast.expr.Expression.class, Optional.of(expressionMetaModel), false, false, false, false);
        keyPassiveExpressionMetaModel.getDeclaredPropertyMetaModels().add(keyPassiveExpressionMetaModel.exprPropertyMetaModel);
        keyProgramVariableSVMetaModel.textPropertyMetaModel = new PropertyMetaModel(keyProgramVariableSVMetaModel, "text", java.lang.String.class, Optional.empty(), false, false, false, false);
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final TraditionalJavadocCommentMetaModel traditionalJavadocCommentMetaModel = new TraditionalJavadocCommentMetaModel(Optional.of(javadocCommentMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final LineCommentMetaModel lineCommentMetaModel = new LineCommentMetaModel(Optional.of(commentMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final MarkdownCommentMetaModel markdownCommentMetaModel = new MarkdownCommentMetaModel(Optional.of(javadocCommentMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final ComponentPatternExprMetaModel componentPatternExprMetaModel = new ComponentPatternExprMetaModel(Optional.of(expressionMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final PatternExprMetaModel patternExprMetaModel = new PatternExprMetaModel(Optional.of(componentPatternExprMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final MatchAllPatternExprMetaModel matchAllPatternExprMetaModel = new MatchAllPatternExprMetaModel(Optional.of(componentPatternExprMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlLabledClauseMetaModel jmlLabledClauseMetaModel = new JmlLabledClauseMetaModel(Optional.of(jmlClauseMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlConditionalClauseMetaModel jmlConditionalClauseMetaModel = new JmlConditionalClauseMetaModel(Optional.of(jmlClauseMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final JmlInfFlowClauseMetaModel jmlInfFlowClauseMetaModel = new JmlInfFlowClauseMetaModel(Optional.of(jmlClauseMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyCatchAllStmtMetaModel keyCatchAllStmtMetaModel = new KeyCatchAllStmtMetaModel(Optional.of(statementMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyExecStmtMetaModel keyExecStmtMetaModel = new KeyExecStmtMetaModel(Optional.of(statementMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyLoopScopeBlockStmtMetaModel keyLoopScopeBlockStmtMetaModel = new KeyLoopScopeBlockStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMergePointStmtMetaModel keyMergePointStmtMetaModel = new KeyMergePointStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMethodBodyStatementMetaModel keyMethodBodyStatementMetaModel = new KeyMethodBodyStatementMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMethodCallStmtMetaModel keyMethodCallStmtMetaModel = new KeyMethodCallStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMethodSignatureMetaModel keyMethodSignatureMetaModel = new KeyMethodSignatureMetaModel(Optional.of(nodeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyTransactionStmtMetaModel keyTransactionStmtMetaModel = new KeyTransactionStmtMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeYMarkerStatementMetaModel keYMarkerStatementMetaModel = new KeYMarkerStatementMetaModel(Optional.of(statementMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyExecCtxtSVMetaModel keyExecCtxtSVMetaModel = new KeyExecCtxtSVMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyExpressionSVMetaModel keyExpressionSVMetaModel = new KeyExpressionSVMetaModel(Optional.of(expressionMetaModel));
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMetaConstructMetaModel keyMetaConstructMetaModel = new KeyMetaConstructMetaModel(Optional.of(statementMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMetaConstructExpressionMetaModel keyMetaConstructExpressionMetaModel = new KeyMetaConstructExpressionMetaModel(Optional.of(expressionMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMetaConstructTypeMetaModel keyMetaConstructTypeMetaModel = new KeyMetaConstructTypeMetaModel(Optional.of(typeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyMethodSignatureSVMetaModel keyMethodSignatureSVMetaModel = new KeyMethodSignatureSVMetaModel(Optional.of(nodeMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyPassiveExpressionMetaModel keyPassiveExpressionMetaModel = new KeyPassiveExpressionMetaModel(Optional.of(expressionMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyProgramVariableSVMetaModel keyProgramVariableSVMetaModel = new KeyProgramVariableSVMetaModel(Optional.of(expressionMetaModel));

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final KeyStatementSVMetaModel keyStatementSVMetaModel = new KeyStatementSVMetaModel(Optional.of(statementMetaModel));
