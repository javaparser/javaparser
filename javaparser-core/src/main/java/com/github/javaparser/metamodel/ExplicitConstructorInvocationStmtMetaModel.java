...
public class ExplicitConstructorInvocationStmtMetaModel extends ClassMetaModel {
    ...
    ExplicitConstructorInvocationStmtMetaModel(JavaParserMetaModel parent, Optional<ClassMetaModel> superClassMetaModel) {
        ...
        fieldMetaModels.add(new FieldMetaModel(this, "getExpression", "setExpression", "expression", int.class, null, true, true, false, false));
        fieldMetaModels.add(new FieldMetaModel(this, "isThis", "setIsThis", "isThis", int.class, null, true, false, false, false));
