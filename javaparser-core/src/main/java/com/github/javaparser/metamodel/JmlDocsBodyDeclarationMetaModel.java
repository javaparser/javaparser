...
public class JmlDocsBodyDeclarationMetaModel extends BodyDeclarationMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlDocsBodyDeclarationMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(
                superBaseNodeMetaModel,
                JmlDocsBodyDeclaration.class,
                "JmlDocsBodyDeclaration",
