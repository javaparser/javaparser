...
public class JmlImportDeclarationMetaModel extends NodeMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlImportDeclarationMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, JmlImportDeclaration.class, "JmlImportDeclaration", "com.github.javaparser.ast.jml", false, false);
    }
