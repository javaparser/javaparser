...
import com.github.javaparser.ast.body.JmlClassLevel;
...
public class JmlClassLevelMetaModel extends NodeMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlClassLevelMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, JmlClassLevel.class, "JmlClassLevel", "com.github.javaparser.ast.body", true, false);
    }
