...
public class LambdaExprMetaModel extends ClassMetaModel {
    ...
    LambdaExprMetaModel(JavaParserMetaModel parent, Optional<ClassMetaModel> superClassMetaModel) {
        ...
        fieldMetaModels.add(new FieldMetaModel(this, "isEnclosingParameters", "setIsEnclosingParameters", "isEnclosingParameters", int.class, null, true, false, false, false));
