...
public class WildcardTypeMetaModel extends ClassMetaModel {
    ...
    WildcardTypeMetaModel(JavaParserMetaModel parent, Optional<ClassMetaModel> superClassMetaModel) {
        ...
        fieldMetaModels.add(new FieldMetaModel(this, "getExtendedTypes", "setExtendedTypes", "extendedTypes", int.class, null, true, false, false, false));
        fieldMetaModels.add(new FieldMetaModel(this, "getSuperTypes", "setSuperTypes", "superTypes", int.class, null, true, false, false, false));
    }
}
