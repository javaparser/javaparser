...
public class JavadocCommentMetaModel extends CommentMetaModel {
    ...
    JavadocCommentMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, JavadocComment.class, "JavadocComment", "com.github.javaparser.ast.comments", true, false);
    }

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    protected JavadocCommentMetaModel(Optional<BaseNodeMetaModel> superNodeMetaModel, Class<? extends Node> type, String name, String packageName, boolean isAbstract, boolean hasWildcard) {
