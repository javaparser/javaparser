...
public abstract class HashCodeVisitor implements GenericVisitor<Integer, Void> {
    ...
    public Integer visit(AnnotationMemberDeclaration n, Void arg) {
        return (n.getDefaultValue().isPresent() ? n.getDefaultValue().get().accept(this, arg) : 0) * 31 + (n.getModifiers().hashCode()) * 31 + (n.getName().accept(this, arg)) * 31 + (n.getType().accept(this, arg));
    }
    ...
    public Integer visit(ArrayType n, Void arg) {
        return (n.getComponentType().accept(this, arg));
    }
    ...
    public Integer visit(ClassOrInterfaceDeclaration n, Void arg) {
        return (n.getExtendedTypes().accept(this, arg)) * 31 + (n.getImplementedTypes().accept(this, arg)) * 31 + (n.isInterface() ? 1 : 0) * 31 + (n.getTypeParameters().accept(this, arg));
    }

    public Integer visit(ClassOrInterfaceType n, Void arg) {
        return (n.getName().accept(this, arg)) * 31 + (n.getScope().isPresent() ? n.getScope().get().accept(this, arg) : 0) * 31 + (n.getTypeArguments().isPresent() ? n.getTypeArguments().get().accept(this, arg) : 0);
    }

    public Integer visit(CompilationUnit n, Void arg) {
        return (n.getImports().accept(this, arg)) * 31 + (n.getPackageDeclaration().isPresent() ? n.getPackageDeclaration().get().accept(this, arg) : 0) * 31 + (n.getTypes().accept(this, arg));
    }
    ...
    public Integer visit(ConstructorDeclaration n, Void arg) {
        return (n.getBody().accept(this, arg)) * 31 + (n.getModifiers().hashCode()) * 31 + (n.getName().accept(this, arg)) * 31 + (n.getParameters().accept(this, arg)) * 31 + (n.getThrownExceptions().accept(this, arg)) * 31 + (n.getTypeParameters().accept(this, arg));
    }
    ...
    public Integer visit(EnclosedExpr n, Void arg) {
        return (n.getInner().isPresent() ? n.getInner().get().accept(this, arg) : 0);
    }

    public Integer visit(EnumConstantDeclaration n, Void arg) {
        return (n.getArguments().accept(this, arg)) * 31 + (n.getClassBody().accept(this, arg)) * 31 + (n.getName().accept(this, arg));
    }

    public Integer visit(EnumDeclaration n, Void arg) {
        return (n.getEntries().accept(this, arg)) * 31 + (n.getImplementedTypes().accept(this, arg));
    }
    ...
    public Integer visit(FieldDeclaration n, Void arg) {
        return (n.getModifiers().hashCode()) * 31 + (n.getVariables().accept(this, arg));
    }
    ...
    public Integer visit(InitializerDeclaration n, Void arg) {
        return (n.getBody().accept(this, arg)) * 31 + (n.isStatic() ? 1 : 0);
    }
    ...
    public Integer visit(MethodDeclaration n, Void arg) {
        return (n.getBody().isPresent() ? n.getBody().get().accept(this, arg) : 0) * 31 + (n.isDefault() ? 1 : 0) * 31 + (n.getModifiers().hashCode()) * 31 + (n.getName().accept(this, arg)) * 31 + (n.getParameters().accept(this, arg)) * 31 + (n.getThrownExceptions().accept(this, arg)) * 31 + (n.getType().accept(this, arg)) * 31 + (n.getTypeParameters().accept(this, arg));
    }
    ...
    public Integer visit(NormalAnnotationExpr n, Void arg) {
        return (n.getPairs().accept(this, arg));
    }
    ...
    public Integer visit(Parameter n, Void arg) {
        return (n.getAnnotations().accept(this, arg)) * 31 + (n.isVarArgs() ? 1 : 0) * 31 + (n.getModifiers().hashCode()) * 31 + (n.getName().accept(this, arg)) * 31 + (n.getType().accept(this, arg));
    }
    ...
    public Integer visit(TryStmt n, Void arg) {
        return (n.getCatchClauses().accept(this, arg)) * 31 + (n.getFinallyBlock().isPresent() ? n.getFinallyBlock().get().accept(this, arg) : 0) * 31 + (n.getResources().accept(this, arg)) * 31 + (n.getTryBlock().isPresent() ? n.getTryBlock().get().accept(this, arg) : 0);
    }
    ...
    public Integer visit(TypeParameter n, Void arg) {
        return (n.getName().accept(this, arg)) * 31 + (n.getTypeBound().accept(this, arg));
    }
    ...
    public Integer visit(WildcardType n, Void arg) {
        return (n.getExtendedTypes().isPresent() ? n.getExtendedTypes().get().accept(this, arg) : 0) * 31 + (n.getSuperTypes().isPresent() ? n.getSuperTypes().get().accept(this, arg) : 0);
    }
}
