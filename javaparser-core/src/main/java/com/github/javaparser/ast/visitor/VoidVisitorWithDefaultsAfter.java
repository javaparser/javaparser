...
/**
 * Adapted from {@link com.github.javaparser.ast.visitor.VoidVisitorWithDefaults}. <br>
 * <br>
 * A visitor that returns nothing, and has default methods that are used when a specific visit method is not overridden.<br>
 * The difference with {@link com.github.javaparser.ast.visitor.VoidVisitorWithDefaults} is that in addition to the default 
 * action before invoking the parent method there is another one to be invoked after.<br>
 * 
 */
