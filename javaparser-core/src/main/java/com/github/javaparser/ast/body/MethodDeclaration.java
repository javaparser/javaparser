...
public class MethodDeclaration extends CallableDeclaration<MethodDeclaration>
    ...
    public MethodDeclaration(
            ...
            final NodeList<ReferenceType> thrownExceptions,
            final BlockStmt body,
            ReceiverParameter receiverParameter, final NodeList<JmlContract> contracts) {
        this(
                null,
                modifiers,
                annotations,
    ...
    public MethodDeclaration(
            ...
            BlockStmt body,
            ReceiverParameter receiverParameter, NodeList<JmlContract> contracts) {
        super(
                tokenRange,
                modifiers,
                annotations,
