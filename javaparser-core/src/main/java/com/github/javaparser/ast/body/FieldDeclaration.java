...
public class FieldDeclaration extends BodyDeclaration<FieldDeclaration> implements NodeWithJavadoc<FieldDeclaration>, NodeWithVariables<FieldDeclaration>, NodeWithAccessModifiers<FieldDeclaration>, NodeWithStaticModifier<FieldDeclaration>, NodeWithFinalModifier<FieldDeclaration>, Resolvable<ResolvedFieldDeclaration> {
    ...
    public MethodDeclaration createGetter() {
        ...
        getter = parentClass.map(clazz -> clazz.addMethod("get" + fieldNameUpper, DefaultKeyword.PUBLIC)).orElseGet(() -> parentEnum.get().addMethod("get" + fieldNameUpper, DefaultKeyword.PUBLIC));
    ...
    public MethodDeclaration createSetter() {
        ...
        setter = parentClass.map(clazz -> clazz.addMethod("set" + fieldNameUpper, DefaultKeyword.PUBLIC)).orElseGet(() -> parentEnum.get().addMethod("set" + fieldNameUpper, DefaultKeyword.PUBLIC));
