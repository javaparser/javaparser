...
public class ArrayCreationExpr extends Expression {
    ...
    public ArrayCreationExpr setElementType(final Type elementType) {
        ...
        notifyPropertyChange(ObservableProperty.ELEMENT_TYPE, elementType, elementType);
        if (elementType != null) {
            elementType.setParentNode(null);
        }
    ...
    public ArrayCreationExpr setLevels(final NodeList<ArrayCreationLevel> levels) {
        ...
        notifyPropertyChange(ObservableProperty.LEVELS, levels, levels);
        if (levels != null) {
            levels.setParentNode(null);
        }
        this.levels = levels;
