...
/**
 * A class or an interface type. <br/>{@code Object} <br/><code>HashMap&lt;String, String></code>
 ...
 * cases like {@code Map.Entry} where Map is the scope of Entry. In <code>java.util.Punchcard</code>, it will not
