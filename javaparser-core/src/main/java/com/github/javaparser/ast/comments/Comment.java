...
public abstract class Comment extends Node {
    ...
    public LineComment asLineComment() {
        throw new IllegalStateException(f("%s is not an LineComment, it is %s", this, this.getClass().getSimpleName()));
    }
    ...
    public BlockComment asBlockComment() {
        throw new IllegalStateException(f("%s is not an BlockComment, it is %s", this, this.getClass().getSimpleName()));
    }
    ...
    public JavadocComment asJavadocComment() {
        throw new IllegalStateException(f("%s is not an JavadocComment, it is %s", this, this.getClass().getSimpleName()));
    }
