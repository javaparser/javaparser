...
public class NoCommentHashCodeVisitor implements GenericVisitor<Integer, Void> {
    ...
    public Integer visit(final JmlFunction n, final Void arg) {
        return (n.getArguments().accept(this, arg)) * 31 + (n.getFunctionName().accept(this, arg));
    }
    ...
    public Integer visit(final JmlClassExprDeclaration n, final Void arg) {
        return (n.getInvariant().accept(this, arg)) * 31 + (n.getKind().isPresent() ? n.getKind().get().accept(this, arg) : 0) * 31 + (n.getModifiers().accept(this, arg)) * 31 + (n.getAnnotations().accept(this, arg));
    }
    ...
    public Integer visit(final JmlRepresentsDeclaration n, final Void arg) {
        return (n.getExpr().accept(this, arg)) * 31 + (n.getModifiers().accept(this, arg)) * 31 + (n.getName().accept(this, arg)) * 31 + (n.getAnnotations().accept(this, arg));
    }

    @Override
    public Integer visit(final JmlContract n, final Void arg) {
        return (n.getBehavior().hashCode()) * 31 + (n.getClauses().accept(this, arg)) * 31 + (n.isLoopContract() ? 1 : 0) * 31 + (n.getModifiers().accept(this, arg)) * 31 + (n.getName().isPresent() ? n.getName().get().accept(this, arg) : 0) * 31 + (n.getSubContracts().accept(this, arg)) * 31 + (n.getType().hashCode());
    }
    ...
    public Integer visit(final JmlClassAxiomDeclaration n, final Void arg) {
        return (n.getExpr().accept(this, arg)) * 31 + (n.getModifiers().accept(this, arg)) * 31 + (n.getAnnotations().accept(this, arg));
    }
