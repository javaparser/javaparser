...
public class TreeStructureVisitor extends VoidVisitorAdapter<Context> {
    ...
    public interface Callback {
        ...
        void enterList(NodeList n, String name, int indent);

        void exitList(NodeList n, String name, int indent);
    }
    ...
    public void visit(NodeList n, Context arg) {
        callback.enterList(n, arg.name, arg.indent);
        ((NodeList<Node>) n).forEach( x -> x.accept(this, arg));
        callback.exitList(n, arg.name, arg.indent);
    }
