...
public class CloneVisitor implements GenericVisitor<Visitable, Object> {
    ...
    public Visitable visit(final JmlCallableClause n, final Object arg) {
        SimpleName name = cloneNode(n.getName(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        JmlCallableClause r = new JmlCallableClause(n.getTokenRange().orElse(null));
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    @Override
    public Visitable visit(final JmlClassInvariantDeclaration n, final Object arg) {
        Expression invariant = cloneNode(n.getInvariant(), arg);
        NodeList<Modifier> modifiers = cloneList(n.getModifiers(), arg);
        NodeList<AnnotationExpr> annotations = cloneList(n.getAnnotations(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        JmlClassInvariantDeclaration r = new JmlClassInvariantDeclaration(n.getTokenRange().orElse(null), modifiers, invariant);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    @Override
    public Visitable visit(final JmlClassAxiomDeclaration n, final Object arg) {
        Expression expr = cloneNode(n.getExpr(), arg);
        NodeList<Modifier> modifiers = cloneList(n.getModifiers(), arg);
        NodeList<AnnotationExpr> annotations = cloneList(n.getAnnotations(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        JmlClassAxiomDeclaration r = new JmlClassAxiomDeclaration(n.getTokenRange().orElse(null), modifiers, expr);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
