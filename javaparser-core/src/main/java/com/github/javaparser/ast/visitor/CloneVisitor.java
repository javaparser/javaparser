...
public class CloneVisitor implements GenericVisitor<Visitable, Object> {
    ...
    public Visitable visit(final AccessibleClause n, final Object arg) {
        ...
        Comment comment = cloneNode(n.getComment(), arg);
        AccessibleClause r = new AccessibleClause(n.getTokenRange().orElse(null), heaps, exprs, measuredBy);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final JmlLabel n, final Object arg) {
        Comment comment = cloneNode(n.getComment(), arg);
        JmlLabel r = new JmlLabel(n.getTokenRange().orElse(null));
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final JmlSetStmt n, final Object arg) {
        Comment comment = cloneNode(n.getComment(), arg);
        JmlSetStmt r = new JmlSetStmt(n.getTokenRange().orElse(null));
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final LoopInvariantClause n, final Object arg) {
        Comment comment = cloneNode(n.getComment(), arg);
        LoopInvariantClause r = new LoopInvariantClause(n.getTokenRange().orElse(null));
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final MeasuredByClause n, final Object arg) {
        ...
        Comment comment = cloneNode(n.getComment(), arg);
        MeasuredByClause r = new MeasuredByClause(n.getTokenRange().orElse(null), e);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final ModifiesClause n, final Object arg) {
        Comment comment = cloneNode(n.getComment(), arg);
        ModifiesClause r = new ModifiesClause(n.getTokenRange().orElse(null));
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final SignalsClause n, final Object arg) {
        ...
        Type type = cloneNode(n.getType(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        SignalsClause r = new SignalsClause(n.getTokenRange().orElse(null), type, name, expr);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final SignalsOnlyClause n, final Object arg) {
        ...
        Comment comment = cloneNode(n.getComment(), arg);
        SignalsOnlyClause r = new SignalsOnlyClause(n.getTokenRange().orElse(null), types);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    @Override
    public Visitable visit(final JmlDebugStmt n, final Object arg) {
        Comment comment = cloneNode(n.getComment(), arg);
        JmlDebugStmt r = new JmlDebugStmt(n.getTokenRange().orElse(null));
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    @Override
    public Visitable visit(final JmlFunction n, final Object arg) {
        NodeList<Expression> arguments = cloneList(n.getArguments(), arg);
        JmlName functionName = cloneNode(n.getFunctionName(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        JmlFunction r = new JmlFunction(n.getTokenRange().orElse(null), functionName, arguments);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    @Override
    public Visitable visit(final JmlHenceByStmt n, final Object arg) {
        Comment comment = cloneNode(n.getComment(), arg);
        JmlHenceByStmt r = new JmlHenceByStmt(n.getTokenRange().orElse(null));
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    @Override
    public Visitable visit(final JmlName n, final Object arg) {
        JmlName qualifier = cloneNode(n.getQualifier(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        JmlName r = new JmlName(n.getTokenRange().orElse(null), n.getIdentifier());
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    @Override
    public Visitable visit(final OldClause n, final Object arg) {
        NodeList<VariableDeclarator> variables = cloneList(n.getVariables(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        OldClause r = new OldClause(n.getTokenRange().orElse(null), variables);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final WhenClause n, final Object arg) {
        Comment comment = cloneNode(n.getComment(), arg);
        WhenClause r = new WhenClause(n.getTokenRange().orElse(null));
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final JmlContract n, final Object arg) {
        ...
        Modifier modifier = cloneNode(n.getModifier(), arg);
        NodeList<JmlContract> subContracts = cloneList(n.getSubContracts(), arg);
        Comment comment = cloneNode(n.getComment(), arg);
        JmlContract r = new JmlContract(n.getTokenRange().orElse(null), n.getBehavior(), modifier, clauses, subContracts);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
