...
public class ConcreteSyntaxModel {
    ...
    static {
        ...
        concreteSyntaxModelByClass.put(ClassOrInterfaceDeclaration.class, sequence(conditional(ObservableProperty.COMPACT, FLAG, list(ObservableProperty.MEMBERS, sequence(newline(), newline()), newline(), none()), sequence(comment(), memberAnnotations(), modifiers(), conditional(ObservableProperty.INTERFACE, FLAG, token(GeneratedJavaParserConstants.INTERFACE), token(GeneratedJavaParserConstants.CLASS)), space(), child(ObservableProperty.NAME), list(TYPE_PARAMETERS, sequence(comma(), space()), string(GeneratedJavaParserConstants.LT), string(GeneratedJavaParserConstants.GT)), list(ObservableProperty.EXTENDED_TYPES, sequence(string(GeneratedJavaParserConstants.COMMA), space()), sequence(space(), token(GeneratedJavaParserConstants.EXTENDS), space()), none()), list(ObservableProperty.IMPLEMENTED_TYPES, sequence(string(GeneratedJavaParserConstants.COMMA), space()), sequence(space(), token(GeneratedJavaParserConstants.IMPLEMENTS), space()), none()), space(), list(ObservableProperty.PERMITTED_TYPES, sequence(string(GeneratedJavaParserConstants.COMMA), space()), sequence(space(), token(GeneratedJavaParserConstants.PERMITS), space()), none()), block(sequence(newline(), list(ObservableProperty.MEMBERS, sequence(newline(), newline()), newline(), newline())))))));
        ...
        concreteSyntaxModelByClass.put(Parameter.class, sequence(comment(), mix(onlineAnnotations(), modifiers()), child(ObservableProperty.TYPE), conditional(ObservableProperty.VAR_ARGS, FLAG, sequence(list(ObservableProperty.VAR_ARGS_ANNOTATIONS, space(), none(), none()), token(GeneratedJavaParserConstants.ELLIPSIS))), space(), child(ObservableProperty.NAME)));
        ...
        concreteSyntaxModelByClass.put(VariableDeclarator.class, sequence(/* FIXME: we should introduce a derived property */
        ...
        concreteSyntaxModelByClass.put(MatchAllPatternExpr.class, sequence(comment(), token(GeneratedJavaParserConstants.UNNAMED_PLACEHOLDER)));
        ...
        concreteSyntaxModelByClass.put(RecordPatternExpr.class, sequence(comment(), child(ObservableProperty.TYPE), space(), token(GeneratedJavaParserConstants.LPAREN), list(ObservableProperty.PATTERN_LIST, sequence(comma(), space()), none(), none()), token(GeneratedJavaParserConstants.RPAREN)));
        ...
        concreteSyntaxModelByClass.put(LocalRecordDeclarationStmt.class, sequence(comment(), child(ObservableProperty.RECORD_DECLARATION)));
        ...
        concreteSyntaxModelByClass.put(SwitchEntry.class, sequence(comment(), conditional(SWITCH_STATEMENT_ENTRY, FLAG, sequence(conditional(ObservableProperty.LABELS, IS_NOT_EMPTY, sequence(token(GeneratedJavaParserConstants.CASE), space(), list(ObservableProperty.LABELS)), token(GeneratedJavaParserConstants._DEFAULT)), token(GeneratedJavaParserConstants.COLON), newline()), sequence(conditional(ObservableProperty.LABELS, IS_NOT_EMPTY, conditional(ObservableProperty.DEFAULT, FLAG, sequence(token(GeneratedJavaParserConstants.CASE), space(), list(ObservableProperty.LABELS), comma(), space(), token(GeneratedJavaParserConstants._DEFAULT)), sequence(token(GeneratedJavaParserConstants.CASE), space(), list(ObservableProperty.LABELS), conditional(ObservableProperty.GUARD, IS_PRESENT, sequence(space(), token(GeneratedJavaParserConstants.WHEN), space(), child(ObservableProperty.GUARD))))), token(GeneratedJavaParserConstants._DEFAULT)), space(), token(GeneratedJavaParserConstants.ARROW), space())), indent(), list(ObservableProperty.STATEMENTS, newline(), none(), newline()), unindent()));
        ...
        concreteSyntaxModelByClass.put(ImportDeclaration.class, sequence(comment(), token(GeneratedJavaParserConstants.IMPORT), space(), conditional(ObservableProperty.STATIC, FLAG, sequence(token(GeneratedJavaParserConstants.STATIC), space())), conditional(ObservableProperty.MODULE, FLAG, sequence(token(GeneratedJavaParserConstants.MODULE), space())), child(ObservableProperty.NAME), conditional(ASTERISK, FLAG, sequence(token(GeneratedJavaParserConstants.DOT), token(GeneratedJavaParserConstants.STAR))), semicolon(), orphanCommentsEnding()));
        ...
        // region JML
        concreteSyntaxModelByClass.put(JmlConditionalClause.class, sequence(attribute(KIND), attribute(CONDITION), token(WHEN), attribute(CONDITION)));
        concreteSyntaxModelByClass.put(JmlLabelStmt.class, sequence(list(JML_TAGS), attribute(LABEL), token(COLON)));
        concreteSyntaxModelByClass.put(JmlMethodSignature.class, sequence(attribute(NAME), token(LPAREN), list(ARGUMENT_TYPES, token(COMMA)), token(RPAREN)));
        concreteSyntaxModelByClass.put(JmlSetComprehensionExpr.class, sequence(token(LBRACE), space(), attribute(BINDING), space(), token(OR), space(), attribute(PREDICATE), space(), token(RBRACE)));
        concreteSyntaxModelByClass.put(JmlForallClause.class, sequence(token(GeneratedJavaParserConstants.FORALL), space(), child(ObservableProperty.VARIABLES), semicolon(), newline()));
        concreteSyntaxModelByClass.put(JmlSimpleExprClause.class, sequence(child(ObservableProperty.KIND), child(HEAPS), space(), child(EXPRESSION), semicolon(), newline()));
        ...
        concreteSyntaxModelByClass.put(JmlLabledClause.class, sequence(child(ObservableProperty.KIND), token(LPAREN), child(LABEL), token(RPAREN), space(), child(EXPRESSION), semicolon(), newline()));
        concreteSyntaxModelByClass.put(JmlCallableClause.class, sequence(child(MODIFIERS), token(CALLABLE), semicolon()));
        concreteSyntaxModelByClass.put(JmlClassExprDeclaration.class, sequence(child(MODIFIERS), space(), token(INVARIANT), space(), child(EXPRESSION), semicolon()));
        ...
        concreteSyntaxModelByClass.put(JmlGhostStmt.class, sequence(list(JML_TAGS), token(GHOST), attribute(STATEMENT)));
        concreteSyntaxModelByClass.put(JmlLabelExpr.class, sequence(token(LPAREN), attribute(KIND), space(), child(LABEL), space(), child(EXPRESSION), token(RPAREN)));
        concreteSyntaxModelByClass.put(JmlLetExpr.class, sequence(token(LPAREN), token(LET), space(), list(VARIABLES), space(), child(BODY), token(RPAREN)));
        ...
        concreteSyntaxModelByClass.put(JmlTypeExpr.class, sequence(child(ObservableProperty.TYPE)));
        concreteSyntaxModelByClass.put(JmlClassExprDeclaration.class, sequence(modifiers(), attribute(KIND), attribute(NAME), child(EXPR), semicolon()));
        concreteSyntaxModelByClass.put(JmlUnreachableStmt.class, sequence(token(UNREACHABLE), semicolon()));
        concreteSyntaxModelByClass.put(JmlBinaryInfixExpr.class, sequence(token(LPAREN), child(LEFT), space(), child(OPERATOR), space(), child(RIGHT), token(RPAREN)));
        ...
        concreteSyntaxModelByClass.put(JmlOldClause.class, sequence(token(OLD), space(), child(DECLARATIONS), semicolon()));
        ...
        concreteSyntaxModelByClass.put(JmlSignalsClause.class, sequence(child(KIND), token(LPAREN), child(TYPE), child(NAME), token(RPAREN), child(EXPR), semicolon()));
        ...
        concreteSyntaxModelByClass.put(KeyLoopScopeBlockStmt.class, sequence(token(LOOPSCOPE), token(LPAREN), attribute(INDEX_P_V), token(RPAREN), token(LBRACE), newline(), attribute(BLOCK), newline(), token(RBRACE)));
        ...
        concreteSyntaxModelByClass.put(KeyPassiveExpression.class, sequence(token(AT), token(LPAREN), attribute(EXPR), token(RPAREN)));
