    ...
    static {
        ...
        concreteSyntaxModelByClass.put(
                ...
                sequence(
                        ...
                        conditional(
                                ...
                                IS_PRESENT,
                                sequence(child(ObservableProperty.QUALIFIER), token(GeneratedJavaParserConstants.DOT))),
                        attribute(ObservableProperty.IDENTIFIER),
                        orphanCommentsEnding()));
        concreteSyntaxModelByClass.put(
                NameExpr.class, sequence(comment(), child(ObservableProperty.NAME), orphanCommentsEnding()));
        concreteSyntaxModelByClass.put(
                ...
                sequence(
                        ...
                        token(GeneratedJavaParserConstants.AT),
                        child(ObservableProperty.NAME),
                        conditional(ObservableProperty.PAIRS, IS_NOT_EMPTY, token(GeneratedJavaParserConstants.LPAREN)),
                        list(ObservableProperty.PAIRS, sequence(comma(), space())),
                        conditional(
                                ObservableProperty.PAIRS, IS_NOT_EMPTY, token(GeneratedJavaParserConstants.RPAREN))));
        concreteSyntaxModelByClass.put(
        ...
        concreteSyntaxModelByClass.put(
                ...
                sequence(
                        ...
                        space(),
                        token(GeneratedJavaParserConstants.LPAREN),
                        list(ObservableProperty.PATTERN_LIST, sequence(comma(), space()), none(), none()),
                        token(GeneratedJavaParserConstants.RPAREN)));
        ...
        concreteSyntaxModelByClass.put(
                ...
                sequence(orphanCommentsBeforeThis(), comment(), child(ObservableProperty.EXPRESSION), semicolon()));
        concreteSyntaxModelByClass.put(
                ForEachStmt.class,
                sequence(
                        comment(),
                ...
                sequence(
                        ...
                        conditional(
                                ...
                                sequence(
                                        ...
                                        conditional(
                                                Arrays.asList(
                                                        ObservableProperty.ELSE_BLOCK,
                                                        ObservableProperty.CASCADING_IF_STMT),
                                                CsmConditional.Condition.FLAG,
        ...
        concreteSyntaxModelByClass.put(
                ...
                sequence(
                        comment(),
                        conditional(
                                SCOPE, IS_PRESENT, sequence(child(SCOPE), string(GeneratedJavaParserConstants.DOT))),
        ...
        concreteSyntaxModelByClass.put(
                PrimitiveType.class,
                sequence(comment(), list(ObservableProperty.ANNOTATIONS), attribute(ObservableProperty.TYPE)));
        concreteSyntaxModelByClass.put(
                TypeParameter.class,
                sequence(
                        comment(),
        ...
        concreteSyntaxModelByClass.put(
                VoidType.class, sequence(comment(), annotations(), token(GeneratedJavaParserConstants.VOID)));
        concreteSyntaxModelByClass.put(
                VarType.class,
        ...
        concreteSyntaxModelByClass.put(
                ...
                sequence(attribute(KIND), attribute(CONDITION), token(WHEN), attribute(CONDITION)));
        ...
        concreteSyntaxModelByClass.put(
                ...
                sequence(attribute(NAME), token(LPAREN), list(ARGUMENT_TYPES, token(COMMA)), token(RPAREN)));
        concreteSyntaxModelByClass.put(
        ...
        concreteSyntaxModelByClass.put(
                ...
                sequence(
                        ...
                        newline()));
        concreteSyntaxModelByClass.put(
                JmlCallableClause.class, sequence(child(MODIFIERS), token(CALLABLE), semicolon()));
        concreteSyntaxModelByClass.put(
        ...
        concreteSyntaxModelByClass.put(
                JmlGhostStmt.class, sequence(list(JML_TAGS), token(GHOST), attribute(STATEMENT)));
        concreteSyntaxModelByClass.put(
                JmlLabelExpr.class,
                sequence(
                        token(LPAREN),
        ...
        concreteSyntaxModelByClass.put(
                JmlExpressionStmt.class, sequence(child(KIND), space(), child(EXPRESSION), semicolon()));
        concreteSyntaxModelByClass.put(JmlTypeExpr.class, sequence(child(ObservableProperty.TYPE)));
        concreteSyntaxModelByClass.put(
                JmlClassExprDeclaration.class,
                sequence(modifiers(), attribute(KIND), attribute(NAME), child(EXPR), semicolon()));
        concreteSyntaxModelByClass.put(JmlUnreachableStmt.class, sequence(token(UNREACHABLE), semicolon()));
        concreteSyntaxModelByClass.put(
                JmlBinaryInfixExpr.class,
                sequence(token(LPAREN), child(LEFT), space(), child(OPERATOR), space(), child(RIGHT), token(RPAREN)));
        ...
        concreteSyntaxModelByClass.put(
                JmlOldClause.class, sequence(token(OLD), space(), child(DECLARATIONS), semicolon()));
        ...
        if (unsupportedNodeClassNames.isEmpty()) {
            ...
            initializationError = Optional.of("The " + ConcreteSyntaxModel.class.getSimpleName()
                    + " should include support for these classes: " + String.join(", ", unsupportedNodeClassNames));
        }
    }
