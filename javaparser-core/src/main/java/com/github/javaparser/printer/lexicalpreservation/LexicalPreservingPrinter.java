...
import static com.github.javaparser.GeneratedModuleInfoParserConstants.JAVA_DOC_COMMENT;
...
public class LexicalPreservingPrinter {
                ...
                if (property == ObservableProperty.COMMENT) {
                    ...
                    if (oldValue == null && newValue != null) {
                        ...
                        if (oldValue instanceof JavadocComment) {
                            ...
                            List<TokenTextElement> matchingTokens = nodeText.getElements().stream().filter(e -> e.isToken(GeneratedModuleInfoParserConstants.JAVA_DOC_COMMENT)
    ...
    private NodeText prettyPrintingTextNode(Node node) {
        if (node instanceof PrimitiveType) {
            ...
            switch (primitiveType.getType()) {
                case INT:
                    nodeText.addToken(GeneratedModuleInfoParserConstants.INT, node.toString());
                    break;
                default:
        ...
        if (node instanceof JavadocComment) {
            NodeText nodeText = new NodeText(this);
            nodeText.addToken(GeneratedModuleInfoParserConstants.JAVA_DOC_COMMENT, "/**"+((JavadocComment)node).getContent()+"*/");
            return nodeText;
        }
    ...
    List<TokenTextElement> findIndentation(Node node) {
        ...
        while (it.hasNext()) {
            ...
            if (tte.getTokenKind() == GeneratedModuleInfoParserConstants.SINGLE_LINE_COMMENT
