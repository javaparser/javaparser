 ...
 */
public class ConfigurationOption implements ConfigurableOption {
    ConfigOption configOption;
    Object currentValue;

    public ConfigurationOption(ConfigOption configOption) {
        this(configOption, null);
    }

    public ConfigurationOption(ConfigOption configOption, Object value) {
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof ConfigurationOption)) return false;
     ...
     */
    @Override
    public ConfigurableOption value(Object value) {
