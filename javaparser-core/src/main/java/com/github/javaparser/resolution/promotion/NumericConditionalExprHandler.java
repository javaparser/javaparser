...
public class NumericConditionalExprHandler implements ConditionalExprHandler {
    ...
    private static final Map<ResolvedType, List<ResolvedType>> NumericConverter = new HashMap();
    ...
    private static final ResolvedPrimitiveType[] resolvedPrimitiveTypeSubList = new ResolvedPrimitiveType[]{ResolvedPrimitiveType.BYTE, ResolvedPrimitiveType.SHORT, ResolvedPrimitiveType.CHAR};
...
//        }
        ...
        if (thenExpr.isPrimitive() && elseExpr.isPrimitive()) {
            if (((ResolvedPrimitiveType) thenExpr).in(resolvedPrimitiveTypeSubList)
                    && elseExpr.equals(ResolvedPrimitiveType.INT)) {
                return thenExpr;
            } else if (((ResolvedPrimitiveType) elseExpr).in(resolvedPrimitiveTypeSubList)
                    && thenExpr.equals(ResolvedPrimitiveType.INT)) {
                return elseExpr;
            }
        }
