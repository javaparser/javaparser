...
```
compile 'com.github.javaparser:javaparser-symbol-solver-core:3.8.2'
```
...
```
compile 'com.github.javaparser:javaparser-core:3.8.2'
```
...
```
compile 'com.github.javaparser:javaparser-core-serialization:3.8.2'
```
