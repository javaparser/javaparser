...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:3.15.8'
```
...
```
implementation 'com.github.javaparser:javaparser-core:3.15.8'
```
...
```
implementation 'com.github.javaparser:javaparser-core-serialization:3.15.8'
```
