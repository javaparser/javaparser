...
```
compile 'com.github.javaparser:javaparser-symbol-solver-core:3.10.0'
```
...
```
compile 'com.github.javaparser:javaparser-core:3.10.0'
```
...
```
compile 'com.github.javaparser:javaparser-core-serialization:3.10.0'
```
