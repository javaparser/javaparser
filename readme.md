...
```
compile 'com.github.javaparser:javaparser-symbol-solver-core:3.6.27'
```
...
```
compile 'com.github.javaparser:javaparser-core:3.6.27'
```
...
```
compile 'com.github.javaparser:javaparser-core-serialization:3.6.27'
```
