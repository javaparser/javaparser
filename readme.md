...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:3.24.1-SNAPSHOT'
```
...
```
implementation 'com.github.javaparser:javaparser-core-serialization:3.24.1-SNAPSHOT'
```
