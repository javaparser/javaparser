...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:3.13.9'
```
...
```
implementation 'com.github.javaparser:javaparser-core:3.13.9'
```
...
```
implementation 'com.github.javaparser:javaparser-core-serialization:3.13.9'
```
