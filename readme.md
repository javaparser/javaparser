...
```
compile 'com.github.javaparser:javaparser-symbol-solver-core:3.6.22'
```
...
```
compile 'com.github.javaparser:javaparser-core:3.6.22'
```
...
```
compile 'com.github.javaparser:javaparser-core-serialization:3.6.22'
```
