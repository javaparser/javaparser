...
<dependency>
    ...
    <version>3.25.3-K7-SNAPSHOT</version>
</dependency>
```
...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:3.25.3-K7-SNAPSHOT'
```
...
```
implementation 'com.github.javaparser:javaparser-core:3.25.3-K7-SNAPSHOT'
```
...
```
implementation 'com.github.javaparser:javaparser-core-serialization:3.25.3-K7-SNAPSHOT'
```
