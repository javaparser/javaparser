...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:3.20.1'
```
...
```
implementation 'com.github.javaparser:javaparser-core:3.20.1'
```
...
```
implementation 'com.github.javaparser:javaparser-core-serialization:3.20.1'
```
