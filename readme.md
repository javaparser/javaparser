...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:2.24.0'
```
...
```
implementation 'com.github.javaparser:javaparser-core:2.24.0'
```
...
```
implementation 'com.github.javaparser:javaparser-core-serialization:2.24.0'
```
