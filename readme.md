...
```
implementation 'com.github.javaparser:javaparser-symbol-solver-core:3.14.16'
```
...
```
implementation 'com.github.javaparser:javaparser-core:3.14.16'
```
...
```
implementation 'com.github.javaparser:javaparser-core-serialization:3.14.16'
```
