...
public class MetaModelGenerator extends AbstractGenerator {
    ...
    private static final List<Class<? extends Node>> ALL_NODE_CLASSES = new ArrayList<Class<? extends Node>>() {{
        ...
        add(com.github.javaparser.ast.jml.clauses.EnsuresClause.class);
        add(com.github.javaparser.ast.jml.clauses.RequiresClause.class);
        add(com.github.javaparser.ast.jml.clauses.AssignableClause.class);
        add(com.github.javaparser.ast.jml.clauses.AccessibleClause.class);
        add(com.github.javaparser.ast.jml.clauses.ModifiesClause.class);
        add(com.github.javaparser.ast.jml.clauses.MeasuredByClause.class);
        add(com.github.javaparser.ast.jml.clauses.DivergesClause.class);
        add(SignalsClause.class);
        add(SignalsOnlyClause.class);
        add(com.github.javaparser.ast.jml.clauses.ReturnsClause.class);
        add(com.github.javaparser.ast.jml.clauses.BreaksClause.class);
        add(com.github.javaparser.ast.jml.clauses.ContinuesClause.class);
        add(com.github.javaparser.ast.jml.clauses.LoopInvariantClause.class);
        add(com.github.javaparser.ast.jml.clauses.LoopVariantClause.class);
        add(com.github.javaparser.ast.jml.clauses.LoopDecreasesClause.class);
        add(com.github.javaparser.ast.jml.clauses.OldClause.class);
        add(com.github.javaparser.ast.jml.clauses.ForallClause.class);
        add(com.github.javaparser.ast.jml.clauses.WhenClause.class);
        add(com.github.javaparser.ast.jml.clauses.CapturesClause.class);
        add(DurationClause.class);
        add(com.github.javaparser.ast.jml.clauses.WorkingSpaceClause.class);
