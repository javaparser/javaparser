...
public final class ExtractingVisitors {
    ...
    public static List<MethodCallExpr> extractMethodCallExprs(Node node) {
        return extract(node, new GenericVisitorAdapter<Void, List<MethodCallExpr>>() {
            @Override
            public Void visit(MethodCallExpr n, List<MethodCallExpr> accumulator) {
                accumulator.add(n);
