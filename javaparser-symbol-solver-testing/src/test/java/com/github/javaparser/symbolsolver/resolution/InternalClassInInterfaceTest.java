...
class InternalClassInInterfaceTest {
    ...
    void resolveFieldOfEnumAsInternalClassOfInterfaceUnqualifiedSamePackage() throws IOException {
        ...
        Optional<FieldAccessExpr> fae = cu.findFirst(
                ...
                n -> n.toString().equals("AnInterface.ListChangeType.ADDITION")
                        && n.getRange().get().begin.line == 4);

        assertTrue(fae.isPresent());

        assertEquals(
                "foo.bar.AnInterface.ListChangeType",
                fae.get().resolve().getType().describe());
    ...
    void resolveFieldOfEnumAsInternalClassOfInterfaceQualifiedSamePackage() throws IOException {
        ...
        Optional<FieldAccessExpr> fae = cu.findFirst(
                FieldAccessExpr.class,
                n -> n.toString().equals("foo.bar.AnInterface.ListChangeType.ADDITION")
