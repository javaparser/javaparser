...
public class ResolutionOfOverloadedMethodsWithTypeVariablesInvolvedTest {
    ...
    public void test() {
        ...
        expected.add("ReflectionMethodDeclaration{method=public java.lang.StringBuilder java.lang.StringBuilder.append(java.lang.String)}");
        expected.add("builder.append(element == this ? \"(this box)\" : element)");
        expected.add("ReflectionMethodDeclaration{method=public java.lang.StringBuilder java.lang.StringBuilder.append(java.lang.Object)}");
