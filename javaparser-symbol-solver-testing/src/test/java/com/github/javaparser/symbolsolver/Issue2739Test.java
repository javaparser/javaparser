...
public class Issue2739Test extends AbstractResolutionTest {

    @BeforeEach
    void setUp() {
        CombinedTypeSolver cts = new CombinedTypeSolver(new ReflectionTypeSolver(),
                new JavaParserTypeSolver("src/test/resources/issue2050"));
    ...
    void test() throws FileNotFoundException {
        CompilationUnit cu = parse(new File("src/test/resources/issue2050/foo/Derived.java"));
        ...
        assertTrue("bar.Base".equals(rrt.describe()));
    }
