...
import org.javaparser.symbolsolver.javaparsermodel.contexts.EnumDeclarationContext;
...
class EnumDeclarationContextResolutionTest extends AbstractResolutionTest {
    ...
    void solveSymbolReferringToDeclaredInstanceField() {
        ...
        org.javaparser.ast.body.EnumDeclaration enumDeclaration = Navigator.demandEnum(cu, "MyEnum");
