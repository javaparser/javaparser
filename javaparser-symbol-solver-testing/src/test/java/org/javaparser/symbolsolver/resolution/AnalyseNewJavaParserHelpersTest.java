...
//    }
    ...
    void nodesTypeIsCorrect() throws IOException {
        ...
        assertEquals("org.javaparser.utils.PositionUtils.sortByBeginPosition(java.util.List<T>).T", type.asReferenceType().typeParametersValues().get(0).asTypeParameter().getQualifiedName());
        ...
        assertEquals("org.javaparser.ast.Node", bound.getType().describe());
    }
