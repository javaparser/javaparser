...
class ReflectionEnumDeclarationTest extends AbstractSymbolResolutionTest {
    ...
    @Test
    void testIsClass() {
        ReflectionEnumDeclaration modifier = (ReflectionEnumDeclaration) typeSolver.solveType("org.javaparser.symbolsolver.reflectionmodel.MyModifier");
    ...
    void testGetPackageName() {
        ReflectionEnumDeclaration modifier = (ReflectionEnumDeclaration) typeSolver.solveType("org.javaparser.symbolsolver.reflectionmodel.MyModifier");
        assertEquals("org.javaparser.symbolsolver.reflectionmodel", modifier.getPackageName());
    }
    ...
    void testGetQualifiedName() {
        ReflectionEnumDeclaration modifier = (ReflectionEnumDeclaration) typeSolver.solveType("org.javaparser.symbolsolver.reflectionmodel.MyModifier");
        assertEquals("org.javaparser.symbolsolver.reflectionmodel.MyModifier", modifier.getQualifiedName());
    }
