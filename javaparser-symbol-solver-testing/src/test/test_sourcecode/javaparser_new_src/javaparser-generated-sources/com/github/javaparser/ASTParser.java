...
final class ASTParser implements ASTParserConstants {
    ...
    final public ImportDeclaration EmptyImportDeclaration() {
        Position begin;
     ...
     */
    final public ModifierHolder Modifiers() {
        Position begin = INVALID;
    ...
    final public ClassOrInterfaceDeclaration ClassOrInterfaceDeclaration(ModifierHolder modifier) {
    ...
    final public List<ClassOrInterfaceType> ExtendsList(boolean isInterface) {
    ...
    final public List<ClassOrInterfaceType> ImplementsList(boolean isInterface) {
        List<ClassOrInterfaceType> ret = new LinkedList<ClassOrInterfaceType>();
        ClassOrInterfaceType cit;
    ...
    final public EnumDeclaration EnumDeclaration(ModifierHolder modifier) {
        NameExpr name;
        List<ClassOrInterfaceType> impList = null;
     ...
     */
    final public RangedList<TypeParameter> TypeParameters() {
    ...
    final public List<ClassOrInterfaceType> TypeBound() {
        List<ClassOrInterfaceType> ret = new LinkedList<ClassOrInterfaceType>();
        ClassOrInterfaceType cit;
        jj_consume_token(EXTENDS);
        cit = AnnotatedClassOrInterfaceType();
    ...
    final public List<BodyDeclaration<?>> ClassOrInterfaceBody(boolean isInterface) {
    ...
    final public FieldDeclaration FieldDeclaration(ModifierHolder modifier) {
        Type type;
    ...
    final public MethodDeclaration MethodDeclaration(ModifierHolder modifier) {
    ...
    final public ReferenceType ReferenceTypeWithAnnotations() {
    ...
    final public List<Parameter> FormalParameters() {
    ...
    final public List<Parameter> FormalLambdaParameters() {
        List<Parameter> ret = null;
        Parameter par;
        jj_consume_token(COMMA);
        par = FormalParameter();
    ...
    final public List<Parameter> InferredLambdaParameters() {
        List<Parameter> ret = null;
        VariableDeclaratorId id;
        jj_consume_token(COMMA);
        id = VariableDeclaratorId();
    ...
    final public ConstructorDeclaration ConstructorDeclaration(ModifierHolder modifier) {
        RangedList<TypeParameter> typeParameters = new RangedList<TypeParameter>(null);
        NameExpr name;
        List<Parameter> parameters;
        List<ReferenceType> throws_ = null;
    ...
    final public ArrayBracketPair ArrayBracketPair() {
        List<AnnotationExpr> annotations = null;
        Position begin = INVALID;
        annotations = Annotations();
    ...
    final public IntersectionType IntersectionType() {
        Position begin;
    ...
    final public ClassOrInterfaceType AnnotatedClassOrInterfaceType() {
        List<AnnotationExpr> annotations;
        ClassOrInterfaceType cit;
        annotations = Annotations();
    ...
    final public RangedList<Type<?>> TypeArguments() {
    ...
    final public List<Expression> Arguments() {
    ...
    final public List<Expression> ArgumentList() {
     ...
     */
    final public ArrayCreationExpr ArrayCreation(Position begin, Type type) {
        Expression expr = null;
    ...
    final public List<Expression> ForInit() {
        List<Expression> ret;
        Expression expr;
    ...
    final public List<Expression> ExpressionList() {
        List<Expression> ret = new LinkedList<Expression>();
        Expression expr;
        expr = Expression();
        ret.add(expr);
    ...
    final public List<Expression> ForUpdate() {
        List<Expression> ret;
        ret = ExpressionList();
        return ret;
    }
    ...
    final public List<VariableDeclarationExpr> ResourceSpecification() {
    ...
    final public List<VariableDeclarationExpr> Resources() {
        List<VariableDeclarationExpr> variables = new LinkedList<VariableDeclarationExpr>();
    ...
    final public List<AnnotationExpr> Annotations() {
        List<AnnotationExpr> annotations = null;
    ...
    final public List<MemberValuePair> MemberValuePairs() {
    ...
    /* Annotation Types. */
    final public AnnotationDeclaration AnnotationTypeDeclaration(ModifierHolder modifier) {
        NameExpr name;
        List<BodyDeclaration<?>> members;
        Position begin = modifier.begin;
        jj_consume_token(AT);
    ...
    final public List<BodyDeclaration<?>> AnnotationTypeBody() {
    ...
    final public AnnotationMemberDeclaration AnnotationTypeMemberDeclaration(ModifierHolder modifier) {
        Type type;
        String name;
