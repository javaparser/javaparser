...
public abstract class ModifierVisitorAdapter<A> implements GenericVisitor<Node, A> {
    ...
    @Override
    public Node visit(final AnnotationDeclaration n, final A arg) {
    ...
    @Override
    public Node visit(final AnnotationMemberDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        final List<AnnotationExpr> annotations = n.getAnnotations();
    ...
    @Override
    public Node visit(final ArrayAccessExpr n, final A arg) {
    ...
    @Override
    public Node visit(final ArrayCreationExpr n, final A arg) {
        n.setType((Type) n.getType().accept(this, arg));
    ...
    @Override
    public Node visit(final ArrayInitializerExpr n, final A arg) {
        if (n.getValues() != null) {
    ...
    @Override
    public Node visit(final AssertStmt n, final A arg) {
    ...
    @Override
    public Node visit(final AssignExpr n, final A arg) {
    ...
    @Override
    public Node visit(final BlockStmt n, final A arg) {
    ...
    @Override
    public Node visit(final BooleanLiteralExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final BreakStmt n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final CastExpr n, final A arg) {
        n.setType((Type) n.getType().accept(this, arg));
    ...
    @Override
    public Node visit(final CharLiteralExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final ClassExpr n, final A arg) {
        n.setType((Type) n.getType().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final ClassOrInterfaceDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        final List<AnnotationExpr> annotations = n.getAnnotations();
    ...
    @Override
    public Node visit(final ClassOrInterfaceType n, final A arg) {
        if (n.getScope() != null) {
    ...
    @Override
    public Node visit(final CompilationUnit n, final A arg) {
    ...
    @Override
    public Node visit(final ConditionalExpr n, final A arg) {
    ...
    @Override
    public Node visit(final ConstructorDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        final List<AnnotationExpr> annotations = n.getAnnotations();
    ...
    @Override
    public Node visit(final ContinueStmt n, final A arg) {
        return n;
    }
    ...
    @Override
    public Node visit(final DoubleLiteralExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final EmptyMemberDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        return n;
    ...
    @Override
    public Node visit(final EmptyStmt n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final EmptyTypeDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        return n;
    ...
    @Override
    public Node visit(final EnclosedExpr n, final A arg) {
        n.setInner((Expression) n.getInner().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final EnumConstantDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        final List<AnnotationExpr> annotations = n.getAnnotations();
    ...
    @Override
    public Node visit(final EnumDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        final List<AnnotationExpr> annotations = n.getAnnotations();
    ...
    @Override
    public Node visit(final ExplicitConstructorInvocationStmt n, final A arg) {
        if (!n.isThis()) {
            if (n.getExpr() != null) {
                n.setExpr((Expression) n.getExpr().accept(this, arg));
            }
    ...
    @Override
    public Node visit(final FieldDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        final List<AnnotationExpr> annotations = n.getAnnotations();
    ...
    @Override
    public Node visit(final ForeachStmt n, final A arg) {
    ...
    @Override
    public Node visit(final ForStmt n, final A arg) {
    ...
    @Override
    public Node visit(final InitializerDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        n.setBlock((BlockStmt) n.getBlock().accept(this, arg));
    ...
    @Override
    public Node visit(final InstanceOfExpr n, final A arg) {
        n.setExpr((Expression) n.getExpr().accept(this, arg));
        n.setType((Type) n.getType().accept(this, arg));
        return n;
    }
    ...
    @Override
    public Node visit(final IntegerLiteralExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final IntegerLiteralMinValueExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final JavadocComment n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final LabeledStmt n, final A arg) {
        n.setStmt((Statement) n.getStmt().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final LongLiteralExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final LongLiteralMinValueExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final MarkerAnnotationExpr n, final A arg) {
        n.setName((NameExpr) n.getName().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final MemberValuePair n, final A arg) {
        n.setValue((Expression) n.getValue().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final MethodCallExpr n, final A arg) {
        if (n.getScope() != null) {
            n.setScope((Expression) n.getScope().accept(this, arg));
        }
        final List<Type> typeArgs = n.getTypeArgs();
    ...
    @Override
    public Node visit(final MethodDeclaration n, final A arg) {
        if (n.getJavaDoc() != null) {
            n.setJavaDoc((JavadocComment) n.getJavaDoc().accept(this, arg));
        }
        final List<AnnotationExpr> annotations = n.getAnnotations();
    ...
    @Override
    public Node visit(final NameExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final NormalAnnotationExpr n, final A arg) {
        n.setName((NameExpr) n.getName().accept(this, arg));
    ...
    @Override
    public Node visit(final NullLiteralExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final ObjectCreationExpr n, final A arg) {
        if (n.getScope() != null) {
            n.setScope((Expression) n.getScope().accept(this, arg));
        }
        final List<Type> typeArgs = n.getTypeArgs();
    ...
    @Override
    public Node visit(final PackageDeclaration n, final A arg) {
        final List<AnnotationExpr> annotations = n.getAnnotations();
        if (annotations != null) {
            for (int i = 0; i < annotations.size(); i++) {
                annotations.set(i, (AnnotationExpr) annotations.get(i).accept(this, arg));
    ...
    @Override
    public Node visit(final Parameter n, final A arg) {
    ...
    @Override
    public Node visit(final PrimitiveType n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final QualifiedNameExpr n, final A arg) {
        n.setQualifier((NameExpr) n.getQualifier().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final ReferenceType n, final A arg) {
        n.setType((Type) n.getType().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final ReturnStmt n, final A arg) {
        if (n.getExpr() != null) {
            n.setExpr((Expression) n.getExpr().accept(this, arg));
        }
        return n;
    ...
    @Override
    public Node visit(final SingleMemberAnnotationExpr n, final A arg) {
        n.setName((NameExpr) n.getName().accept(this, arg));
    ...
    @Override
    public Node visit(final StringLiteralExpr n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final SuperExpr n, final A arg) {
    ...
    @Override
    public Node visit(final SwitchEntryStmt n, final A arg) {
        if (n.getLabel() != null) {
    ...
    @Override
    public Node visit(final SwitchStmt n, final A arg) {
    ...
    @Override
    public Node visit(final SynchronizedStmt n, final A arg) {
        n.setExpr((Expression) n.getExpr().accept(this, arg));
        n.setBlock((BlockStmt) n.getBlock().accept(this, arg));
        return n;
    }
    ...
    @Override
    public Node visit(final ThisExpr n, final A arg) {
        if (n.getClassExpr() != null) {
            n.setClassExpr((Expression) n.getClassExpr().accept(this, arg));
        }
        return n;
    ...
    @Override
    public Node visit(final ThrowStmt n, final A arg) {
        n.setExpr((Expression) n.getExpr().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final TryStmt n, final A arg) {
    ...
    @Override
    public Node visit(final TypeDeclarationStmt n, final A arg) {
        n.setTypeDeclaration((TypeDeclaration) n.getTypeDeclaration().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final TypeParameter n, final A arg) {
    ...
    @Override
    public Node visit(final UnaryExpr n, final A arg) {
        n.setExpr((Expression) n.getExpr().accept(this, arg));
        return n;
    }

    @Override
    public Node visit(final UnknownType n, final A arg) {
        return n;
    }
    ...
    @Override
    public Node visit(final VariableDeclarator n, final A arg) {
        n.setId((VariableDeclaratorId) n.getId().accept(this, arg));
        if (n.getInit() != null) {
    ...
    @Override
    public Node visit(final VariableDeclaratorId n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final VoidType n, final A arg) {
        return n;
    }

    @Override
    public Node visit(final WhileStmt n, final A arg) {
        n.setCondition((Expression) n.getCondition().accept(this, arg));
        n.setBody((Statement) n.getBody().accept(this, arg));
        return n;
    }
    ...
    @Override
    public Node visit(final WildcardType n, final A arg) {
