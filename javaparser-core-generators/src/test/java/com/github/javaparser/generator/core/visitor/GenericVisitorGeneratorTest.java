...
/**
 * Comprehensive tests for GenericVisitorGenerator.
 * Verifies that GenericVisitor interface methods are correctly generated.
 */
class GenericVisitorGeneratorTest {

    private SourceRoot sourceRoot;
    private GenericVisitorGenerator generator;

    @BeforeEach
    void setUp() throws Exception {
        sourceRoot = createTempSourceRoot(GenericVisitorGeneratorTest.class);
        generator = new GenericVisitorGenerator(sourceRoot);
    }
    ...
    void testVisitMethodGeneration() throws Exception {
        ...
        ClassOrInterfaceDeclaration interfaceDecl = cu.addInterface("GenericVisitor");
        interfaceDecl.addTypeParameter("R");
