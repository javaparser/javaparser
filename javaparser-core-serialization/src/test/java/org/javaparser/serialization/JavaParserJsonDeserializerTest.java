...
import org.javaparser.javadoc.JavadocBlockTag;
...
import static org.javaparser.serialization.JavaParserJsonSerializerTest.serialize;
import static org.javaparser.utils.Utils.EOL;
import static org.javaparser.utils.Utils.normalizeEolInTextBlock;
...
class JavaParserJsonDeserializerTest {
    ...
    void testComment() {
        ...
        assertEquals("org.javaparser.ast.comments.BlockComment", comment.getClass().getName());
        ...
        assertEquals("org.javaparser.ast.comments.LineComment", methodDeclaration.getComment().get().getClass().getName());
