...
public class ClassOrInterfaceDeclarationContextResolutionTest extends AbstractResolutionTest {
    ...
    public void solveSymbolReferringToInheritedInstanceField() throws ParseException {
        ...
        SymbolReference<? extends ValueDeclaration> ref = context.solveSymbol("k", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    ...
    public void solveSymbolReferringToInterfaceInheritedInstanceField() throws ParseException {
        ...
        SymbolReference<? extends ValueDeclaration> ref = context.solveSymbol("o", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
        assertEquals("int", ref.getCorrespondingDeclaration().getType().describe());
    }
    ...
    public void solveSymbolReferringToInheritedStaticField() throws ParseException {
        ...
        SymbolReference<? extends ValueDeclaration> ref = context.solveSymbol("m", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    ...
    public void solveSymbolReferringToUnknownElement() throws ParseException {
        ...
        SymbolReference<? extends ValueDeclaration> ref = context.solveSymbol("zzz", new MemoryTypeSolver());
    ...
    public void solveTypeRefToItself() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("A", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    }
    ...
    public void solveTypeRefToUnexisting() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("Foo", new MemoryTypeSolver());
        assertEquals(false, ref.isSolved());
    }
    ...
    public void solveTypeRefToObject() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("Object", new ReflectionTypeSolver());
        assertEquals(true, ref.isSolved());
    }
    ...
    public void solveTypeRefToJavaLangObject() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("java.lang.Object", new ReflectionTypeSolver());
        assertEquals(true, ref.isSolved());
    }
    ...
    public void solveTypeRefToInternalClass() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("B", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    }
    ...
    public void solveTypeRefToInternalEnum() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("E", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    }
    ...
    public void solveTypeRefToInternalOfInternalClass() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("C", new MemoryTypeSolver());
        assertEquals(false, ref.isSolved());
    }
    ...
    public void solveTypeRefToAnotherClassInFile() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("Super", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    }
    ...
    public void solveTypeRefToQualifiedInternalClass() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("A.B", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    }
    ...
    public void solveTypeRefToQualifiedInternalOfInternalClass() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("B.C", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    }
    ...
    public void solveTypeRefToMoreQualifiedInternalOfInternalClass() throws ParseException {
        ...
        SymbolReference<ReferenceTypeDeclaration> ref = context.solveType("A.B.C", new MemoryTypeSolver());
        assertEquals(true, ref.isSolved());
    }
