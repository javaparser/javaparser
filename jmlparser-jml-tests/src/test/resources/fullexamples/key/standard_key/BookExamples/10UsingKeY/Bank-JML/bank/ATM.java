...
public class ATM {
     ...
     * or an offline proxy
     *
     * @param accountNumber the number of the account to be accessed
     ...
     *
     * @param newOnline <code>true</code> iff the terminal is switched online
     */
    /*@
        public normal_behavior
     ...
     *
     * @param pin the PIN that is entered
     */
    /*@ public normal_behavior
        requires  insertedCard != null;
     ...
     *
     * @param amount the amount that is supposed to be withdrawn
