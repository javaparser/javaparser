...
public class CentralHost {
     ...
     *
     * @param accountNumber the number of the account that is requested
     ...
     *
     * @param accountNumber number of the account for which a card is supposed to be
     *                      issued
     * @param pin           the PIN of the card to be issued
