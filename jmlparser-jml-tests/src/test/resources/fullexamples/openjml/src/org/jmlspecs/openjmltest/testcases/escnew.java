...
//                +"  }\n"
    ...
    @Test
    public void testShortCircuitDup() {
        main.addOptions("-escMaxWarnings=1");
        helpTCX("tt.TestJava", "package tt; import org.jmlspecs.annotation.*; \n"
                        + "public class TestJava { int f; \n"
...
//                ,"/tt/TestJava.java:50: warning: Associated declaration",7
    ...
    @Test
    // FIXME - problem is an infinite loop with use of consistentWithEquals - invariants use it, but the invariants are part of the specs for the (model pure) consistentWithEquals method
