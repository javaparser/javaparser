...
//        jmldebug = true;
    ...
    @Test
    public void gitbug500a() {
        helpTCG("-solver-seed=242");
    }

    @Ignore // FIXME - times out
    @Test
    public void gitbug500b() {
        helpTCG("-solver-seed=242");
    }

    @Test
    public void gitbug500c() {
        helpTCG("-rac");  // Just RAC compilation - RAC compile crash
    }

    @Test
    public void gitbug502() {
        helpTCG();
    }
    ...
    @Test
    public void gitbug556() {
        expectedExit = 0;
        helpTCG();
    }

    @Test
    public void gitbug557() {
        expectedExit = 0;
        helpTCG();
    }

    @Test
    public void gitbug558() {
        expectedExit = 0;
        helpTCG();
    }

    @Test
    public void gitbug558a() {
        expectedExit = 0;
        helpTCG();
    }

    @Test
    public void gitbug558b() {
        expectedExit = 0;
        helpTCG();
    }

    @Test
    public void gitbug559() {
        expectedExit = 0;
        helpTCG("-escExitInfo");
    }

    @Test
    public void gitbug559a() {
        expectedExit = 0;
        helpTCG();
    }

    @Test
    public void gitbug560() {
        expectedExit = 0;
        helpTCG();
    }

    @Test
    public void gitbug567() {
        expectedExit = 0;
        helpTCG();
    }

    @Test
    public void gitbug567a() {
        expectedExit = 0;
        helpTCF("test/gitbug567", "test/gitbug567a", "-code-math=java");
    }

    @Test
    public void gitbug567b() {
        expectedExit = 0;
        helpTCF("test/gitbug567", "test/gitbug567b", "-code-math=safe");
    }

    @Test
    public void gitbug567c() {
        expectedExit = 0;
        helpTCF("test/gitbug567", "test/gitbug567c", "-code-math=bigint");
    }

    @Test
    public void gitbug572() {
        expectedExit = 1;
        helpTCG();
    }
    ...
    @Test
    @Ignore  // Needs specs about double
    ...
    @Test
    @Ignore // FIXME - needs to be RAC and to be fixed
    ...
    @Test
    @Ignore // FIXME - needs some implementation
    ...
    @Test
    @Ignore // FIXME -- nullpointer exception, time out //  // Complained of infinite run time
    ...
    @Test
    @Ignore // FIXME -- MISMATCHED BLOCKS // // Complained of undefined symbols
    ...
    @Test
    @Ignore // FIXME - this seems to be an incompleteness or bug in Z3 non-linear computations
    ...
    @Test
    @Ignore // Will erroneously succeed until measured_by is implemented
    ...
    @Test
    @Ignore // FIXME: Bug fixed, but the specs are not complete
    ...
    @Test
    @Ignore // FIXME: EXAMPLE SPECS NOT YET COMPLETE
    ...
    @Test
    @Ignore // FIXME: Specs not yet finished
