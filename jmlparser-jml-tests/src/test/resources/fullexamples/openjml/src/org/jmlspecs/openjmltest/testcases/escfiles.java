...
public class escfiles extends EscBase {
    ...
    @Test
    @Ignore // FIXME - nonlinear inference
...
//    }
    ...
    @Test
    @Ignore // Problem is with mixed BV and bigint operations
    ...
    @Test
    @Ignore // times out -- see testPrime for fixed version
    public void testPrimeNumbers() {
        helpTF("buggyPrimeNumbers");
    }

    @Test
    @Ignore // FIXME - unclear why fails
    ...
    @Test
    @Ignore // FIXME - axioms for multi-dimensional arrays
    ...
    @Test
    @Ignore // FIXME - Specs need improvement
    ...
    @Test
    @Ignore // FIXME - implement diverges
    ...
    @Test
    @Ignore // FIXME - string comparisons for switch statements
    ...
    @Test
    @Ignore // FIXME - ignore for now; implement with real specs
    ...
    @Test
    @Ignore // FIXME - not yet implemented
    ...
    @Test
    // Basic problem is with the toString conversion of a \bigint, because of the -code-math=bigint setting of these
    ...
    @Test
    @Ignore // FIXME - fix a problem with concatenation
