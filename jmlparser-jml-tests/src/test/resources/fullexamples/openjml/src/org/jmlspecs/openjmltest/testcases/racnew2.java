...
public class racnew2 extends RacBase {
     ...
     */ // FIXME - test unary with expressions in ++ --
    @Test
     ...
     */
    @Test
    public void testSwitchInteger2() {
        helpTCX("tt.TestJava", "package tt; public class TestJava { public static void main(String[] args) { \n" +
                        "  m(0); m(1); m(2); m(3); \n" +
                        "  System.out.println(\"END\"); \n" +
                        "  } \n" +
     ...
     */
    @Test
    public void testSwitchInteger2Null() {
     ...
     */
    @Test
    public void testGenMethod2() {  // FIXME - this needs more investigation -- the type int seems to be used (e.g. in addImplicitCOnversion) in an expression i != null where I would expect it to have been converted to T
    ...
    @Test
    public void testBoxingOnDeclaration() {
        helpTCX("tt.A", "package tt; public class A { \n"
                        + "public static void main(String[] args) {  \n"
                        + "{ Integer i = 6;\n"
                        + "int k = i;\n"
    ...
    @Test
    public void testBoxingOnNullDeclaration() {
    ...
    @Test
    public void testBoxingOnAssignment() {  // In Java mode
    ...
    @Test
    public void testBoxingOnAssignmentMathMode() {
    ...
    @Test
    public void testBoxingOnAssignmentOp() {
        helpTCX("tt.A", "package tt; /*@ nullable_by_default*/ public class A { \n"
                        + "public static void main(String[] args) {  \n"
    ...
    @Test
    public void testBoxingOnNullAsssignment() {
        helpTCX("tt.A", "package tt; /*@ nullable_by_default*/ public class A { \n"
                        + "public static void main(String[] args) {  \n"
                        + "try { Integer i = null;\n"
                        + "int k; k = i;\n"
    ...
    @Test
    public void testStringSwitchNull() {
        helpTCX("tt.A", "package tt; /*@ nullable_by_default*/ public class A { \n"
                        + "public static void main(String[] args) {  \n"
    ...
    @Test
    public void testEnumSwitchNull() {
        helpTCX("tt.A", "package tt; /*@ nullable_by_default*/ public class A { \n"
                        + "enum E { A,B,C}; public static void main(String[] args) {  \n"
                        + "E e = null; int k = 0;\n"
                        + "try { switch (e) {\n"
