...
//                ,"/$A/A.jml:1: Associated declaration: /$A/A.jml:2: ",8
    ...
    @Test
    public void testSimpleFieldDup() {
        helpTCF("$A/A.java",
    ...
    @Test
    public void testSimpleFieldModelDup() {
        helpTCF("$A/A.java",
                "public class A { int j; \n/*@ model int j; */ } "
    ...
    @Test
    public void testSimpleFieldModelDup2() {
        helpTCF("$A/A.java",
                "public class A { int j; \n/*@ model */ int j;} "
    ...
    @Test
    public void testSimpleFieldModelDup3() {
        helpTCF("$A/A.java",
                "public class A { int j; \n/*@  int j; */} "
    ...
    @Test
    public void testJmlSimpleField() {
    ...
    @Test
    public void testJmlSimpleFieldTypeError() {
    ...
    @Test
    public void testJmlSimpleFieldDup() {
    ...
    @Test
    public void testJmlSimpleFieldDup2() {
    ...
    @Test
    public void testJmlSimpleFieldDup4() {
        addMockFile("$A/A.jml", "public class A { int j; \n/*@ model */ int j; }");
        helpTCF("$A/A.java",
                "public class A { int j; } "
    ...
    @Test
    public void testJmlSimpleFieldDup3() {
        addMockFile("$A/A.jml", "public class A { \n/*@ int jjjj; */ }");
        helpTCF("$A/A.java",
    ...
    @Test
    public void testJmlSimpleFieldNoMatch() {
    ...
    @Test
    public void testJmlSimpleFieldNoMatchOK() {
    ...
    @Test
    public void testJmlSimpleFieldNoMatch2() {
        addMockFile("$A/A.jml", "public class A { /*@  int k; */ }");
        helpTCF("$A/A.java",
                "public class A { int j; } "
    ...
    @Test
    public void testJmlSimpleFieldNoMatch3() {
        addMockFile("$A/A.jml", "public class A { /*@ model */ int k; }");
        helpTCF("$A/A.java",
                "public class A { int j; } "
    ...
    @Test
    public void testSimpleMethodDup() {
        helpTCF("$A/A.java",
    ...
    @Test
    public void testSimpleMethodModelDup() {
        helpTCF("$A/A.java",
    ...
    @Test
    public void testSimpleMethodModelDup2() {
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;}  \n/*@ model */ int j(){return 0;} } "
    ...
    @Test
    public void testSimpleMethodModelDup3() {
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;}  \n/*@ int j(){return 0;}  */} "
    ...
    @Test
    public void testJmlSimpleMethod() {
        addMockFile("$A/A.jml", "public class A { int j();  }");
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;}  } "
        );
    ...
    @Test
    public void testJmlSimpleMethodWithBody() {
    ...
    @Test
    public void testJmlSimpleMethodTypeError() {
        addMockFile("$A/A.jml", "public class A { double j();  }");
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;}  } "
...
// FIXME - should have an associated declaration
    ...
    @Test
    public void testJmlSimpleMethodTypeError2() {
    ...
    @Test
    public void testJmlSimpleMethodDup() {
    ...
    @Test
    public void testJmlSimpleMethodDup2() {
        addMockFile("$A/A.jml", "public class A { int j(); \n/*@ model int j(){return 0;}  */ }");
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;}  } "
    ...
    @Test
    public void testJmlSimpleMethodDup4() {
        addMockFile("$A/A.jml", "public class A { int j();  \n/*@ model */ int j(){return 0;}  }");
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;} } "
                , "/$A/A.jml:2: A Java declaration (not within a JML annotation) may not be either ghost or model", 5
    ...
    @Test
    public void testJmlSimpleMethodDup5() {
    ...
    @Test
    public void testJmlSimpleMethodDup3() {
        addMockFile("$A/A.jml", "public class A { \n/*@ int j();  */ }");
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;}  } "
    ...
    @Test
    public void testJmlSimpleMethodNoMatch() {
    ...
    @Test
    public void testJmlSimpleMethodNoMatchOK() {
        addMockFile("$A/A.jml", "public class A { /*@ model int k();  */ }");
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;}  } "
        );
    ...
    @Test
    public void testJmlSimpleMethodNoMatch2() {
        addMockFile("$A/A.jml", "public class A { \n/*@  int k(){return 0;}  */ }");
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;}  } "
    ...
    @Test
    public void testJmlSimpleMethodNoMatch3() {
    ...
    @Test
    public void testJmlMethodIgnored() {
        addMockFile("$A/A.jml", "public class A { \n/*@ model int k(){return 0;} */ }");
        helpTCF("$A/A.java",
                "public class A { int j(){return 0;} \n/*@ model int j(); */ } "
        );
    ...
    @Test
    public void testJmlFieldIgnored() {
        addMockFile("$A/A.jml", "public class A { \n int j; /*@ model int k; */ }");
        helpTCF("$A/A.java",
                "public class A { int j; \n/*@ model int j; */ } "
        );
