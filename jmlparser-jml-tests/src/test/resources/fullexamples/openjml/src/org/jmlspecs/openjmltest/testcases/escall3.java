...
// TODO - are these tests duplicated elsewhere?
    ...
    @Test
    public void testNullSynchronized1() {
        helpTCX("tt.TestJava", "package tt; \n"
                        + "public class TestJava { \n"
    ...
    @Test
    public void testNullSynchronized2() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
    ...
    @Test
    public void testArrayType1() { // TODO: CVC4 takes 147 sec
        helpTCX("tt.TestJava", "package tt; \n"
                        + "public class TestJava { \n"
    ...
    @Test
    public void testArrayType1Bug() { // TODO: CVC4 takes 147 sec
        helpTCX("tt.TestJava", "package tt; \n"
                        + "public class TestJava { \n"
    ...
    @Test
    public void testArrayType2() { // TODO: CVC4 takes 186 sec
        helpTCX("tt.TestJava", "package tt; \n"
                        + "public class TestJava { \n"
    ...
    @Test
    public void testArrayType2Bug() { // TODO: CVC4 takes 186 sec
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
    ...
    @Test
    public void testMethodWithConstructorNameFixed() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
    ...
    @Test
    public void testExceptionTypeC() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
    ...
    @Test
    public void testExceptionTypeB() {
        helpTCX("tt.TestJava", "package tt; \n"
                        + "public class TestJava { \n"
    ...
    @Test
    public void testExceptionType2() {
        expectedExit = 1;
        helpTCX("tt.TestJava", "package tt; \n"
                        + "public class TestJava { \n"
    ...
    @Test
    public void testMethodWithConstructorNameOK() {
    ...
    @Test
    public void testMethodWithConstructorName() {
        helpTCX("tt.TestJava", "package tt; \n"
                        + "public class TestJava { \n"
    ...
    @Test
    public void testBoxingOnAssignment() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
    ...
    @Test
    public void testMethodWithConstructorNameBug() {
    ...
    @Test
    public void testTryResources1x() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
                + "    static public int flag = 0;\n"
                + "    public static class RR implements AutoCloseable {\n"
    ...
    // If RR() throws an exception, mmm exits exceptionally
    @Test
    public void testTryResources1a() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
                + "    static public int flag = 0;\n"
                + "    public static class RR implements AutoCloseable {\n"
    ...
    @Test
    public void testTryResources2b() {
    ...
    // Checks the class of the resulting exception when try body and close calls throw exceptions
    @Test
    public void testTryResources2c() {
        main.addOptions("-checkFeasibility=all", "-defaults=constructor:pure"); // Part of test
        helpTCX("tt.TestJava", "package tt; \n"
                        + "public class TestJava { \n"
    ...
    @Test
    public void testTryResources4a() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
                + "    static public int flag = 0;\n"
                + "    public static class RR implements AutoCloseable {\n"
    ...
    @Test
    public void testTryResources4b() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
                + "    static public int flag = 0;\n"
                + "    public static class RR implements AutoCloseable {\n"
    ...
    @Test
    public void testTryResources4c() {
        helpTCX("tt.TestJava", "package tt; \n"
                + "public class TestJava { \n"
                + "    static public int flag = 0;\n"
                + "    public static class RR implements AutoCloseable {\n"
