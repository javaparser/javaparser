...
public class scanner extends JmlTestCase {
    ...
    public void helpScanner(String s, ITokenKind[] list, int[] positions, int numErrors) {
        try {
            ...
            if (positions != null && 2 * i != positions.length)
                fail("Number of start/end locations (" + (positions.length) + ") should be double the number of tokens (" + i + ")");
        } catch (Exception e) {
    ...
    @Test
    public void testArrow() {  // Now a Java operator, but in JML context
        helpScanner("/*@ -> */",
    ...
    @Test
    public void testArrow2() {  // Now a Java operator, in Java context
        helpScanner("    ->   ",
     ...
     */
    @Test
    public void testEmptyJavaComment() {
        helpScanner("//",
                new ITokenKind[]{},
                new int[]{});
    }
     ...
     */
    @Test
    public void testMisMatchedJMLComment() {
     ...
     */
    @Test
    public void testEmbeddedJMLComment() {
     ...
     */
    @Test
    public void testEmbeddedJMLComment3() {
     ...
     */
    @Test
    public void testEmbeddedJMLComment4() {
        helpScanner("/*@requires //@ requires  \n requires */ public",
     ...
     */
    @Test
    public void testEmbeddedJMLComment2() {
     ...
     */
    @Test
    public void testEmbeddedJMLComment5() {
        helpScanner("//@requires /*@ requires\n public   */ public  ",
                new ITokenKind[]{IDENTIFIER, IDENTIFIER, EJML, PUBLIC, STAR, SLASH, PUBLIC, EOF},
                null);
    }
     ...
     */
    @Test
    public void testEmbeddedJavaComment() {
        helpScanner("//@requires // requires",
                new ITokenKind[]{IDENTIFIER, EOF},
                null);
    }
     ...
     */
    @Test
    public void testEmbeddedJavaComment2() {
     ...
     */
    @Test
    public void testEmbeddedJavaComment3() {
        helpScanner("//@requires /* requires ensures \n signals */ modifies ",
                new ITokenKind[]{IDENTIFIER, IDENTIFIER, EOF},
     ...
     */
    @Test
    public void testEmbeddedJavaComment4() {
     ...
     */
    @Test
    public void testEmbeddedJavaComment6() {
...
//    }
    ...
    // Testing an unclosed informal comment in a BLOCK comment
    @Test
    public void testInformalComment4a() {
        helpScanner("/*@ \\result(* requires *\n*** */",
                new ITokenKind[]{IDENTIFIER, INFORMAL_COMMENT, EJML},
                new int[]{4, 11, 11, 29, 29, 31},
                1);
    ...
    // Testing an unclosed informal comment in a BLOCK comment
    @Test
    public void testInformalComment4b() {
        helpScanner("/*@ \\result(* requires *\n*** ",
    ...
    // Testing an unclosed informal comment in a LINE comment
    @Test
    public void testInformalComment5a() {
        helpScanner("//@ \\result(* requires *****",
    ...
    // Testing an unclosed informal comment in a LINE comment
    @Test
    public void testInformalComment6() {
    ...
    @Test
    public void testIntLiteralWithUnderscore() {
        String v = "123_456";
    ...
    @Test
    public void testIntLiteralWithUnderscoreBin() {
    ...
    @Test
    public void testIntLiteralWithUnderscoreHex() {
        String v = "0xDE_AF";
        Scanner sc = fac.newScanner(v, true);
        sc.nextToken();
        assertEquals(INTLITERAL, sc.token().kind);
    ...
    @Test
    public void testIntLiteralWithUnderscoreHexLong() {
...
//    }
    ...
    @Test
    public void testConditionalKey1() {
...
//    }
    ...
    @Test
    public void testConditionalKey4() {
        keys = new String[]{"NEG"};
        helpScanner("//-NEG@ requires\n  /*-NEG@ requires */",
                new ITokenKind[]{EOF},
                null);
    ...
    @Test
    public void testConditionalKey5() {
...
//
    @Test
    public void testConditionalKey7() {
        keys = new String[]{"NEG"};
        helpScanner("//-NEG+POS@ requires\n  /*-NEG+POS@ requires */",
                new ITokenKind[]{EOF},
                null);
    ...
    @Test
    public void testConditionalKey8() {
...
//    }
    ...
    @Test
    public void testConditionalKey10() {
        Options.instance(context).put("-Xlint:deprecation", "true");
        helpScanner("//-@ requires\n  /*-@ requires */",
                new ITokenKind[]{EOF},
                null,
...
//    }
    ...
    @Test
    public void testConditionalKey10d() {
        helpScanner("//-@ requires\n  /*-@ requires */",
                new ITokenKind[]{EOF},
                null,
                0);
