...
public class racfiles extends RacBase {
     ...
     */
    @Test
    // FIXME - problems with library specs - RAC cannot handle ghost variables when it does not compile the class file
    public void test1a() {
        expectedExit = 0;
        expectedRACExit = 0;
    ...
    @Test
    // Bug in that import statements must be in .java files, not .jml // FIXME - partially fixed - .jml imports are merged into .java imports
    ...
    @Test
    @Ignore // FIXME - Class encoding error in RAC
    ...
    @Test
    @Ignore // FIXME - RAC Not yet working for programs using string
