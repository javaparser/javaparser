...
public class Test {
    ...
    Object nn() {
        return f;
    } // Error because f is nullable but nn is not
    ...
    @NonNull
    Object fiii = null; // OK - fi is nonnull by declaration here that is ignored
    // Assigning a field
...
class A { // NullableByDefault
    ...
    @NonNull
    Object fiii = null; // OK - fiii is nullable; this declaration is ignored
    // Assigning a field
