...
public abstract class MemoryArea extends Object {
     ...
     *
     * @param initialSize  The initial size of this new memory area
     * @param reservedSize The size of the reserved area in the backing store in which this memory area is located. This must be
