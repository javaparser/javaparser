 ...
 * @scjComment - SCJ issue: The semantics of <code>getTime</code> with <code>dest
...
public abstract class Clock {
     ...
     *
     * @param active when true, indicates that the clock can be used for the event-driven release of handler.
