...
public abstract class ManagedMemory extends MemoryArea {
     ...
     * @throws IllegalArgumentException if the caller is a schedulable object and <code>logic</code>
     *                                  is null.
     */
     ...
     *
     * @param logic The Runnable object whose <code>run()</code> method shall be executed.
     ...
     * allocation area.
     *
     * @param size  is the number of free bytes within the inner-nested private
     *              memory.
     * @param logic provides the run method that is to be executed within the
