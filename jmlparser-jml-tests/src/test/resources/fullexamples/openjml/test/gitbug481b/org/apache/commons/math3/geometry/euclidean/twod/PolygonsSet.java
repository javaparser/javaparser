...
public class PolygonsSet extends AbstractRegion<Euclidean2D, Euclidean1D> {
    ...
    private static class SegmentsBuilder implements BSPTreeVisitor<Euclidean2D> {
        ...
        public void visitInternalNode(final BSPTree<Euclidean2D> node) {
            @SuppressWarnings("unchecked") final BoundaryAttribute<Euclidean2D> attribute = (BoundaryAttribute<Euclidean2D>) node.getAttribute();
        ...
        private void addContribution(final SubHyperplane<Euclidean2D> sub,
            ...
            @SuppressWarnings("unchecked") final AbstractSubHyperplane<Euclidean2D, Euclidean1D> absSub =
