...
public class CommentParsingSteps {
    ...
    @When("the class is parsed by the comment japa.parser")
    ...
    @When("the do not consider annotations as node start for code attribution is $value on the Java japa.parser")
